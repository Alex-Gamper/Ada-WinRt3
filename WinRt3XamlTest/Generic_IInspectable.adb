...
package body Generic_IInspectable is
    ...
    function QueryInterface (This : access Kind_Interface; riid : in GUID_Ptr; pvObject : not null access IUnknown) return Winrt.HResult is
    ...
    function GetIids (This : access Kind_Interface; iidCount : access UInt32; iids : in IID_Ptr) return Winrt.HResult is
        Hr : Winrt.HResult := E_NOTIMPL;
    begin
        return Hr;
    end;
   
    function GetRuntimeClassName (This : access Kind_Interface; className : access HString) return Winrt.HResult is
    ...
    function GetTrustLevel (This : access Kind_Interface; trustLevel_p : access TrustLevel) return Winrt.HResult is
        Hr : Winrt.HResult := S_OK;
    begin
