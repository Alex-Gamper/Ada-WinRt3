...
--------------------------------------------------------------------------------
package WinUI3.Windows.Gaming.XboxLive.Storage is
   ...
   type IGameSaveBlobGetResult_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGameSaveBlobInfo_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGameSaveBlobInfoGetResult_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGameSaveBlobInfoQuery_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGameSaveContainer_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGameSaveContainerInfo_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGameSaveContainerInfoGetResult_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGameSaveContainerInfoQuery_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGameSaveOperationResult_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGameSaveProvider_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGameSaveProviderGetResult_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGameSaveProviderStatics_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   package IVectorView_IGameSaveBlobInfo is new WinUI3.Windows.Foundation.Collections.IVectorView (IGameSaveBlobInfo);
   IID_IVectorView_IGameSaveBlobInfo : aliased WinUI3.IID := (1053217412, 1212, 23805, (167, 69, 68, 8, 158, 168, 99, 30 ));
   ...
   package IVectorView_IGameSaveContainerInfo is new WinUI3.Windows.Foundation.Collections.IVectorView (IGameSaveContainerInfo);
   IID_IVectorView_IGameSaveContainerInfo : aliased WinUI3.IID := (2070529991, 55518, 21434, (145, 109, 180, 216, 44, 232, 19, 232 ));
   ...
   IID_IVectorView_HString : aliased WinUI3.IID := (3765078006, 5215, 24477, (177, 177, 50, 39, 103, 191, 133, 169 ));
   ...
   -----------------------------------------------------------------------------
   -- type IGameSaveBlobGetResult is interface and WinUI3.IInspectable;

      function get_Status
      (
         this : access IGameSaveBlobGetResult_Interface;
         RetVal : access WinUI3.Windows.Gaming.XboxLive.Storage.GameSaveErrorStatus
      )
      ...
      IID_IGameSaveBlobGetResult : aliased WinUI3.IID := (2440200672, 29185, 18771, (170, 44, 64, 8, 240, 58, 239, 69 ));

   -----------------------------------------------------------------------------
   -- type IGameSaveBlobInfo is interface and WinUI3.IInspectable;
      ...
      IID_IGameSaveBlobInfo : aliased WinUI3.IID := (2916319284, 47856, 17989, (182, 208, 70, 237, 175, 251, 60, 43 ));

   -----------------------------------------------------------------------------
   -- type IGameSaveBlobInfoGetResult is interface and WinUI3.IInspectable;
      ...
      IID_IGameSaveBlobInfoGetResult : aliased WinUI3.IID := (3344401794, 13975, 17087, (152, 156, 102, 93, 146, 59, 82, 49 ));

   -----------------------------------------------------------------------------
   -- type IGameSaveBlobInfoQuery is interface and WinUI3.IInspectable;
      ...
      IID_IGameSaveBlobInfoQuery : aliased WinUI3.IID := (2682090674, 61166, 17531, (169, 210, 127, 150, 192, 248, 50, 8 ));

   -----------------------------------------------------------------------------
   -- type IGameSaveContainer is interface and WinUI3.IInspectable;
      ...
      (
         this : access IGameSaveContainer_Interface;
         RetVal : access WinUI3.Windows.Gaming.XboxLive.Storage.IGameSaveProvider
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         this : access IGameSaveContainer_Interface;
         blobNamePrefix : WinUI3.HString;
         RetVal : access WinUI3.Windows.Gaming.XboxLive.Storage.IGameSaveBlobInfoQuery
      )
      return WinUI3.Hresult is abstract;

      IID_IGameSaveContainer : aliased WinUI3.IID := (3284176777, 22079, 20173, (156, 111, 51, 253, 14, 50, 61, 16 ));

   -----------------------------------------------------------------------------
   -- type IGameSaveContainerInfo is interface and WinUI3.IInspectable;
      ...
      IID_IGameSaveContainerInfo : aliased WinUI3.IID := (3085071104, 5469, 19380, (178, 186, 147, 3, 6, 243, 145, 181 ));

   -----------------------------------------------------------------------------
   -- type IGameSaveContainerInfoGetResult is interface and WinUI3.IInspectable;
      ...
      IID_IGameSaveContainerInfoGetResult : aliased WinUI3.IID := (4291104116, 50561, 20381, (158, 57, 48, 161, 12, 30, 76, 80 ));

   -----------------------------------------------------------------------------
   -- type IGameSaveContainerInfoQuery is interface and WinUI3.IInspectable;
      ...
      IID_IGameSaveContainerInfoQuery : aliased WinUI3.IID := (1016391779, 28544, 17191, (147, 39, 255, 193, 26, 253, 66, 179 ));

   -----------------------------------------------------------------------------
   -- type IGameSaveOperationResult is interface and WinUI3.IInspectable;
      ...
      IID_IGameSaveOperationResult : aliased WinUI3.IID := (3473873413, 9376, 17794, (154, 85, 177, 187, 187, 147, 136, 216 ));

   -----------------------------------------------------------------------------
   -- type IGameSaveProvider is interface and WinUI3.IInspectable;
      ...
      (
         this : access IGameSaveProvider_Interface;
         name : WinUI3.HString;
         RetVal : access WinUI3.Windows.Gaming.XboxLive.Storage.IGameSaveContainer
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         this : access IGameSaveProvider_Interface;
         RetVal : access WinUI3.Windows.Gaming.XboxLive.Storage.IGameSaveContainerInfoQuery
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         this : access IGameSaveProvider_Interface;
         containerNamePrefix : WinUI3.HString;
         RetVal : access WinUI3.Windows.Gaming.XboxLive.Storage.IGameSaveContainerInfoQuery
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_IGameSaveProvider : aliased WinUI3.IID := (2426798996, 33022, 16913, (151, 248, 165, 222, 20, 221, 149, 210 ));

   -----------------------------------------------------------------------------
   -- type IGameSaveProviderGetResult is interface and WinUI3.IInspectable;
      ...
      IID_IGameSaveProviderGetResult : aliased WinUI3.IID := (985204758, 54163, 19813, (172, 22, 65, 195, 230, 122, 185, 69 ));

   -----------------------------------------------------------------------------
   -- type IGameSaveProviderStatics is interface and WinUI3.IInspectable;

      function GetForUserAsync
      (
         this : access IGameSaveProviderStatics_Interface;
         user : WinUI3.Windows.System.IUser;
         serviceConfigId : WinUI3.HString;
         RetVal : access GenericObject
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_IGameSaveProviderStatics : aliased WinUI3.IID := (3491577552, 31491, 17565, (140, 189, 52, 2, 132, 42, 16, 72 ));
   ...
   return WinUI3.Windows.Gaming.XboxLive.Storage.GameSaveErrorStatus;
   ...
   return WinUI3.Windows.Gaming.XboxLive.Storage.GameSaveBlobInfoGetResult'Class;
   ...
   return WinUI3.Windows.Gaming.XboxLive.Storage.GameSaveProvider'Class;
   ...
   return WinUI3.Windows.Gaming.XboxLive.Storage.GameSaveOperationResult'Class;
   ...
   return WinUI3.Windows.Gaming.XboxLive.Storage.GameSaveBlobGetResult'Class;
   ...
   return WinUI3.Windows.Gaming.XboxLive.Storage.GameSaveBlobInfoQuery'Class;
   ...
   return WinUI3.Windows.Gaming.XboxLive.Storage.GameSaveContainerInfoGetResult'Class;
   ...
   return WinUI3.Windows.Gaming.XboxLive.Storage.GameSaveProviderGetResult;
   ...
   return WinUI3.Windows.Gaming.XboxLive.Storage.GameSaveContainer'Class;
   ...
   return WinUI3.Windows.Gaming.XboxLive.Storage.GameSaveContainerInfoQuery'Class;
