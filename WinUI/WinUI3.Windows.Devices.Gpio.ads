...
--                                                                            --
--------------------------------------------------------------------------------
limited with WinUI3.Windows.Devices.Gpio.Provider;
with WinUI3.Windows.Foundation;
with WinUI3.Windows.Foundation.Collections;
with Ada.Finalization;
--------------------------------------------------------------------------------
package WinUI3.Windows.Devices.Gpio is
   ...
   type IGpioChangeCounter_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGpioChangeCounterFactory_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGpioChangeReader_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGpioChangeReaderFactory_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGpioController_Interface is interface and WinUI3.IInspectable_Interface;
   type IGpioController is access all IGpioController_Interface'Class;
   type IGpioController_Ptr is access all IGpioController;

   type IGpioControllerStatics_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGpioControllerStatics2_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGpioPin_Interface is interface and WinUI3.IInspectable_Interface;
   type IGpioPin is access all IGpioPin_Interface'Class;
   type IGpioPin_Ptr is access all IGpioPin;

   type IGpioPinValueChangedEventArgs_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type GpioChangeCount is record
      Count : WinUI3.UInt64;
      RelativeTime : WinUI3.Windows.Foundation.TimeSpan;
   ...
   package IVector_GpioChangeRecord is new WinUI3.Windows.Foundation.Collections.IVector (GpioChangeRecord);
   IID_IVector_GpioChangeRecord : aliased WinUI3.IID := (570934633, 38419, 22673, (142, 20, 212, 40, 37, 215, 215, 51 ));
   ...
   -----------------------------------------------------------------------------
   -- type IGpioChangeCounter is interface and WinUI3.IInspectable;
      ...
      (
         this : access IGpioChangeCounter_Interface;
         RetVal : access WinUI3.Windows.Devices.Gpio.GpioChangePolarity
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         this : access IGpioChangeCounter_Interface;
         RetVal : access WinUI3.Windows.Devices.Gpio.GpioChangeCount
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_IGpioChangeCounter : aliased WinUI3.IID := (3411984606, 26625, 17407, (128, 61, 69, 118, 98, 138, 139, 38 ));

   -----------------------------------------------------------------------------
   -- type IGpioChangeCounterFactory is interface and WinUI3.IInspectable;

      function Create
      (
         this : access IGpioChangeCounterFactory_Interface;
         pin : WinUI3.Windows.Devices.Gpio.IGpioPin;
         RetVal : access WinUI3.Windows.Devices.Gpio.IGpioChangeCounter
      )
      return WinUI3.Hresult is abstract;

      IID_IGpioChangeCounterFactory : aliased WinUI3.IID := (343774390, 2718, 16652, (180, 250, 248, 159, 64, 82, 8, 77 ));

   -----------------------------------------------------------------------------
   -- type IGpioChangeReader is interface and WinUI3.IInspectable;
      ...
      (
         this : access IGpioChangeReader_Interface;
         RetVal : access WinUI3.Windows.Devices.Gpio.GpioChangeRecord
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_IGpioChangeReader : aliased WinUI3.IID := (180127839, 57393, 18664, (133, 144, 112, 222, 120, 54, 60, 109 ));

   -----------------------------------------------------------------------------
   -- type IGpioChangeReaderFactory is interface and WinUI3.IInspectable;

      function Create
      (
         this : access IGpioChangeReaderFactory_Interface;
         pin : WinUI3.Windows.Devices.Gpio.IGpioPin;
         RetVal : access WinUI3.Windows.Devices.Gpio.IGpioChangeReader
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_IGpioChangeReaderFactory : aliased WinUI3.IID := (2841218803, 14606, 17434, (157, 28, 232, 222, 11, 45, 240, 223 ));

   -----------------------------------------------------------------------------
   -- type IGpioController is interface and WinUI3.IInspectable;
      ...
      (
         ...
         RetVal : access WinUI3.Windows.Devices.Gpio.IGpioPin
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_IGpioController : aliased WinUI3.IID := (675287779, 29793, 18076, (168, 188, 97, 214, 157, 8, 165, 60 ));

   -----------------------------------------------------------------------------
   -- type IGpioControllerStatics is interface and WinUI3.IInspectable;

      function GetDefault
      (
         this : access IGpioControllerStatics_Interface;
         RetVal : access WinUI3.Windows.Devices.Gpio.IGpioController
      )
      return WinUI3.Hresult is abstract;

      IID_IGpioControllerStatics : aliased WinUI3.IID := (785839150, 31479, 16662, (149, 51, 196, 61, 153, 161, 251, 100 ));

   -----------------------------------------------------------------------------
   -- type IGpioControllerStatics2 is interface and WinUI3.IInspectable;
      ...
      IID_IGpioControllerStatics2 : aliased WinUI3.IID := (2435546400, 27812, 16646, (163, 115, 255, 253, 52, 107, 14, 91 ));

   -----------------------------------------------------------------------------
   -- type IGpioPin is interface and WinUI3.IInspectable;
      ...
      (
         this : access IGpioPin_Interface;
         RetVal : access WinUI3.Windows.Devices.Gpio.GpioSharingMode
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         this : access IGpioPin_Interface;
         RetVal : access WinUI3.Windows.Devices.Gpio.GpioPinDriveMode
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         this : access IGpioPin_Interface;
         RetVal : access WinUI3.Windows.Devices.Gpio.GpioPinValue
      )
      return WinUI3.Hresult is abstract;

      IID_IGpioPin : aliased WinUI3.IID := (299479175, 44974, 18320, (158, 233, 224, 234, 201, 66, 210, 1 ));

   -----------------------------------------------------------------------------
   -- type IGpioPinValueChangedEventArgs is interface and WinUI3.IInspectable;

      function get_Edge
      (
         this : access IGpioPinValueChangedEventArgs_Interface;
         RetVal : access WinUI3.Windows.Devices.Gpio.GpioPinEdge
      )
      return WinUI3.Hresult is abstract;

      IID_IGpioPinValueChangedEventArgs : aliased WinUI3.IID := (825731809, 28733, 16473, (189, 36, 181, 178, 93, 255, 184, 78 ));
   ...
   return WinUI3.Windows.Devices.Gpio.GpioChangePolarity;
   ...
   return WinUI3.Windows.Devices.Gpio.GpioChangeCount;
   ...
   return WinUI3.Windows.Devices.Gpio.GpioChangeRecord;
   ...
   function GetDefault
   return WinUI3.Windows.Devices.Gpio.GpioController;
   ...
   return WinUI3.Windows.Devices.Gpio.GpioPin'Class;
   ...
   return WinUI3.Windows.Devices.Gpio.GpioSharingMode;
   ...
   return WinUI3.Windows.Devices.Gpio.GpioPinDriveMode;
   ...
   return WinUI3.Windows.Devices.Gpio.GpioPinValue;
   ...
   return WinUI3.Windows.Devices.Gpio.GpioPinEdge;
