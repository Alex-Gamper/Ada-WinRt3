...
--------------------------------------------------------------------------------
package WinUI3.Windows.Devices.Spi.Provider is
   ...
   type IProviderSpiConnectionSettings_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IProviderSpiConnectionSettingsFactory_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type ISpiControllerProvider_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type ISpiDeviceProvider_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type ISpiProvider_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   -----------------------------------------------------------------------------
   -- type IProviderSpiConnectionSettings is interface and WinUI3.IInspectable;
      ...
      (
         this : access IProviderSpiConnectionSettings_Interface;
         RetVal : access WinUI3.Windows.Devices.Spi.Provider.ProviderSpiMode
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         this : access IProviderSpiConnectionSettings_Interface;
         value : WinUI3.Windows.Devices.Spi.Provider.ProviderSpiMode
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         this : access IProviderSpiConnectionSettings_Interface;
         RetVal : access WinUI3.Windows.Devices.Spi.Provider.ProviderSpiSharingMode
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         this : access IProviderSpiConnectionSettings_Interface;
         value : WinUI3.Windows.Devices.Spi.Provider.ProviderSpiSharingMode
      )
      return WinUI3.Hresult is abstract;

      IID_IProviderSpiConnectionSettings : aliased WinUI3.IID := (4127409488, 42306, 20160, (150, 1, 164, 221, 104, 248, 105, 123 ));

   -----------------------------------------------------------------------------
   -- type IProviderSpiConnectionSettingsFactory is interface and WinUI3.IInspectable;

      function Create
      (
         this : access IProviderSpiConnectionSettingsFactory_Interface;
         chipSelectLine : WinUI3.Int32;
         RetVal : access WinUI3.Windows.Devices.Spi.Provider.IProviderSpiConnectionSettings
      )
      return WinUI3.Hresult is abstract;

      IID_IProviderSpiConnectionSettingsFactory : aliased WinUI3.IID := (1715825498, 3193, 17379, (159, 60, 229, 151, 128, 172, 24, 250 ));

   -----------------------------------------------------------------------------
   -- type ISpiControllerProvider is interface and WinUI3.IInspectable;

      function GetDeviceProvider
      (
         this : access ISpiControllerProvider_Interface;
         settings : WinUI3.Windows.Devices.Spi.Provider.IProviderSpiConnectionSettings;
         RetVal : access WinUI3.Windows.Devices.Spi.Provider.ISpiDeviceProvider
      )
      return WinUI3.Hresult is abstract;

      IID_ISpiControllerProvider : aliased WinUI3.IID := (3244844292, 718, 16934, (163, 133, 79, 17, 251, 4, 180, 27 ));

   -----------------------------------------------------------------------------
   -- type ISpiDeviceProvider is interface and WinUI3.IInspectable;
      ...
      IID_ISpiDeviceProvider : aliased WinUI3.IID := (219952195, 12363, 16476, (180, 247, 245, 171, 16, 116, 70, 30 ));

   -----------------------------------------------------------------------------
   -- type ISpiProvider is interface and WinUI3.IInspectable;
      ...
      IID_ISpiProvider : aliased WinUI3.IID := (2528403938, 30676, 18638, (170, 160, 117, 113, 90, 131, 98, 207 ));
   ...
   return WinUI3.Windows.Devices.Spi.Provider.ProviderSpiMode;
   ...
   return WinUI3.Windows.Devices.Spi.Provider.ProviderSpiSharingMode;
...
end WinUI3.Windows.Devices.Spi.Provider;
