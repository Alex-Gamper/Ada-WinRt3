...
--------------------------------------------------------------------------------
package body WinUI3.Windows.Media.Ocr is

   package IAsyncOperation_OcrResult is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.Media.Ocr.IOcrResult);
   package AsyncOperationCompletedHandler_OcrResult is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.Media.Ocr.IOcrResult);
   ...
   return WinUI3.UInt32 is
      ...
      m_hString        : constant WinUI3.HString := To_HString ("Windows.Media.Ocr.OcrEngine");
      m_Factory        : access WinUI3.Windows.Media.Ocr.IOcrEngineStatics_Interface'Class := null;
      temp             : WinUI3.UInt32 := 0;
   ...
   return WinUI3.Windows.Media.Ocr.OcrEngine is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_hString        : constant WinUI3.HString := To_HString ("Windows.Media.Ocr.OcrEngine");
      m_Factory        : access WinUI3.Windows.Media.Ocr.IOcrEngineStatics_Interface'Class := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Media.Ocr.IOcrEngine;
   begin
      return RetVal : WinUI3.Windows.Media.Ocr.OcrEngine do
         Hr := RoGetActivationFactory (m_hString, IID_IOcrEngineStatics'Access , m_Factory'Address);
         if Hr = S_OK then
            ...
            Retval.m_IOcrEngine := new WinUI3.Windows.Media.Ocr.IOcrEngine;
   ...
   return WinUI3.Windows.Media.Ocr.OcrResult'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      ...
      m_RetVal         : aliased WinUI3.Windows.Media.Ocr.IOcrResult;
      m_IID            : aliased WinUI3.IID := (3352760718, 44598, 22976, (172, 118, 123, 173, 238, 113, 28, 139 )); -- Windows.Media.Ocr.OcrResult;
      m_HandlerIID     : aliased WinUI3.IID := (2560365425, 17482, 24190, (177, 151, 158, 170, 249, 210, 130, 154 ));
   ...
   begin
      return RetVal : WinUI3.Windows.Media.Ocr.OcrResult do
         ...
         if Hr = S_OK then
            ...
            if m_AsyncOperation /= null then
               ...
               if m_AsyncStatus = Completed_e then
                  ...
                  Retval.m_IOcrResult := new WinUI3.Windows.Media.Ocr.IOcrResult;
