...
--------------------------------------------------------------------------------
package body WinUI3.Windows.Devices.Enumeration.Pnp is

   package IAsyncOperation_PnpObject is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.Devices.Enumeration.Pnp.IPnpObject);
   package AsyncOperationCompletedHandler_PnpObject is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.Devices.Enumeration.Pnp.IPnpObject);

   package IAsyncOperation_PnpObjectCollection is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.GenericObject);
   package AsyncOperationCompletedHandler_PnpObjectCollection is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.GenericObject);

   package IVectorView_IPnpObject is new WinUI3.Windows.Foundation.Collections.IVectorView (IPnpObject);
   package IIterable_IPnpObject is new WinUI3.Windows.Foundation.Collections.IIterable (IPnpObject);
   -----------------------------------------------------------------------------
   ...
   (
      type_x : WinUI3.Windows.Devices.Enumeration.Pnp.PnpObjectType;
      id : WinUI3.WString;
      requestedProperties : GenericObject
   )
   return WinUI3.Windows.Devices.Enumeration.Pnp.PnpObject is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_hString        : constant WinUI3.HString := To_HString ("Windows.Devices.Enumeration.Pnp.PnpObject");
      m_Factory        : access WinUI3.Windows.Devices.Enumeration.Pnp.IPnpObjectStatics_Interface'Class := null;
      temp             : WinUI3.UInt32 := 0;
      ...
      m_RetVal         : aliased WinUI3.Windows.Devices.Enumeration.Pnp.IPnpObject;
      m_IID            : aliased WinUI3.IID := (582024083, 12518, 20506, (189, 59, 159, 163, 6, 62, 156, 22 )); -- Windows.Devices.Enumeration.Pnp.PnpObject;
      m_HandlerIID     : aliased WinUI3.IID := (2640401507, 26745, 21023, (142, 151, 230, 109, 61, 219, 201, 94 ));
   ...
   begin
      return RetVal : WinUI3.Windows.Devices.Enumeration.Pnp.PnpObject do
            ...
            if Hr = S_OK then
               ...
               if m_AsyncOperation /= null then
                  ...
                  if m_AsyncStatus = Completed_e then
                     ...
                     Retval.m_IPnpObject := new WinUI3.Windows.Devices.Enumeration.Pnp.IPnpObject;
   ...
   return WinUI3.Windows.Devices.Enumeration.Pnp.PnpObjectCollection is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_hString        : constant WinUI3.HString := To_HString ("Windows.Devices.Enumeration.Pnp.PnpObject");
      m_Factory        : access WinUI3.Windows.Devices.Enumeration.Pnp.IPnpObjectStatics_Interface'Class := null;
      ...
      m_IID            : aliased WinUI3.IID := (4085498572, 62246, 23486, (149, 209, 203, 194, 71, 20, 239, 134 )); -- Windows.Devices.Enumeration.Pnp.PnpObjectCollection;
      m_HandlerIID     : aliased WinUI3.IID := (2166195020, 41310, 21794, (183, 244, 229, 48, 4, 252, 88, 255 ));
   ...
   begin
      return RetVal : WinUI3.Windows.Devices.Enumeration.Pnp.PnpObjectCollection do
         Hr := RoGetActivationFactory (m_hString, IID_IPnpObjectStatics'Access , m_Factory'Address);
         if Hr = S_OK then
   ...
   return WinUI3.Windows.Devices.Enumeration.Pnp.PnpObjectWatcher is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_hString        : constant WinUI3.HString := To_HString ("Windows.Devices.Enumeration.Pnp.PnpObject");
      m_Factory        : access WinUI3.Windows.Devices.Enumeration.Pnp.IPnpObjectStatics_Interface'Class := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Devices.Enumeration.Pnp.IPnpObjectWatcher;
   begin
      return RetVal : WinUI3.Windows.Devices.Enumeration.Pnp.PnpObjectWatcher do
         Hr := RoGetActivationFactory (m_hString, IID_IPnpObjectStatics'Access , m_Factory'Address);
         if Hr = S_OK then
            ...
            Retval.m_IPnpObjectWatcher := new WinUI3.Windows.Devices.Enumeration.Pnp.IPnpObjectWatcher;
   ...
   return WinUI3.Windows.Devices.Enumeration.Pnp.PnpObjectType is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Devices.Enumeration.Pnp.PnpObjectType;
   begin
   ...
   (
      this : in out PnpObject;
      updateInfo : WinUI3.Windows.Devices.Enumeration.Pnp.PnpObjectUpdate'Class
   ) is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
   ...
   return WinUI3.Windows.Devices.Enumeration.Pnp.PnpObject'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : IVectorView_IPnpObject.Kind := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Devices.Enumeration.Pnp.IPnpObject;
      m_GenericIID     : aliased WinUI3.IID := (3437602712, 53865, 24526, (153, 206, 239, 10, 227, 205, 5, 105 ));
      function QInterface is new Generic_QueryInterface (WinUI3.GenericObject_Interface, IVectorView_IPnpObject.Kind, m_GenericIID'Unchecked_Access);
   begin
      return RetVal : WinUI3.Windows.Devices.Enumeration.Pnp.PnpObject do
   ...
   (
      this : in out PnpObjectCollection;
      value : WinUI3.Windows.Devices.Enumeration.Pnp.PnpObject'Class;
   ...
   (
      ...
      items : WinUI3.Windows.Devices.Enumeration.Pnp.IPnpObject_Array
   )
   return WinUI3.UInt32 is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
   ...
   return WinUI3.Windows.Devices.Enumeration.Pnp.PnpObject'Class is
      ...
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Devices.Enumeration.Pnp.IPnpObject;
      m_GenericIID     : aliased WinUI3.IID := (817168530, 14062, 21503, (148, 80, 2, 144, 4, 67, 108, 96 ));
      function QInterface is new Generic_QueryInterface (WinUI3.GenericObject_Interface, IIterable_IPnpObject.Kind, m_GenericIID'Unchecked_Access);
   begin
      return RetVal : WinUI3.Windows.Devices.Enumeration.Pnp.PnpObject do
         m_Interface := QInterface (this.m_GenericObject.all);
...
end WinUI3.Windows.Devices.Enumeration.Pnp;
