...
with WinUI3.Windows.Security.Authentication.Web.Core;
...
--------------------------------------------------------------------------------
package body WinUI3.Windows.Security.Authentication.Web.Provider is
   ...
   begin
      return RetVal : WebAccountClientView do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IWebAccountClientView := new WinUI3.Windows.Security.Authentication.Web.Provider.IWebAccountClientView;
   ...
   return WebAccountClientView is
      ...
      temp         : WinUI3.UInt32 := 0;
      m_ComRetVal  : aliased WinUI3.Windows.Security.Authentication.Web.Provider.IWebAccountClientView;
      HStr_accountPairwiseId : constant WinUI3.HString := To_HString (accountPairwiseId);
   begin
      return RetVal : WebAccountClientView do
         Hr := RoGetActivationFactory (m_hString, IID_IWebAccountClientViewFactory'Access , m_Factory'Address);
         if Hr = S_OK then
   ...
   return WinUI3.Windows.Security.Authentication.Web.Provider.WebAccountClientViewType is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Security.Authentication.Web.Provider.WebAccountClientViewType;
   begin
   ...
   package body WebAccountManager is
      ...
      return WinUI3.GenericObject is
         Hr               : WinUI3.HResult := S_OK;
         tmp              : WinUI3.HResult := S_OK;
         m_hString        : constant WinUI3.HString := To_HString ("Windows.Security.Authentication.Web.Provider.WebAccountManager");
         m_Factory        : access WinUI3.Windows.Security.Authentication.Web.Provider.IWebAccountManagerStatics3_Interface'Class := null;
         temp             : WinUI3.UInt32 := 0;
         ...
         m_IID            : aliased WinUI3.IID := (1723174976, 31891, 24470, (181, 47, 44, 9, 141, 21, 87, 208 )); -- GenericObject;
         m_HandlerIID     : aliased WinUI3.IID := (3255373196, 14296, 23623, (149, 129, 15, 23, 185, 26, 12, 211 ));
      ...
      return WinUI3.Windows.Security.Credentials.WebAccount is
         ...
         HStr_webAccountUserName : constant WinUI3.HString := To_HString (webAccountUserName);
         m_Temp           : WinUI3.Int32 := 0;
         m_Completed      : WinUI3.UInt32 := 0;
         m_Captured       : WinUI3.UInt32 := 0;
         m_Compare        : constant WinUI3.UInt32 := 0;
      ...
      return WinUI3.Windows.Security.Credentials.WebAccount is
         ...
         HStr_webAccountId : constant WinUI3.HString := To_HString (webAccountId);
         HStr_webAccountUserName : constant WinUI3.HString := To_HString (webAccountUserName);
         HStr_perUserWebAccountId : constant WinUI3.HString := To_HString (perUserWebAccountId);
         m_Temp           : WinUI3.Int32 := 0;
         m_Completed      : WinUI3.UInt32 := 0;
         m_Captured       : WinUI3.UInt32 := 0;
         m_Compare        : constant WinUI3.UInt32 := 0;
      ...
      procedure InvalidateAppCacheForAllAccountsAsync is
         ...
         tmp              : WinUI3.HResult := S_OK;
         m_hString        : constant WinUI3.HString := To_HString ("Windows.Security.Authentication.Web.Provider.WebAccountManager");
         m_Factory        : access WinUI3.Windows.Security.Authentication.Web.Provider.IWebAccountManagerStatics4_Interface'Class := null;
         temp             : WinUI3.UInt32 := 0;
         m_Temp           : WinUI3.Int32 := 0;
         m_Completed      : WinUI3.UInt32 := 0;
         m_Captured       : WinUI3.UInt32 := 0;
      ...
      return WinUI3.Windows.Security.Credentials.WebAccount is
         ...
         tmp              : WinUI3.HResult := S_OK;
         m_hString        : constant WinUI3.HString := To_HString ("Windows.Security.Authentication.Web.Provider.WebAccountManager");
         m_Factory        : access WinUI3.Windows.Security.Authentication.Web.Provider.IWebAccountMapManagerStatics_Interface'Class := null;
         temp             : WinUI3.UInt32 := 0;
         HStr_webAccountId : constant WinUI3.HString := To_HString (webAccountId);
         HStr_webAccountUserName : constant WinUI3.HString := To_HString (webAccountUserName);
         HStr_perUserWebAccountId : constant WinUI3.HString := To_HString (perUserWebAccountId);
      ...
      (
         ...
         tmp              : WinUI3.HResult := S_OK;
         m_hString        : constant WinUI3.HString := To_HString ("Windows.Security.Authentication.Web.Provider.WebAccountManager");
         m_Factory        : access WinUI3.Windows.Security.Authentication.Web.Provider.IWebAccountManagerStatics_Interface'Class := null;
         temp             : WinUI3.UInt32 := 0;
         HStr_webAccountUserName : constant WinUI3.HString := To_HString (webAccountUserName);
         m_Temp           : WinUI3.Int32 := 0;
         m_Completed      : WinUI3.UInt32 := 0;
      ...
      return WinUI3.GenericObject is
         ...
         m_ComRetVal      : aliased WinUI3.GenericObject := null;
         m_RetVal         : aliased WinUI3.GenericObject;
         m_IID            : aliased WinUI3.IID := (292038593, 6270, 20629, (161, 75, 223, 65, 17, 198, 56, 194 )); -- GenericObject;
         m_HandlerIID     : aliased WinUI3.IID := (1067864943, 32378, 23497, (178, 15, 216, 102, 202, 202, 248, 28 ));
         m_Handler        : AsyncOperationCompletedHandler_GenericObject.Kind := new AsyncOperationCompletedHandler_GenericObject.Kind_Delegate'(IAsyncOperation_Callback'Access, 1, m_HandlerIID'Unchecked_Access);
      ...
      (
         ...
         tmp              : WinUI3.HResult := S_OK;
         m_hString        : constant WinUI3.HString := To_HString ("Windows.Security.Authentication.Web.Provider.WebAccountManager");
         m_Factory        : access WinUI3.Windows.Security.Authentication.Web.Provider.IWebAccountManagerStatics2_Interface'Class := null;
         temp             : WinUI3.UInt32 := 0;
         HStr_uriString : constant WinUI3.HString := To_HString (uriString);
         HStr_callerPFN : constant WinUI3.HString := To_HString (callerPFN);
         m_Temp           : WinUI3.Int32 := 0;
         m_Completed      : WinUI3.UInt32 := 0;
         m_Captured       : WinUI3.UInt32 := 0;
         m_Compare        : constant WinUI3.UInt32 := 0;
      ...
      return WinUI3.Windows.Security.Credentials.WebAccount is
         ...
         tmp              : WinUI3.HResult := S_OK;
         m_hString        : constant WinUI3.HString := To_HString ("Windows.Security.Authentication.Web.Provider.WebAccountManager");
         m_Factory        : access WinUI3.Windows.Security.Authentication.Web.Provider.IWebAccountScopeManagerStatics_Interface'Class := null;
         temp             : WinUI3.UInt32 := 0;
         HStr_webAccountId : constant WinUI3.HString := To_HString (webAccountId);
         HStr_webAccountUserName : constant WinUI3.HString := To_HString (webAccountUserName);
         m_Temp           : WinUI3.Int32 := 0;
      ...
      return WinUI3.Windows.Security.Authentication.Web.Provider.WebAccountScope is
         Hr               : WinUI3.HResult := S_OK;
         tmp              : WinUI3.HResult := S_OK;
         m_hString        : constant WinUI3.HString := To_HString ("Windows.Security.Authentication.Web.Provider.WebAccountManager");
         m_Factory        : access WinUI3.Windows.Security.Authentication.Web.Provider.IWebAccountScopeManagerStatics_Interface'Class := null;
         temp             : WinUI3.UInt32 := 0;
         m_ComRetVal      : aliased WinUI3.Windows.Security.Authentication.Web.Provider.WebAccountScope;
      begin
         Hr := RoGetActivationFactory (m_hString, IID_IWebAccountScopeManagerStatics'Access , m_Factory'Address);
         if Hr = S_OK then
   ...
   return WinUI3.Windows.Security.Authentication.Web.Provider.WebAccountProviderOperationKind is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.Security.Authentication.Web.Provider.IWebAccountProviderOperation := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Security.Authentication.Web.Provider.WebAccountProviderOperationKind;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Security.Authentication.Web.Provider.IWebAccountProviderAddAccountOperation_Interface, WinUI3.Windows.Security.Authentication.Web.Provider.IWebAccountProviderOperation, WinUI3.Windows.Security.Authentication.Web.Provider.IID_IWebAccountProviderOperation'Unchecked_Access);
   begin
   ...
   (
      ...
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.Security.Authentication.Web.Provider.IWebAccountProviderBaseReportOperation := null;
      temp             : WinUI3.UInt32 := 0;
   ...
   return WinUI3.Windows.Security.Authentication.Web.Provider.WebProviderTokenRequest'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Security.Authentication.Web.Provider.IWebProviderTokenRequest;
   begin
      return RetVal : WinUI3.Windows.Security.Authentication.Web.Provider.WebProviderTokenRequest do
         Hr := this.m_IWebAccountProviderTokenOperation.all.get_ProviderRequest (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IWebProviderTokenRequest := new WinUI3.Windows.Security.Authentication.Web.Provider.IWebProviderTokenRequest;
   ...
   return WinUI3.Windows.Security.Authentication.Web.Provider.WebAccountProviderOperationKind is
      ...
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Security.Authentication.Web.Provider.WebAccountProviderOperationKind;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Security.Authentication.Web.Provider.IWebAccountProviderTokenOperation_Interface, WinUI3.Windows.Security.Authentication.Web.Provider.IWebAccountProviderOperation, WinUI3.Windows.Security.Authentication.Web.Provider.IID_IWebAccountProviderOperation'Unchecked_Access);
   begin
   ...
   (
      ...
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.Security.Authentication.Web.Provider.IWebAccountProviderSilentReportOperation := null;
      temp             : WinUI3.UInt32 := 0;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Security.Authentication.Web.Provider.IWebAccountProviderTokenOperation_Interface, WinUI3.Windows.Security.Authentication.Web.Provider.IWebAccountProviderSilentReportOperation, WinUI3.Windows.Security.Authentication.Web.Provider.IID_IWebAccountProviderSilentReportOperation'Unchecked_Access);
   begin
      m_Interface := QInterface (this.m_IWebAccountProviderTokenOperation.all);
   ...
   return WinUI3.Windows.Security.Authentication.Web.Provider.WebAccountProviderOperationKind is
      ...
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Security.Authentication.Web.Provider.WebAccountProviderOperationKind;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Security.Authentication.Web.Provider.IWebAccountProviderManageAccountOperation_Interface, WinUI3.Windows.Security.Authentication.Web.Provider.IWebAccountProviderOperation, WinUI3.Windows.Security.Authentication.Web.Provider.IID_IWebAccountProviderOperation'Unchecked_Access);
   begin
   ...
   (
      ...
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.Security.Authentication.Web.Provider.IWebAccountProviderUIReportOperation := null;
      temp             : WinUI3.UInt32 := 0;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Security.Authentication.Web.Provider.IWebAccountProviderTokenOperation_Interface, WinUI3.Windows.Security.Authentication.Web.Provider.IWebAccountProviderUIReportOperation, WinUI3.Windows.Security.Authentication.Web.Provider.IID_IWebAccountProviderUIReportOperation'Unchecked_Access);
   begin
      m_Interface := QInterface (this.m_IWebAccountProviderTokenOperation.all);
   ...
   return WinUI3.Windows.Security.Authentication.Web.Provider.WebAccountProviderOperationKind is
      ...
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Security.Authentication.Web.Provider.WebAccountProviderOperationKind;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Security.Authentication.Web.Provider.IWebAccountProviderSignOutAccountOperation_Interface, WinUI3.Windows.Security.Authentication.Web.Provider.IWebAccountProviderOperation, WinUI3.Windows.Security.Authentication.Web.Provider.IID_IWebAccountProviderOperation'Unchecked_Access);
   begin
   ...
   return WinUI3.Windows.Security.Authentication.Web.Core.WebTokenRequest'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Security.Authentication.Web.Core.IWebTokenRequest;
   begin
      return RetVal : WinUI3.Windows.Security.Authentication.Web.Core.WebTokenRequest do
   ...
   return WinUI3.Windows.Security.Authentication.Web.Provider.WebAccountSelectionOptions is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Security.Authentication.Web.Provider.WebAccountSelectionOptions;
   begin
   ...
   return WinUI3.Windows.Storage.Streams.IBuffer is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.Security.Authentication.Web.Provider.IWebProviderTokenRequest2 := null;
      temp             : WinUI3.UInt32 := 0;
      m_Temp           : WinUI3.Int32 := 0;
      m_Completed      : WinUI3.UInt32 := 0;
      m_Captured       : WinUI3.UInt32 := 0;
      ...
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Security.Authentication.Web.Provider.IWebProviderTokenRequest_Interface, WinUI3.Windows.Security.Authentication.Web.Provider.IWebProviderTokenRequest2, WinUI3.Windows.Security.Authentication.Web.Provider.IID_IWebProviderTokenRequest2'Unchecked_Access);
   begin
   ...
   return WinUI3.WString is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.Security.Authentication.Web.Provider.IWebProviderTokenRequest3 := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.HString;
      AdaRetval        : WString;
   ...
   begin
      return RetVal : WebProviderTokenResponse do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IWebProviderTokenResponse := new WinUI3.Windows.Security.Authentication.Web.Provider.IWebProviderTokenResponse;
   ...
   return WinUI3.Windows.Security.Authentication.Web.Core.WebTokenResponse'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Security.Authentication.Web.Core.IWebTokenResponse;
   begin
      return RetVal : WinUI3.Windows.Security.Authentication.Web.Core.WebTokenResponse do
