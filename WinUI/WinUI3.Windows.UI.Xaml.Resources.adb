...
--------------------------------------------------------------------------------
package body WinUI3.Windows.UI.Xaml.Resources is
   ...
   return CustomXamlResourceLoader is
      ...
      m_hString    : constant WinUI3.HString := To_HString ("Windows.UI.Xaml.Resources.ICustomXamlResourceLoader");
      m_Factory    : access ICustomXamlResourceLoaderFactory_Interface'Class := null;
      temp         : WinUI3.UInt32 := 0;
      m_ComRetVal  : aliased WinUI3.Windows.UI.Xaml.Resources.ICustomXamlResourceLoader;
   begin
      return RetVal : CustomXamlResourceLoader do
         ...
         if Hr = S_OK then
            ...
            Retval.m_ICustomXamlResourceLoader := new WinUI3.Windows.UI.Xaml.Resources.ICustomXamlResourceLoader;
   ...
   return WinUI3.Windows.UI.Xaml.Resources.CustomXamlResourceLoader is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_hString        : constant WinUI3.HString := To_HString ("Windows.UI.Xaml.Resources.CustomXamlResourceLoader");
      m_Factory        : access WinUI3.Windows.UI.Xaml.Resources.ICustomXamlResourceLoaderStatics_Interface'Class := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.UI.Xaml.Resources.ICustomXamlResourceLoader;
   begin
      return RetVal : WinUI3.Windows.UI.Xaml.Resources.CustomXamlResourceLoader do
   ...
   return WinUI3.IInspectable is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.UI.Xaml.Resources.ICustomXamlResourceLoaderOverrides := null;
      temp             : WinUI3.UInt32 := 0;
      ...
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.UI.Xaml.Resources.ICustomXamlResourceLoader_Interface, WinUI3.Windows.UI.Xaml.Resources.ICustomXamlResourceLoaderOverrides, WinUI3.Windows.UI.Xaml.Resources.IID_ICustomXamlResourceLoaderOverrides'Unchecked_Access);
   begin
