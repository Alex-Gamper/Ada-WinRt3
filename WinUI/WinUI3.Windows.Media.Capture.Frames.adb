...
--------------------------------------------------------------------------------
package body WinUI3.Windows.Media.Capture.Frames is

   package IAsyncOperation_MediaFrameReaderStartStatus is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.Media.Capture.Frames.MediaFrameReaderStartStatus);
   package AsyncOperationCompletedHandler_MediaFrameReaderStartStatus is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.Media.Capture.Frames.MediaFrameReaderStartStatus);

   package IAsyncOperation_MediaFrameSourceGetPropertyResult is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceGetPropertyResult);
   package AsyncOperationCompletedHandler_MediaFrameSourceGetPropertyResult is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceGetPropertyResult);

   package IAsyncOperation_MediaFrameSourceSetPropertyStatus is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.Media.Capture.Frames.MediaFrameSourceSetPropertyStatus);
   package AsyncOperationCompletedHandler_MediaFrameSourceSetPropertyStatus is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.Media.Capture.Frames.MediaFrameSourceSetPropertyStatus);
   ...
   package IAsyncOperation_MediaFrameSourceGroup is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceGroup);
   package AsyncOperationCompletedHandler_MediaFrameSourceGroup is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceGroup);

   package IAsyncOperation_MultiSourceMediaFrameReaderStartStatus is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.Media.Capture.Frames.MultiSourceMediaFrameReaderStartStatus);
   package AsyncOperationCompletedHandler_MultiSourceMediaFrameReaderStartStatus is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.Media.Capture.Frames.MultiSourceMediaFrameReaderStartStatus);
   ...
   return WinUI3.Windows.Media.Capture.Frames.MediaFrameReference'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Media.Capture.Frames.IMediaFrameReference;
   begin
      return RetVal : WinUI3.Windows.Media.Capture.Frames.MediaFrameReference do
         Hr := this.m_IAudioMediaFrame.all.get_FrameReference (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IMediaFrameReference := new WinUI3.Windows.Media.Capture.Frames.IMediaFrameReference;
   ...
   return WinUI3.Windows.Media.Capture.Frames.VideoMediaFrame'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Media.Capture.Frames.IVideoMediaFrame;
   begin
      return RetVal : WinUI3.Windows.Media.Capture.Frames.VideoMediaFrame do
         Hr := this.m_IDepthMediaFrame.all.get_VideoMediaFrame (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IVideoMediaFrame := new WinUI3.Windows.Media.Capture.Frames.IVideoMediaFrame;
   ...
   return WinUI3.Windows.Media.Capture.Frames.DepthMediaFrameFormat'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Media.Capture.Frames.IDepthMediaFrameFormat;
   begin
      return RetVal : WinUI3.Windows.Media.Capture.Frames.DepthMediaFrameFormat do
         Hr := this.m_IDepthMediaFrame.all.get_DepthFormat (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IDepthMediaFrameFormat := new WinUI3.Windows.Media.Capture.Frames.IDepthMediaFrameFormat;
   ...
   return WinUI3.Windows.Media.Devices.Core.DepthCorrelatedCoordinateMapper'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Media.Devices.Core.IDepthCorrelatedCoordinateMapper;
   begin
      return RetVal : WinUI3.Windows.Media.Devices.Core.DepthCorrelatedCoordinateMapper do
         ...
         Retval.m_IDepthCorrelatedCoordinateMapper := new WinUI3.Windows.Media.Devices.Core.IDepthCorrelatedCoordinateMapper;
   ...
   return WinUI3.UInt32 is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.Media.Capture.Frames.IDepthMediaFrame2 := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.UInt32;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Media.Capture.Frames.IDepthMediaFrame_Interface, WinUI3.Windows.Media.Capture.Frames.IDepthMediaFrame2, WinUI3.Windows.Media.Capture.Frames.IID_IDepthMediaFrame2'Unchecked_Access);
   begin
   ...
   return WinUI3.Windows.Media.Capture.Frames.VideoMediaFrameFormat'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Media.Capture.Frames.IVideoMediaFrameFormat;
   begin
      return RetVal : WinUI3.Windows.Media.Capture.Frames.VideoMediaFrameFormat do
         Hr := this.m_IDepthMediaFrameFormat.all.get_VideoFormat (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IVideoMediaFrameFormat := new WinUI3.Windows.Media.Capture.Frames.IVideoMediaFrameFormat;
   ...
   return WinUI3.Windows.Media.MediaProperties.AudioEncodingProperties'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.Media.Capture.Frames.IMediaFrameFormat2 := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Media.MediaProperties.IAudioEncodingProperties;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Media.Capture.Frames.IMediaFrameFormat_Interface, WinUI3.Windows.Media.Capture.Frames.IMediaFrameFormat2, WinUI3.Windows.Media.Capture.Frames.IID_IMediaFrameFormat2'Unchecked_Access);
   begin
      return RetVal : WinUI3.Windows.Media.MediaProperties.AudioEncodingProperties do
   ...
   return WinUI3.Windows.Media.Capture.Frames.MediaFrameReaderStartStatus is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      ...
      m_RetVal         : aliased WinUI3.Windows.Media.Capture.Frames.MediaFrameReaderStartStatus;
      m_IID            : aliased WinUI3.IID := (3683525914, 44486, 22355, (135, 132, 196, 75, 77, 124, 91, 7 )); -- Windows.Media.Capture.Frames.MediaFrameReaderStartStatus;
      m_HandlerIID     : aliased WinUI3.IID := (2672407269, 12136, 23640, (141, 139, 18, 23, 111, 246, 234, 80 ));
   ...
   (
      ...
      temp             : WinUI3.UInt32 := 0;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Media.Capture.Frames.IMediaFrameReader_Interface, WinUI3.Windows.Foundation.IClosable, WinUI3.Windows.Foundation.IID_IClosable'Unchecked_Access);
   begin
   ...
   (
      ...
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.Media.Capture.Frames.IMediaFrameReader2 := null;
      temp             : WinUI3.UInt32 := 0;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Media.Capture.Frames.IMediaFrameReader_Interface, WinUI3.Windows.Media.Capture.Frames.IMediaFrameReader2, WinUI3.Windows.Media.Capture.Frames.IID_IMediaFrameReader2'Unchecked_Access);
   begin
      m_Interface := QInterface (this.m_IMediaFrameReader.all);
   ...
   return WinUI3.Windows.Media.Capture.Frames.MediaFrameReaderAcquisitionMode is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.Media.Capture.Frames.IMediaFrameReader2 := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Media.Capture.Frames.MediaFrameReaderAcquisitionMode;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Media.Capture.Frames.IMediaFrameReader_Interface, WinUI3.Windows.Media.Capture.Frames.IMediaFrameReader2, WinUI3.Windows.Media.Capture.Frames.IID_IMediaFrameReader2'Unchecked_Access);
   begin
      m_Interface := QInterface (this.m_IMediaFrameReader.all);
   ...
   return WinUI3.Windows.Media.Capture.Frames.MediaFrameSourceKind is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Media.Capture.Frames.MediaFrameSourceKind;
   begin
   ...
   return WinUI3.Windows.Media.Capture.Frames.MediaFrameFormat'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Media.Capture.Frames.IMediaFrameFormat;
   begin
      return RetVal : WinUI3.Windows.Media.Capture.Frames.MediaFrameFormat do
         Hr := this.m_IMediaFrameReference.all.get_Format (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IMediaFrameFormat := new WinUI3.Windows.Media.Capture.Frames.IMediaFrameFormat;
   ...
   return WinUI3.Windows.Media.Capture.Frames.BufferMediaFrame'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Media.Capture.Frames.IBufferMediaFrame;
   begin
      return RetVal : WinUI3.Windows.Media.Capture.Frames.BufferMediaFrame do
         Hr := this.m_IMediaFrameReference.all.get_BufferMediaFrame (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IBufferMediaFrame := new WinUI3.Windows.Media.Capture.Frames.IBufferMediaFrame;
   ...
   (
      ...
      m_Interface      : WinUI3.Windows.Foundation.IClosable := null;
      temp             : WinUI3.UInt32 := 0;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Media.Capture.Frames.IMediaFrameReference_Interface, WinUI3.Windows.Foundation.IClosable, WinUI3.Windows.Foundation.IID_IClosable'Unchecked_Access);
   begin
   ...
   return WinUI3.Windows.Media.Capture.Frames.AudioMediaFrame'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.Media.Capture.Frames.IMediaFrameReference2 := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Media.Capture.Frames.IAudioMediaFrame;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Media.Capture.Frames.IMediaFrameReference_Interface, WinUI3.Windows.Media.Capture.Frames.IMediaFrameReference2, WinUI3.Windows.Media.Capture.Frames.IID_IMediaFrameReference2'Unchecked_Access);
   begin
      return RetVal : WinUI3.Windows.Media.Capture.Frames.AudioMediaFrame do
         m_Interface := QInterface (this.m_IMediaFrameReference.all);
         ...
         Retval.m_IAudioMediaFrame := new WinUI3.Windows.Media.Capture.Frames.IAudioMediaFrame;
   ...
   return WinUI3.Windows.Media.Capture.Frames.MediaFrameSourceInfo'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceInfo;
   begin
      return RetVal : WinUI3.Windows.Media.Capture.Frames.MediaFrameSourceInfo do
         Hr := this.m_IMediaFrameSource.all.get_Info (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IMediaFrameSourceInfo := new WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceInfo;
   ...
   return WinUI3.Windows.Media.Capture.Frames.MediaFrameSourceController'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceController;
   begin
      return RetVal : WinUI3.Windows.Media.Capture.Frames.MediaFrameSourceController do
         Hr := this.m_IMediaFrameSource.all.get_Controller (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IMediaFrameSourceController := new WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceController;
   ...
   return WinUI3.Windows.Media.Capture.Frames.MediaFrameSourceGetPropertyResult'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      ...
      m_AsyncStatus    : aliased WinUI3.Windows.Foundation.AsyncStatus;
      m_ComRetVal      : aliased WinUI3.GenericObject := null;
      m_RetVal         : aliased WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceGetPropertyResult;
      m_IID            : aliased WinUI3.IID := (2147498361, 18822, 21159, (178, 39, 174, 107, 228, 210, 181, 205 )); -- Windows.Media.Capture.Frames.MediaFrameSourceGetPropertyResult;
      m_HandlerIID     : aliased WinUI3.IID := (3495395085, 52806, 23623, (143, 124, 74, 229, 98, 108, 199, 109 ));
   ...
   begin
      return RetVal : WinUI3.Windows.Media.Capture.Frames.MediaFrameSourceGetPropertyResult do
         ...
         if Hr = S_OK then
            ...
            if m_AsyncOperation /= null then
               ...
               if m_AsyncStatus = Completed_e then
                  Hr := m_AsyncOperation.GetResults (m_RetVal'Access);
                  Retval.m_IMediaFrameSourceGetPropertyResult := new WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceGetPropertyResult;
   ...
   return WinUI3.Windows.Media.Capture.Frames.MediaFrameSourceSetPropertyStatus is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      HStr_propertyId : constant WinUI3.HString := To_HString (propertyId);
      ...
      m_AsyncStatus    : aliased WinUI3.Windows.Foundation.AsyncStatus;
      m_ComRetVal      : aliased WinUI3.GenericObject := null;
      m_RetVal         : aliased WinUI3.Windows.Media.Capture.Frames.MediaFrameSourceSetPropertyStatus;
      m_IID            : aliased WinUI3.IID := (2706406422, 24452, 22638, (140, 169, 34, 79, 55, 224, 224, 222 )); -- Windows.Media.Capture.Frames.MediaFrameSourceSetPropertyStatus;
      m_HandlerIID     : aliased WinUI3.IID := (4128466490, 50821, 24000, (177, 51, 96, 217, 67, 3, 166, 227 ));
   ...
   return WinUI3.Windows.Media.Capture.Frames.MediaFrameSourceGetPropertyResult'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceController2 := null;
      temp             : WinUI3.UInt32 := 0;
      m_Temp           : WinUI3.Int32 := 0;
      m_Completed      : WinUI3.UInt32 := 0;
      m_Captured       : WinUI3.UInt32 := 0;
      ...
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceController_Interface, WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceController2, WinUI3.Windows.Media.Capture.Frames.IID_IMediaFrameSourceController2'Unchecked_Access);
   ...
   begin
      return RetVal : WinUI3.Windows.Media.Capture.Frames.MediaFrameSourceGetPropertyResult do
         ...
         Hr := m_Interface.GetPropertyByExtendedIdAsync (WinUI3.UInt32(extendedPropertyId'Length), Convert_extendedPropertyId (extendedPropertyId (extendedPropertyId'First)'Address), maxPropertyValueSize, m_ComRetVal'Access);
         temp := m_Interface.Release;
         if Hr = S_OK then
            m_AsyncOperation := QI (m_ComRetVal);
            temp := m_ComRetVal.Release;
   ...
   begin
      m_Interface := QInterface (this.m_IMediaFrameSourceController.all);
      Hr := m_Interface.SetPropertyByExtendedIdAsync (WinUI3.UInt32(extendedPropertyId'Length), Convert_extendedPropertyId (extendedPropertyId (extendedPropertyId'First)'Address), WinUI3.UInt32(propertyValue'Length), Convert_propertyValue (propertyValue (propertyValue'First)'Address), m_ComRetVal'Access);
      temp := m_Interface.Release;
      if Hr = S_OK then
         m_AsyncOperation := QI (m_ComRetVal);
         temp := m_ComRetVal.Release;
   ...
   return WinUI3.Windows.Media.Devices.AudioDeviceController'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceController3 := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Media.Devices.IAudioDeviceController;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceController_Interface, WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceController3, WinUI3.Windows.Media.Capture.Frames.IID_IMediaFrameSourceController3'Unchecked_Access);
   begin
   ...
   return WinUI3.Windows.Media.Capture.Frames.MediaFrameSourceGetPropertyStatus is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Media.Capture.Frames.MediaFrameSourceGetPropertyStatus;
   begin
   ...
   return WinUI3.GenericObject is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_hString        : constant WinUI3.HString := To_HString ("Windows.Media.Capture.Frames.MediaFrameSourceGroup");
      m_Factory        : access WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceGroupStatics_Interface'Class := null;
      temp             : WinUI3.UInt32 := 0;
      m_Temp           : WinUI3.Int32 := 0;
      m_Completed      : WinUI3.UInt32 := 0;
      m_Captured       : WinUI3.UInt32 := 0;
      ...
      m_IID            : aliased WinUI3.IID := (2811594911, 27977, 22151, (170, 190, 242, 252, 98, 55, 250, 26 )); -- GenericObject;
      m_HandlerIID     : aliased WinUI3.IID := (3489106532, 48452, 22072, (175, 47, 84, 12, 35, 179, 34, 231 ));
   ...
   return WinUI3.Windows.Media.Capture.Frames.MediaFrameSourceGroup is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_hString        : constant WinUI3.HString := To_HString ("Windows.Media.Capture.Frames.MediaFrameSourceGroup");
      m_Factory        : access WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceGroupStatics_Interface'Class := null;
      ...
      m_AsyncStatus    : aliased WinUI3.Windows.Foundation.AsyncStatus;
      m_ComRetVal      : aliased WinUI3.GenericObject := null;
      m_RetVal         : aliased WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceGroup;
      m_IID            : aliased WinUI3.IID := (4079315591, 45519, 22851, (182, 100, 159, 25, 54, 125, 39, 121 )); -- Windows.Media.Capture.Frames.MediaFrameSourceGroup;
      m_HandlerIID     : aliased WinUI3.IID := (2918256363, 40901, 21819, (145, 100, 41, 66, 70, 153, 42, 42 ));
   ...
   return WinUI3.Windows.Media.Capture.MediaStreamType is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Media.Capture.MediaStreamType;
   begin
   ...
   return WinUI3.WString is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceInfo2 := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.HString;
      AdaRetval        : WString;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceInfo_Interface, WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceInfo2, WinUI3.Windows.Media.Capture.Frames.IID_IMediaFrameSourceInfo2'Unchecked_Access);
   begin
   ...
   return WinUI3.Windows.Devices.Enumeration.Panel is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceInfo3 := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Devices.Enumeration.Panel;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceInfo_Interface, WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceInfo3, WinUI3.Windows.Media.Capture.Frames.IID_IMediaFrameSourceInfo3'Unchecked_Access);
   begin
      m_Interface := QInterface (this.m_IMediaFrameSourceInfo.all);
   ...
   return WinUI3.Boolean is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceInfo4 := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Boolean;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceInfo_Interface, WinUI3.Windows.Media.Capture.Frames.IMediaFrameSourceInfo4, WinUI3.Windows.Media.Capture.Frames.IID_IMediaFrameSourceInfo4'Unchecked_Access);
   begin
      m_Interface := QInterface (this.m_IMediaFrameSourceInfo.all);
   ...
   return WinUI3.Windows.Media.Capture.Frames.MultiSourceMediaFrameReference'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Media.Capture.Frames.IMultiSourceMediaFrameReference;
   begin
      return RetVal : WinUI3.Windows.Media.Capture.Frames.MultiSourceMediaFrameReference do
         Hr := this.m_IMultiSourceMediaFrameReader.all.TryAcquireLatestFrame (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IMultiSourceMediaFrameReference := new WinUI3.Windows.Media.Capture.Frames.IMultiSourceMediaFrameReference;
   ...
   return WinUI3.Windows.Media.Capture.Frames.MultiSourceMediaFrameReaderStartStatus is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_Temp           : WinUI3.Int32 := 0;
      ...
      m_AsyncStatus    : aliased WinUI3.Windows.Foundation.AsyncStatus;
      m_ComRetVal      : aliased WinUI3.GenericObject := null;
      m_RetVal         : aliased WinUI3.Windows.Media.Capture.Frames.MultiSourceMediaFrameReaderStartStatus;
      m_IID            : aliased WinUI3.IID := (2722281810, 30378, 21733, (161, 59, 168, 112, 124, 16, 152, 225 )); -- Windows.Media.Capture.Frames.MultiSourceMediaFrameReaderStartStatus;
      m_HandlerIID     : aliased WinUI3.IID := (418312778, 13106, 24558, (160, 240, 114, 206, 237, 51, 6, 69 ));
   ...
   (
      ...
      m_Interface      : WinUI3.Windows.Foundation.IClosable := null;
      temp             : WinUI3.UInt32 := 0;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Media.Capture.Frames.IMultiSourceMediaFrameReader_Interface, WinUI3.Windows.Foundation.IClosable, WinUI3.Windows.Foundation.IID_IClosable'Unchecked_Access);
   begin
   ...
   (
      ...
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.Media.Capture.Frames.IMultiSourceMediaFrameReader2 := null;
      temp             : WinUI3.UInt32 := 0;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Media.Capture.Frames.IMultiSourceMediaFrameReader_Interface, WinUI3.Windows.Media.Capture.Frames.IMultiSourceMediaFrameReader2, WinUI3.Windows.Media.Capture.Frames.IID_IMultiSourceMediaFrameReader2'Unchecked_Access);
   begin
      m_Interface := QInterface (this.m_IMultiSourceMediaFrameReader.all);
      Hr := m_Interface.put_AcquisitionMode (value);
      temp := m_Interface.Release;
   ...
   (
      ...
      m_Interface      : WinUI3.Windows.Foundation.IClosable := null;
      temp             : WinUI3.UInt32 := 0;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Media.Capture.Frames.IMultiSourceMediaFrameReference_Interface, WinUI3.Windows.Foundation.IClosable, WinUI3.Windows.Foundation.IID_IClosable'Unchecked_Access);
   begin
   ...
   return WinUI3.Windows.Media.Capture.Frames.InfraredMediaFrame'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Media.Capture.Frames.IInfraredMediaFrame;
   begin
      return RetVal : WinUI3.Windows.Media.Capture.Frames.InfraredMediaFrame do
         Hr := this.m_IVideoMediaFrame.all.get_InfraredMediaFrame (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IInfraredMediaFrame := new WinUI3.Windows.Media.Capture.Frames.IInfraredMediaFrame;
   ...
   return WinUI3.Windows.Media.Capture.Frames.DepthMediaFrame'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Media.Capture.Frames.IDepthMediaFrame;
   begin
      return RetVal : WinUI3.Windows.Media.Capture.Frames.DepthMediaFrame do
         Hr := this.m_IVideoMediaFrame.all.get_DepthMediaFrame (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IDepthMediaFrame := new WinUI3.Windows.Media.Capture.Frames.IDepthMediaFrame;
