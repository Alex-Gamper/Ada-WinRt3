...
--------------------------------------------------------------------------------
package body WinUI3.Microsoft.UI.Composition.Core is
   ...
   begin
      return RetVal : CompositorController do
         ...
         if Hr = S_OK then
            Retval.m_ICompositorController := new WinUI3.Microsoft.UI.Composition.Core.ICompositorController;
   ...
   (
      ...
      temp             : WinUI3.UInt32 := 0;
      function QInterface is new Generic_QueryInterface (WinUI3.Microsoft.UI.Composition.Core.ICompositorController_Interface, WinUI3.Windows.Foundation.IClosable, WinUI3.Windows.Foundation.IID_IClosable'Unchecked_Access);
   begin
...
end WinUI3.Microsoft.UI.Composition.Core;
