...
--------------------------------------------------------------------------------
package WinUI3.Windows.Devices.I2c.Provider is
   ...
   type II2cControllerProvider_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type II2cDeviceProvider_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type II2cProvider_Interface is interface and WinUI3.IInspectable_Interface;
   type II2cProvider is access all II2cProvider_Interface'Class;
   type II2cProvider_Ptr is access all II2cProvider;

   type IProviderI2cConnectionSettings_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   -----------------------------------------------------------------------------
   -- type II2cControllerProvider is interface and WinUI3.IInspectable;

      function GetDeviceProvider
      (
         this : access II2cControllerProvider_Interface;
         settings : WinUI3.Windows.Devices.I2c.Provider.IProviderI2cConnectionSettings;
         RetVal : access WinUI3.Windows.Devices.I2c.Provider.II2cDeviceProvider
      )
      return WinUI3.Hresult is abstract;

      IID_II2cControllerProvider : aliased WinUI3.IID := (1640151938, 17680, 16739, (168, 124, 78, 21, 169, 85, 137, 128 ));

   -----------------------------------------------------------------------------
   -- type II2cDeviceProvider is interface and WinUI3.IInspectable;
      ...
      (
         ...
         bufferSize : WinUI3.UInt32;
         buffer : WinUI3.Byte_Ptr;
         RetVal : access WinUI3.Windows.Devices.I2c.Provider.ProviderI2cTransferResult
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_II2cDeviceProvider : aliased WinUI3.IID := (2905876052, 22504, 17726, (131, 41, 209, 228, 71, 209, 3, 169 ));

   -----------------------------------------------------------------------------
   -- type II2cProvider is interface and WinUI3.IInspectable;
      ...
      IID_II2cProvider : aliased WinUI3.IID := (1863518270, 48994, 20450, (169, 90, 240, 137, 153, 102, 152, 24 ));

   -----------------------------------------------------------------------------
   -- type IProviderI2cConnectionSettings is interface and WinUI3.IInspectable;
      ...
      (
         this : access IProviderI2cConnectionSettings_Interface;
         RetVal : access WinUI3.Windows.Devices.I2c.Provider.ProviderI2cBusSpeed
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         this : access IProviderI2cConnectionSettings_Interface;
         RetVal : access WinUI3.Windows.Devices.I2c.Provider.ProviderI2cSharingMode
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_IProviderI2cConnectionSettings : aliased WinUI3.IID := (3923463732, 58640, 17591, (128, 157, 242, 248, 91, 85, 83, 57 ));
   ...
   return WinUI3.Windows.Devices.I2c.Provider.ProviderI2cBusSpeed;
   ...
   return WinUI3.Windows.Devices.I2c.Provider.ProviderI2cSharingMode;
