...
--------------------------------------------------------------------------------
package WinUI3.Windows.ApplicationModel.Calls.Provider is
   ...
   type IPhoneCallOrigin_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IPhoneCallOrigin2_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IPhoneCallOrigin3_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IPhoneCallOriginManagerStatics_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IPhoneCallOriginManagerStatics2_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IPhoneCallOriginManagerStatics3_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   -----------------------------------------------------------------------------
   -- type IPhoneCallOrigin is interface and WinUI3.IInspectable;
      ...
      IID_IPhoneCallOrigin : aliased WinUI3.IID := (543241337, 3833, 17492, (135, 28, 175, 182, 106, 20, 182, 165 ));

   -----------------------------------------------------------------------------
   -- type IPhoneCallOrigin2 is interface and WinUI3.IInspectable;
      ...
      IID_IPhoneCallOrigin2 : aliased WinUI3.IID := (80210304, 39618, 18280, (181, 54, 182, 141, 164, 149, 125, 2 ));

   -----------------------------------------------------------------------------
   -- type IPhoneCallOrigin3 is interface and WinUI3.IInspectable;
      ...
      IID_IPhoneCallOrigin3 : aliased WinUI3.IID := (1228083124, 53671, 17314, (174, 238, 192, 123, 109, 186, 240, 104 ));

   -----------------------------------------------------------------------------
   -- type IPhoneCallOriginManagerStatics is interface and WinUI3.IInspectable;
      ...
      (
         ...
         callOrigin : WinUI3.Windows.ApplicationModel.Calls.Provider.IPhoneCallOrigin
      )
      return WinUI3.Hresult is abstract;

      IID_IPhoneCallOriginManagerStatics : aliased WinUI3.IID := (3439090186, 39671, 24905, (57, 208, 224, 118, 252, 206, 19, 149 ));

   -----------------------------------------------------------------------------
   -- type IPhoneCallOriginManagerStatics2 is interface and WinUI3.IInspectable;
      ...
      IID_IPhoneCallOriginManagerStatics2 : aliased WinUI3.IID := (2348019263, 16628, 17280, (140, 124, 174, 162, 201, 184, 221, 122 ));

   -----------------------------------------------------------------------------
   -- type IPhoneCallOriginManagerStatics3 is interface and WinUI3.IInspectable;
      ...
      IID_IPhoneCallOriginManagerStatics3 : aliased WinUI3.IID := (785815396, 42723, 20720, (183, 106, 214, 124, 179, 155, 223, 222 ));
