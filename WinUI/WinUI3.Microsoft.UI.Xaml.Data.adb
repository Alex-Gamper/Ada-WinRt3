...
--------------------------------------------------------------------------------
package body WinUI3.Microsoft.UI.Xaml.Data is
   ...
   return BindingBase is
      ...
      m_hString    : constant WinUI3.HString := To_HString ("Microsoft.UI.Xaml.Data.IBindingBase");
      m_Factory    : access IBindingBaseFactory_Interface'Class := null;
      temp         : WinUI3.UInt32 := 0;
      m_ComRetVal  : aliased WinUI3.Microsoft.UI.Xaml.Data.IBindingBase;
   begin
      return RetVal : BindingBase do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IBindingBase := new WinUI3.Microsoft.UI.Xaml.Data.IBindingBase;
   ...
   return Binding is
      Hr           : WinUI3.HResult := S_OK;
      tmp          : WinUI3.HResult := S_OK;
      m_hString    : constant WinUI3.HString := To_HString ("Microsoft.UI.Xaml.Data.IBinding");
      m_Factory    : access IBindingFactory_Interface'Class := null;
      temp         : WinUI3.UInt32 := 0;
      m_ComRetVal  : aliased WinUI3.Microsoft.UI.Xaml.Data.IBinding;
   begin
      return RetVal : Binding do
         Hr := RoGetActivationFactory (m_hString, IID_IBindingFactory'Access , m_Factory'Address);
         if Hr = S_OK then
            Hr := m_Factory.CreateInstance (baseInterface, innerInterface, m_ComRetVal'Access);
            Retval.m_IBinding := new WinUI3.Microsoft.UI.Xaml.Data.IBinding;
   ...
   return WinUI3.Microsoft.UI.Xaml.Data.BindingMode is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Microsoft.UI.Xaml.Data.BindingMode;
   begin
   ...
   return WinUI3.Microsoft.UI.Xaml.Data.RelativeSource'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Microsoft.UI.Xaml.Data.IRelativeSource;
   begin
      return RetVal : WinUI3.Microsoft.UI.Xaml.Data.RelativeSource do
         Hr := this.m_IBinding.all.get_RelativeSource (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IRelativeSource := new WinUI3.Microsoft.UI.Xaml.Data.IRelativeSource;
   ...
   return WinUI3.IInspectable is
      ...
      m_ComRetVal      : aliased WinUI3.IInspectable;
   begin
      Hr := this.m_IBinding.all.get_FallbackValue (m_ComRetVal'Access);
      if Hr /= S_OK then
         raise Program_Error;
      end if;
      return m_ComRetVal;
   ...
   (
      ...
      temp             : WinUI3.UInt32 := 0;
   begin
      Hr := this.m_IBinding.all.put_FallbackValue (value);
      if Hr /= S_OK then
         raise Program_Error;
      end if;
   end;
   ...
   return WinUI3.IInspectable is
      ...
      m_ComRetVal      : aliased WinUI3.IInspectable;
   begin
      Hr := this.m_IBinding.all.get_TargetNullValue (m_ComRetVal'Access);
      if Hr /= S_OK then
         raise Program_Error;
      end if;
      return m_ComRetVal;
   ...
   (
      ...
      temp             : WinUI3.UInt32 := 0;
   begin
      Hr := this.m_IBinding.all.put_TargetNullValue (value);
      if Hr /= S_OK then
         raise Program_Error;
      end if;
   end;
   ...
   return WinUI3.Microsoft.UI.Xaml.Data.UpdateSourceTrigger is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Microsoft.UI.Xaml.Data.UpdateSourceTrigger;
   begin
      Hr := this.m_IBinding.all.get_UpdateSourceTrigger (m_ComRetVal'Access);
      if Hr /= S_OK then
         raise Program_Error;
      end if;
      return m_ComRetVal;
   ...
   (
      ...
      temp             : WinUI3.UInt32 := 0;
   begin
      Hr := this.m_IBinding.all.put_UpdateSourceTrigger (value);
      if Hr /= S_OK then
         raise Program_Error;
      end if;
   end;
   ...
   return WinUI3.Microsoft.UI.Xaml.Data.Binding'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Microsoft.UI.Xaml.Data.IBinding;
   begin
      return RetVal : WinUI3.Microsoft.UI.Xaml.Data.Binding do
   ...
   (
      ...
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_hString        : constant WinUI3.HString := To_HString ("Microsoft.UI.Xaml.Data.BindingOperations");
      m_Factory        : access WinUI3.Microsoft.UI.Xaml.Data.IBindingOperationsStatics_Interface'Class := null;
      temp             : WinUI3.UInt32 := 0;
   begin
   ...
   function Constructor return CollectionViewSource is
      Hr           : WinUI3.HResult := S_OK;
      tmp          : WinUI3.HResult := S_OK;
      m_hString    : constant WinUI3.HString := To_HString ("Microsoft.UI.Xaml.Data.ICollectionViewSource");
      m_ComRetVal  : aliased WinUI3.Microsoft.UI.Xaml.Data.ICollectionViewSource;
   begin
      return RetVal : CollectionViewSource do
         Hr := RoActivateInstance (m_hString, m_ComRetVal'Address);
         if Hr = S_OK then
            Retval.m_ICollectionViewSource := new WinUI3.Microsoft.UI.Xaml.Data.ICollectionViewSource;
   ...
   return WinUI3.Microsoft.UI.Xaml.DependencyProperty is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_hString        : constant WinUI3.HString := To_HString ("Microsoft.UI.Xaml.Data.CollectionViewSource");
      m_Factory        : access WinUI3.Microsoft.UI.Xaml.Data.ICollectionViewSourceStatics_Interface'Class := null;
      temp             : WinUI3.UInt32 := 0;
   ...
   return WinUI3.Microsoft.UI.Xaml.Data.ICollectionView is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Microsoft.UI.Xaml.Data.ICollectionView;
   begin
   ...
   return CurrentChangingEventArgs is
      Hr           : WinUI3.HResult := S_OK;
      tmp          : WinUI3.HResult := S_OK;
      m_hString    : constant WinUI3.HString := To_HString ("Microsoft.UI.Xaml.Data.ICurrentChangingEventArgs");
      m_Factory    : access ICurrentChangingEventArgsFactory_Interface'Class := null;
      temp         : WinUI3.UInt32 := 0;
      m_ComRetVal  : aliased WinUI3.Microsoft.UI.Xaml.Data.ICurrentChangingEventArgs;
   begin
      return RetVal : CurrentChangingEventArgs do
         ...
         if Hr = S_OK then
            Hr := m_Factory.CreateInstance (baseInterface, innerInterface, m_ComRetVal'Access);
            Retval.m_ICurrentChangingEventArgs := new WinUI3.Microsoft.UI.Xaml.Data.ICurrentChangingEventArgs;
   ...
   procedure Initialize (this : in out DataErrorsChangedEventArgs) is
   begin
      null;
   end;

   procedure Finalize (this : in out DataErrorsChangedEventArgs) is
      temp : WinUI3.UInt32 := 0;
      procedure Free is new Ada.Unchecked_Deallocation (IDataErrorsChangedEventArgs, IDataErrorsChangedEventArgs_Ptr);
   begin
      if this.m_IDataErrorsChangedEventArgs /= null then
         if this.m_IDataErrorsChangedEventArgs.all /= null then
            temp := this.m_IDataErrorsChangedEventArgs.all.Release;
            Free (this.m_IDataErrorsChangedEventArgs);
         end if;
      end if;
   end;
   ...
   return DataErrorsChangedEventArgs is
      Hr           : WinUI3.HResult := S_OK;
      tmp          : WinUI3.HResult := S_OK;
      m_hString    : constant WinUI3.HString := To_HString ("Microsoft.UI.Xaml.Data.IDataErrorsChangedEventArgs");
      m_Factory    : access IDataErrorsChangedEventArgsFactory_Interface'Class := null;
      temp         : WinUI3.UInt32 := 0;
      m_ComRetVal  : aliased WinUI3.Microsoft.UI.Xaml.Data.IDataErrorsChangedEventArgs;
      HStr_name : constant WinUI3.HString := To_HString (name);
   begin
      return RetVal : DataErrorsChangedEventArgs do
         Hr := RoGetActivationFactory (m_hString, IID_IDataErrorsChangedEventArgsFactory'Access , m_Factory'Address);
         if Hr = S_OK then
            Hr := m_Factory.CreateInstance (HStr_name, m_ComRetVal'Access);
            Retval.m_IDataErrorsChangedEventArgs := new WinUI3.Microsoft.UI.Xaml.Data.IDataErrorsChangedEventArgs;
            Retval.m_IDataErrorsChangedEventArgs.all := m_ComRetVal;
            temp := m_Factory.Release;
         end if;
         tmp := WindowsDeleteString (m_hString);
   ...
   return WinUI3.WString is
      ...
      AdaRetval        : WString;
   begin
      Hr := this.m_IDataErrorsChangedEventArgs.all.get_PropertyName (m_ComRetVal'Access);
      if Hr /= S_OK then
         raise Program_Error;
      end if;
      AdaRetval := To_Ada (m_ComRetVal);
   ...
   (
      ...
      HStr_value : constant WinUI3.HString := To_HString (value);
   begin
      Hr := this.m_IDataErrorsChangedEventArgs.all.put_PropertyName (HStr_value);
      if Hr /= S_OK then
         raise Program_Error;
      end if;
      tmp := WindowsDeleteString (HStr_value);
   ...
   return ItemIndexRange is
      Hr           : WinUI3.HResult := S_OK;
      tmp          : WinUI3.HResult := S_OK;
      m_hString    : constant WinUI3.HString := To_HString ("Microsoft.UI.Xaml.Data.IItemIndexRange");
      m_Factory    : access IItemIndexRangeFactory_Interface'Class := null;
      temp         : WinUI3.UInt32 := 0;
      m_ComRetVal  : aliased WinUI3.Microsoft.UI.Xaml.Data.IItemIndexRange;
   begin
      return RetVal : ItemIndexRange do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IItemIndexRange := new WinUI3.Microsoft.UI.Xaml.Data.IItemIndexRange;
   ...
   return PropertyChangedEventArgs is
      Hr           : WinUI3.HResult := S_OK;
      tmp          : WinUI3.HResult := S_OK;
      m_hString    : constant WinUI3.HString := To_HString ("Microsoft.UI.Xaml.Data.IPropertyChangedEventArgs");
      m_Factory    : access IPropertyChangedEventArgsFactory_Interface'Class := null;
      temp         : WinUI3.UInt32 := 0;
      m_ComRetVal  : aliased WinUI3.Microsoft.UI.Xaml.Data.IPropertyChangedEventArgs;
      HStr_name : constant WinUI3.HString := To_HString (name);
   begin
      return RetVal : PropertyChangedEventArgs do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IPropertyChangedEventArgs := new WinUI3.Microsoft.UI.Xaml.Data.IPropertyChangedEventArgs;
   ...
   return RelativeSource is
      Hr           : WinUI3.HResult := S_OK;
      tmp          : WinUI3.HResult := S_OK;
      m_hString    : constant WinUI3.HString := To_HString ("Microsoft.UI.Xaml.Data.IRelativeSource");
   ...
   return WinUI3.Microsoft.UI.Xaml.Data.RelativeSourceMode is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Microsoft.UI.Xaml.Data.RelativeSourceMode;
   begin
