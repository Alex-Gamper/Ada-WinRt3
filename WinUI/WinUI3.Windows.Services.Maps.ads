...
--------------------------------------------------------------------------------
package WinUI3.Windows.Services.Maps is
   ...
   type IEnhancedWaypoint_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IEnhancedWaypointFactory_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IManeuverWarning_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IMapLocationFinderStatics_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IMapLocationFinderStatics2_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IMapManagerStatics_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IMapRouteDrivingOptions2_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IMapRouteFinderResult_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IMapRouteFinderResult2_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IMapRouteFinderStatics_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IMapRouteFinderStatics2_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IMapRouteFinderStatics3_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IMapRouteLeg_Interface is interface and WinUI3.IInspectable_Interface;
   type IMapRouteLeg is access all IMapRouteLeg_Interface'Class;
   type IMapRouteLeg_Ptr is access all IMapRouteLeg;

   type IMapRouteLeg2_Interface is interface and WinUI3.IInspectable_Interface;
   type IMapRouteLeg2 is access all IMapRouteLeg2_Interface'Class;
   type IMapRouteLeg2_Ptr is access all IMapRouteLeg2;

   type IMapRouteManeuver_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IMapRouteManeuver2_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IMapRouteManeuver3_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IMapServiceStatics_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IMapServiceStatics2_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IMapServiceStatics3_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IMapServiceStatics4_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IPlaceInfo_Interface is interface and WinUI3.IInspectable_Interface;
   type IPlaceInfo is access all IPlaceInfo_Interface'Class;
   type IPlaceInfo_Ptr is access all IPlaceInfo;

   type IPlaceInfoCreateOptions_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IPlaceInfoStatics_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IPlaceInfoStatics2_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   package IVectorView_IMapLocation is new WinUI3.Windows.Foundation.Collections.IVectorView (IMapLocation);
   IID_IVectorView_IMapLocation : aliased WinUI3.IID := (2386512612, 23896, 23412, (157, 63, 96, 151, 136, 148, 114, 212 ));
   ...
   package IVectorView_IMapRouteLeg is new WinUI3.Windows.Foundation.Collections.IVectorView (IMapRouteLeg);
   IID_IVectorView_IMapRouteLeg : aliased WinUI3.IID := (1826059587, 28620, 24355, (176, 61, 209, 185, 225, 101, 88, 105 ));
   ...
   IID_IReference_Double : aliased WinUI3.IID := (597272742, 50537, 22264, (165, 21, 97, 107, 5, 105, 136, 13 ));
   ...
   IID_IReference_DateTime : aliased WinUI3.IID := (2926492396, 35052, 21739, (185, 153, 51, 220, 58, 141, 14, 235 ));
   ...
   package IVectorView_IMapRoute is new WinUI3.Windows.Foundation.Collections.IVectorView (IMapRoute);
   IID_IVectorView_IMapRoute : aliased WinUI3.IID := (1811484410, 37195, 20711, (137, 237, 245, 242, 87, 159, 82, 223 ));
   ...
   package IVectorView_IMapRouteManeuver is new WinUI3.Windows.Foundation.Collections.IVectorView (IMapRouteManeuver);
   IID_IVectorView_IMapRouteManeuver : aliased WinUI3.IID := (3779490813, 43862, 24469, (172, 113, 167, 62, 187, 123, 18, 60 ));
   ...
   package IVectorView_IManeuverWarning is new WinUI3.Windows.Foundation.Collections.IVectorView (IManeuverWarning);
   IID_IVectorView_IManeuverWarning : aliased WinUI3.IID := (4117699054, 14460, 23042, (145, 206, 224, 67, 154, 228, 239, 198 ));
   ...
   -----------------------------------------------------------------------------
   -- type IEnhancedWaypoint is interface and WinUI3.IInspectable;
      ...
      (
         this : access IEnhancedWaypoint_Interface;
         RetVal : access WinUI3.Windows.Services.Maps.WaypointKind
      )
      return WinUI3.Hresult is abstract;

      IID_IEnhancedWaypoint : aliased WinUI3.IID := (3978726516, 22803, 4582, (139, 119, 134, 243, 12, 168, 147, 211 ));

   -----------------------------------------------------------------------------
   -- type IEnhancedWaypointFactory is interface and WinUI3.IInspectable;

      function Create
      (
         this : access IEnhancedWaypointFactory_Interface;
         point : WinUI3.Windows.Devices.Geolocation.IGeopoint;
         kind : WinUI3.Windows.Services.Maps.WaypointKind;
         RetVal : access WinUI3.Windows.Services.Maps.IEnhancedWaypoint
      )
      return WinUI3.Hresult is abstract;

      IID_IEnhancedWaypointFactory : aliased WinUI3.IID := (2944828535, 41642, 18141, (182, 69, 35, 179, 27, 138, 166, 199 ));

   -----------------------------------------------------------------------------
   -- type IManeuverWarning is interface and WinUI3.IInspectable;

      function get_Kind
      (
         this : access IManeuverWarning_Interface;
         RetVal : access WinUI3.Windows.Services.Maps.ManeuverWarningKind
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         this : access IManeuverWarning_Interface;
         RetVal : access WinUI3.Windows.Services.Maps.ManeuverWarningSeverity
      )
      return WinUI3.Hresult is abstract;

      IID_IManeuverWarning : aliased WinUI3.IID := (3248713098, 9776, 17272, (158, 74, 110, 68, 37, 61, 206, 186 ));

   -----------------------------------------------------------------------------
   -- type IMapAddress is interface and WinUI3.IInspectable;
      ...
      IID_IMapAddress : aliased WinUI3.IID := (3483871603, 41908, 17556, (179, 255, 203, 169, 77, 182, 150, 153 ));

   -----------------------------------------------------------------------------
   -- type IMapAddress2 is interface and WinUI3.IInspectable;
      ...
      IID_IMapAddress2 : aliased WinUI3.IID := (1976397297, 58797, 17833, (191, 64, 108, 242, 86, 193, 221, 19 ));

   -----------------------------------------------------------------------------
   -- type IMapLocation is interface and WinUI3.IInspectable;
      ...
      (
         this : access IMapLocation_Interface;
         RetVal : access WinUI3.Windows.Services.Maps.IMapAddress
      )
      return WinUI3.Hresult is abstract;

      IID_IMapLocation : aliased WinUI3.IID := (1007107927, 3492, 17128, (158, 226, 169, 111, 207, 35, 113, 220 ));

   -----------------------------------------------------------------------------
   -- type IMapLocationFinderResult is interface and WinUI3.IInspectable;
      ...
      (
         this : access IMapLocationFinderResult_Interface;
         RetVal : access WinUI3.Windows.Services.Maps.MapLocationFinderStatus
      )
      return WinUI3.Hresult is abstract;

      IID_IMapLocationFinderResult : aliased WinUI3.IID := (1139929465, 59596, 17910, (190, 210, 84, 204, 191, 150, 93, 154 ));

   -----------------------------------------------------------------------------
   -- type IMapLocationFinderStatics is interface and WinUI3.IInspectable;

      function FindLocationsAtAsync
      (
         this : access IMapLocationFinderStatics_Interface;
         queryPoint : WinUI3.Windows.Devices.Geolocation.IGeopoint;
         RetVal : access GenericObject
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         ...
         referencePoint : WinUI3.Windows.Devices.Geolocation.IGeopoint;
         RetVal : access GenericObject
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_IMapLocationFinderStatics : aliased WinUI3.IID := (831183709, 7261, 20277, (162, 223, 170, 202, 148, 149, 149, 23 ));

   -----------------------------------------------------------------------------
   -- type IMapLocationFinderStatics2 is interface and WinUI3.IInspectable;
      ...
      IID_IMapLocationFinderStatics2 : aliased WinUI3.IID := (2509933462, 25733, 19965, (133, 26, 51, 172, 49, 126, 58, 246 ));

   -----------------------------------------------------------------------------
   -- type IMapManagerStatics is interface and WinUI3.IInspectable;
      ...
      IID_IMapManagerStatics : aliased WinUI3.IID := (937682197, 33460, 19796, (143, 217, 175, 38, 36, 179, 1, 28 ));

   -----------------------------------------------------------------------------
   -- type IMapRoute is interface and WinUI3.IInspectable;
      ...
      IID_IMapRoute : aliased WinUI3.IID := (4211586866, 22605, 17795, (156, 96, 100, 31, 234, 39, 67, 73 ));

   -----------------------------------------------------------------------------
   -- type IMapRoute2 is interface and WinUI3.IInspectable;

      function get_ViolatedRestrictions
      (
         this : access IMapRoute2_Interface;
         RetVal : access WinUI3.Windows.Services.Maps.MapRouteRestrictions
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_IMapRoute2 : aliased WinUI3.IID := (3519403020, 8723, 19120, (162, 96, 70, 179, 129, 105, 190, 172 ));

   -----------------------------------------------------------------------------
   -- type IMapRoute3 is interface and WinUI3.IInspectable;
      ...
      (
         this : access IMapRoute3_Interface;
         RetVal : access WinUI3.Windows.Services.Maps.TrafficCongestion
      )
      return WinUI3.Hresult is abstract;

      IID_IMapRoute3 : aliased WinUI3.IID := (2240618158, 62125, 17055, (187, 55, 205, 33, 9, 79, 252, 146 ));

   -----------------------------------------------------------------------------
   -- type IMapRoute4 is interface and WinUI3.IInspectable;
      ...
      IID_IMapRoute4 : aliased WinUI3.IID := (913083557, 12371, 20385, (128, 255, 212, 117, 243, 237, 30, 110 ));

   -----------------------------------------------------------------------------
   -- type IMapRouteDrivingOptions is interface and WinUI3.IInspectable;
      ...
      (
         this : access IMapRouteDrivingOptions_Interface;
         RetVal : access WinUI3.Windows.Services.Maps.MapRouteOptimization
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_IMapRouteDrivingOptions : aliased WinUI3.IID := (1746220621, 50908, 18071, (164, 82, 177, 143, 143, 11, 103, 161 ));

   -----------------------------------------------------------------------------
   -- type IMapRouteDrivingOptions2 is interface and WinUI3.IInspectable;
      ...
      IID_IMapRouteDrivingOptions2 : aliased WinUI3.IID := (903644784, 49816, 18640, (181, 173, 130, 84, 96, 100, 86, 3 ));

   -----------------------------------------------------------------------------
   -- type IMapRouteFinderResult is interface and WinUI3.IInspectable;
      ...
      (
         this : access IMapRouteFinderResult_Interface;
         RetVal : access WinUI3.Windows.Services.Maps.MapRouteFinderStatus
      )
      return WinUI3.Hresult is abstract;

      IID_IMapRouteFinderResult : aliased WinUI3.IID := (2825429786, 37922, 18092, (140, 161, 177, 97, 77, 75, 251, 226 ));

   -----------------------------------------------------------------------------
   -- type IMapRouteFinderResult2 is interface and WinUI3.IInspectable;
      ...
      IID_IMapRouteFinderResult2 : aliased WinUI3.IID := (544250989, 55564, 18120, (145, 198, 125, 75, 228, 239, 178, 21 ));

   -----------------------------------------------------------------------------
   -- type IMapRouteFinderStatics is interface and WinUI3.IInspectable;

      function GetDrivingRouteAsync
      (
         this : access IMapRouteFinderStatics_Interface;
         startPoint : WinUI3.Windows.Devices.Geolocation.IGeopoint;
         endPoint : WinUI3.Windows.Devices.Geolocation.IGeopoint;
         RetVal : access GenericObject
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_IMapRouteFinderStatics : aliased WinUI3.IID := (3097871631, 7268, 19514, (129, 235, 31, 124, 21, 42, 251, 187 ));

   -----------------------------------------------------------------------------
   -- type IMapRouteFinderStatics2 is interface and WinUI3.IInspectable;
      ...
      (
         ...
         startPoint : WinUI3.Windows.Devices.Geolocation.IGeopoint;
         endPoint : WinUI3.Windows.Devices.Geolocation.IGeopoint;
         options : WinUI3.Windows.Services.Maps.IMapRouteDrivingOptions;
         RetVal : access GenericObject
      )
      return WinUI3.Hresult is abstract;

      IID_IMapRouteFinderStatics2 : aliased WinUI3.IID := (2949393523, 30560, 18863, (179, 189, 186, 241, 53, 183, 3, 225 ));

   -----------------------------------------------------------------------------
   -- type IMapRouteFinderStatics3 is interface and WinUI3.IInspectable;
      ...
      IID_IMapRouteFinderStatics3 : aliased WinUI3.IID := (4127818036, 22803, 4582, (139, 119, 134, 243, 12, 168, 147, 211 ));

   -----------------------------------------------------------------------------
   -- type IMapRouteLeg is interface and WinUI3.IInspectable;
      ...
      IID_IMapRouteLeg : aliased WinUI3.IID := (2532881142, 23482, 19735, (157, 182, 26, 38, 63, 236, 116, 113 ));

   -----------------------------------------------------------------------------
   -- type IMapRouteLeg2 is interface and WinUI3.IInspectable;
      ...
      IID_IMapRouteLeg2 : aliased WinUI3.IID := (48367149, 51654, 17848, (142, 84, 26, 16, 181, 122, 23, 232 ));

   -----------------------------------------------------------------------------
   -- type IMapRouteManeuver is interface and WinUI3.IInspectable;
      ...
      (
         this : access IMapRouteManeuver_Interface;
         RetVal : access WinUI3.Windows.Services.Maps.MapRouteManeuverKind
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         this : access IMapRouteManeuver_Interface;
         RetVal : access WinUI3.Windows.Services.Maps.MapManeuverNotices
      )
      return WinUI3.Hresult is abstract;

      IID_IMapRouteManeuver : aliased WinUI3.IID := (3982235632, 42667, 19813, (160, 134, 250, 138, 126, 52, 13, 242 ));

   -----------------------------------------------------------------------------
   -- type IMapRouteManeuver2 is interface and WinUI3.IInspectable;
      ...
      IID_IMapRouteManeuver2 : aliased WinUI3.IID := (1568394652, 31899, 16863, (131, 139, 234, 226, 30, 75, 5, 169 ));

   -----------------------------------------------------------------------------
   -- type IMapRouteManeuver3 is interface and WinUI3.IInspectable;
      ...
      IID_IMapRouteManeuver3 : aliased WinUI3.IID := (2795583711, 1155, 16742, (133, 190, 185, 147, 54, 193, 24, 117 ));

   -----------------------------------------------------------------------------
   -- type IMapServiceStatics is interface and WinUI3.IInspectable;
      ...
      IID_IMapServiceStatics : aliased WinUI3.IID := (21278085, 49228, 19677, (135, 26, 160, 114, 109, 9, 124, 212 ));

   -----------------------------------------------------------------------------
   -- type IMapServiceStatics2 is interface and WinUI3.IInspectable;
      ...
      IID_IMapServiceStatics2 : aliased WinUI3.IID := (4162404077, 40069, 16553, (136, 150, 15, 195, 253, 43, 124, 42 ));

   -----------------------------------------------------------------------------
   -- type IMapServiceStatics3 is interface and WinUI3.IInspectable;
      ...
      IID_IMapServiceStatics3 : aliased WinUI3.IID := (168939040, 25511, 18516, (179, 85, 214, 220, 218, 34, 61, 27 ));

   -----------------------------------------------------------------------------
   -- type IMapServiceStatics4 is interface and WinUI3.IInspectable;
      ...
      (
         this : access IMapServiceStatics4_Interface;
         RetVal : access WinUI3.Windows.Services.Maps.MapServiceDataUsagePreference
      )
      return WinUI3.Hresult is abstract;

      IID_IMapServiceStatics4 : aliased WinUI3.IID := (143272034, 27324, 16910, (148, 95, 76, 253, 137, 198, 115, 86 ));

   -----------------------------------------------------------------------------
   -- type IPlaceInfo is interface and WinUI3.IInspectable;
      ...
      IID_IPlaceInfo : aliased WinUI3.IID := (2584219830, 12744, 20330, (159, 24, 149, 11, 76, 56, 149, 26 ));

   -----------------------------------------------------------------------------
   -- type IPlaceInfoCreateOptions is interface and WinUI3.IInspectable;
      ...
      IID_IPlaceInfoCreateOptions : aliased WinUI3.IID := (3442721061, 26609, 19379, (153, 7, 236, 206, 147, 155, 3, 153 ));

   -----------------------------------------------------------------------------
   -- type IPlaceInfoStatics is interface and WinUI3.IInspectable;

      function Create
      (
         this : access IPlaceInfoStatics_Interface;
         referencePoint : WinUI3.Windows.Devices.Geolocation.IGeopoint;
         RetVal : access WinUI3.Windows.Services.Maps.IPlaceInfo
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         this : access IPlaceInfoStatics_Interface;
         referencePoint : WinUI3.Windows.Devices.Geolocation.IGeopoint;
         options : WinUI3.Windows.Services.Maps.IPlaceInfoCreateOptions;
         RetVal : access WinUI3.Windows.Services.Maps.IPlaceInfo
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         this : access IPlaceInfoStatics_Interface;
         identifier : WinUI3.HString;
         defaultPoint : WinUI3.Windows.Devices.Geolocation.IGeopoint;
         options : WinUI3.Windows.Services.Maps.IPlaceInfoCreateOptions;
         RetVal : access WinUI3.Windows.Services.Maps.IPlaceInfo
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         this : access IPlaceInfoStatics_Interface;
         location : WinUI3.Windows.Services.Maps.IMapLocation;
         RetVal : access WinUI3.Windows.Services.Maps.IPlaceInfo
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_IPlaceInfoStatics : aliased WinUI3.IID := (2193227633, 27856, 18596, (175, 217, 94, 216, 32, 151, 147, 107 ));

   -----------------------------------------------------------------------------
   -- type IPlaceInfoStatics2 is interface and WinUI3.IInspectable;

      function CreateFromAddress
      (
         this : access IPlaceInfoStatics2_Interface;
         displayAddress : WinUI3.HString;
         RetVal : access WinUI3.Windows.Services.Maps.IPlaceInfo
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_IPlaceInfoStatics2 : aliased WinUI3.IID := (1930363465, 16455, 17571, (143, 129, 37, 80, 165, 33, 99, 112 ));
   ...
   return WinUI3.Windows.Services.Maps.WaypointKind;
   ...
   return WinUI3.Windows.Services.Maps.ManeuverWarningKind;

   function get_Severity
   (
      this : in out ManeuverWarning
   )
   return WinUI3.Windows.Services.Maps.ManeuverWarningSeverity;
   ...
   return WinUI3.Windows.Services.Maps.MapAddress'Class;
   ...
   package MapLocationFinder is
      ...
      return WinUI3.Windows.Services.Maps.MapLocationFinderResult;
   ...
   return WinUI3.Windows.Services.Maps.MapLocationFinderStatus;
   ...
   return WinUI3.Windows.Services.Maps.MapRouteRestrictions;
   ...
   return WinUI3.Windows.Services.Maps.TrafficCongestion;
   ...
   return WinUI3.Windows.Services.Maps.MapRouteOptimization;
   ...
   package MapRouteFinder is
      ...
      return WinUI3.Windows.Services.Maps.MapRouteFinderResult;
   ...
   return WinUI3.Windows.Services.Maps.MapRouteFinderStatus;
   ...
   return WinUI3.Windows.Services.Maps.MapRouteManeuverKind;
   ...
   return WinUI3.Windows.Services.Maps.MapManeuverNotices;
   ...
   package MapService is
      ...
      function get_DataUsagePreference
      return WinUI3.Windows.Services.Maps.MapServiceDataUsagePreference;
   ...
   return WinUI3.Windows.Services.Maps.PlaceInfo;
