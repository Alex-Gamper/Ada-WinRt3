...
--------------------------------------------------------------------------------
package body WinUI3.Windows.Devices.WiFiDirect.Services is

   package IAsyncOperation_WiFiDirectServiceProvisioningInfo is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.Devices.WiFiDirect.Services.IWiFiDirectServiceProvisioningInfo);
   package AsyncOperationCompletedHandler_WiFiDirectServiceProvisioningInfo is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.Devices.WiFiDirect.Services.IWiFiDirectServiceProvisioningInfo);

   package IAsyncOperation_WiFiDirectServiceSession is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.Devices.WiFiDirect.Services.IWiFiDirectServiceSession);
   package AsyncOperationCompletedHandler_WiFiDirectServiceSession is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.Devices.WiFiDirect.Services.IWiFiDirectServiceSession);

   package IAsyncOperation_WiFiDirectService is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.Devices.WiFiDirect.Services.IWiFiDirectService);
   package AsyncOperationCompletedHandler_WiFiDirectService is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.Devices.WiFiDirect.Services.IWiFiDirectService);
   ...
   return WinUI3.WString is
      ...
      m_hString        : constant WinUI3.HString := To_HString ("Windows.Devices.WiFiDirect.Services.WiFiDirectService");
      m_Factory        : access WinUI3.Windows.Devices.WiFiDirect.Services.IWiFiDirectServiceStatics_Interface'Class := null;
      temp             : WinUI3.UInt32 := 0;
   ...
   return WinUI3.Windows.Devices.WiFiDirect.Services.WiFiDirectService is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_hString        : constant WinUI3.HString := To_HString ("Windows.Devices.WiFiDirect.Services.WiFiDirectService");
      m_Factory        : access WinUI3.Windows.Devices.WiFiDirect.Services.IWiFiDirectServiceStatics_Interface'Class := null;
      ...
      m_RetVal         : aliased WinUI3.Windows.Devices.WiFiDirect.Services.IWiFiDirectService;
      m_IID            : aliased WinUI3.IID := (3304729320, 20471, 23200, (175, 151, 237, 133, 234, 102, 249, 174 )); -- Windows.Devices.WiFiDirect.Services.WiFiDirectService;
      m_HandlerIID     : aliased WinUI3.IID := (4110787528, 18487, 24078, (138, 77, 30, 42, 245, 71, 126, 92 ));
   ...
   begin
      return RetVal : WinUI3.Windows.Devices.WiFiDirect.Services.WiFiDirectService do
         Hr := RoGetActivationFactory (m_hString, IID_IWiFiDirectServiceStatics'Access , m_Factory'Address);
         if Hr = S_OK then
            ...
            if Hr = S_OK then
               ...
               if m_AsyncOperation /= null then
                  ...
                  if m_AsyncStatus = Completed_e then
                     ...
                     Retval.m_IWiFiDirectService := new WinUI3.Windows.Devices.WiFiDirect.Services.IWiFiDirectService;
   ...
   return WinUI3.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceError is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceError;
   begin
   ...
   return WinUI3.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceProvisioningInfo'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_Temp           : WinUI3.Int32 := 0;
      ...
      m_AsyncStatus    : aliased WinUI3.Windows.Foundation.AsyncStatus;
      m_ComRetVal      : aliased WinUI3.GenericObject := null;
      m_RetVal         : aliased WinUI3.Windows.Devices.WiFiDirect.Services.IWiFiDirectServiceProvisioningInfo;
      m_IID            : aliased WinUI3.IID := (3623505348, 18224, 20590, (191, 240, 128, 30, 180, 168, 49, 168 )); -- Windows.Devices.WiFiDirect.Services.WiFiDirectServiceProvisioningInfo;
      m_HandlerIID     : aliased WinUI3.IID := (2496370024, 1034, 20870, (163, 201, 82, 104, 14, 225, 121, 132 ));
   ...
   begin
      return RetVal : WinUI3.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceProvisioningInfo do
         ...
         if Hr = S_OK then
            ...
            if m_AsyncOperation /= null then
               ...
               if m_AsyncStatus = Completed_e then
                  Hr := m_AsyncOperation.GetResults (m_RetVal'Access);
                  Retval.m_IWiFiDirectServiceProvisioningInfo := new WinUI3.Windows.Devices.WiFiDirect.Services.IWiFiDirectServiceProvisioningInfo;
   ...
   return WinUI3.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSession'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_Temp           : WinUI3.Int32 := 0;
      ...
      m_AsyncStatus    : aliased WinUI3.Windows.Foundation.AsyncStatus;
      m_ComRetVal      : aliased WinUI3.GenericObject := null;
      m_RetVal         : aliased WinUI3.Windows.Devices.WiFiDirect.Services.IWiFiDirectServiceSession;
      m_IID            : aliased WinUI3.IID := (3269086871, 29323, 21505, (169, 217, 58, 1, 133, 69, 10, 242 )); -- Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSession;
      m_HandlerIID     : aliased WinUI3.IID := (2996692753, 24760, 23002, (143, 77, 252, 121, 216, 204, 212, 34 ));
   ...
   begin
      return RetVal : WinUI3.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSession do
         ...
         if Hr = S_OK then
            ...
            if m_AsyncOperation /= null then
               ...
               if m_AsyncStatus = Completed_e then
                  Hr := m_AsyncOperation.GetResults (m_RetVal'Access);
                  Retval.m_IWiFiDirectServiceSession := new WinUI3.Windows.Devices.WiFiDirect.Services.IWiFiDirectServiceSession;
   ...
   return WiFiDirectServiceAdvertiser is
      Hr           : WinUI3.HResult := S_OK;
      tmp          : WinUI3.HResult := S_OK;
      m_hString    : constant WinUI3.HString := To_HString ("Windows.Devices.WiFiDirect.Services.IWiFiDirectServiceAdvertiser");
      m_Factory    : access IWiFiDirectServiceAdvertiserFactory_Interface'Class := null;
      temp         : WinUI3.UInt32 := 0;
      m_ComRetVal  : aliased WinUI3.Windows.Devices.WiFiDirect.Services.IWiFiDirectServiceAdvertiser;
      HStr_serviceName : constant WinUI3.HString := To_HString (serviceName);
   begin
      return RetVal : WiFiDirectServiceAdvertiser do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IWiFiDirectServiceAdvertiser := new WinUI3.Windows.Devices.WiFiDirect.Services.IWiFiDirectServiceAdvertiser;
   ...
   return WinUI3.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceStatus is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceStatus;
   begin
   ...
   return WinUI3.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceAdvertisementStatus is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceAdvertisementStatus;
   begin
   ...
   return WinUI3.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSession'Class is
      ...
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Devices.WiFiDirect.Services.IWiFiDirectServiceSession;
   begin
      return RetVal : WinUI3.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSession do
   ...
   return WinUI3.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceConfigurationMethod is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceConfigurationMethod;
   begin
   ...
   return WinUI3.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceIPProtocol is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceIPProtocol;
   begin
   ...
   return WinUI3.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSessionStatus is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSessionStatus;
   begin
   ...
   return WinUI3.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSessionErrorStatus is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSessionErrorStatus;
   begin
   ...
   (
      ...
      temp             : WinUI3.UInt32 := 0;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Devices.WiFiDirect.Services.IWiFiDirectServiceSession_Interface, WinUI3.Windows.Foundation.IClosable, WinUI3.Windows.Foundation.IID_IClosable'Unchecked_Access);
   begin
   ...
   return WinUI3.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceProvisioningInfo'Class is
      ...
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Devices.WiFiDirect.Services.IWiFiDirectServiceProvisioningInfo;
   begin
      return RetVal : WinUI3.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceProvisioningInfo do
   ...
   (
      ...
      m_Interface      : WinUI3.Windows.Foundation.IClosable := null;
      temp             : WinUI3.UInt32 := 0;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Devices.WiFiDirect.Services.IWiFiDirectServiceSessionRequest_Interface, WinUI3.Windows.Foundation.IClosable, WinUI3.Windows.Foundation.IID_IClosable'Unchecked_Access);
   begin
   ...
   return WinUI3.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSessionRequest'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Devices.WiFiDirect.Services.IWiFiDirectServiceSessionRequest;
   begin
      return RetVal : WinUI3.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSessionRequest do
         Hr := this.m_IWiFiDirectServiceSessionRequestedEventArgs.all.GetSessionRequest (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IWiFiDirectServiceSessionRequest := new WinUI3.Windows.Devices.WiFiDirect.Services.IWiFiDirectServiceSessionRequest;
