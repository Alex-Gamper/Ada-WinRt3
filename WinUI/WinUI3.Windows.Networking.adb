...
--------------------------------------------------------------------------------
package body WinUI3.Windows.Networking is
   ...
   begin
      return RetVal : EndpointPair do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IEndpointPair := new WinUI3.Windows.Networking.IEndpointPair;
   ...
   return HostName is
      ...
      temp         : WinUI3.UInt32 := 0;
      m_ComRetVal  : aliased WinUI3.Windows.Networking.IHostName;
      HStr_hostName_p : constant WinUI3.HString := To_HString (hostName_p);
   begin
   ...
   return WinUI3.Int32 is
      ...
      m_Factory        : access WinUI3.Windows.Networking.IHostNameStatics_Interface'Class := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Int32;
      HStr_value1 : constant WinUI3.HString := To_HString (value1);
      HStr_value2 : constant WinUI3.HString := To_HString (value2);
   begin
   ...
   return WinUI3.Windows.Networking.Connectivity.IPInformation'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Networking.Connectivity.IIPInformation;
   begin
      return RetVal : WinUI3.Windows.Networking.Connectivity.IPInformation do
         Hr := this.m_IHostName.all.get_IPInformation (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IIPInformation := new WinUI3.Windows.Networking.Connectivity.IIPInformation;
   ...
   return WinUI3.Windows.Networking.HostNameType is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Networking.HostNameType;
   begin
   ...
   return WinUI3.WString is
      ...
      m_ComRetVal      : aliased WinUI3.HString;
      AdaRetval        : WString;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Networking.IHostName_Interface, WinUI3.Windows.Foundation.IStringable, WinUI3.Windows.Foundation.IID_IStringable'Unchecked_Access);
   begin
