...
--------------------------------------------------------------------------------
package WinUI3.Windows.Graphics.Display.Core is
   ...
   type IHdmiDisplayInformation_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IHdmiDisplayInformationStatics_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IHdmiDisplayMode_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IHdmiDisplayMode2_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type HdmiDisplayHdr2086Metadata is record
      RedPrimaryX : WinUI3.UInt16;
      RedPrimaryY : WinUI3.UInt16;
      GreenPrimaryX : WinUI3.UInt16;
      GreenPrimaryY : WinUI3.UInt16;
      BluePrimaryX : WinUI3.UInt16;
      BluePrimaryY : WinUI3.UInt16;
      WhitePointX : WinUI3.UInt16;
      WhitePointY : WinUI3.UInt16;
      MaxMasteringLuminance : WinUI3.UInt16;
      MinMasteringLuminance : WinUI3.UInt16;
      MaxContentLightLevel : WinUI3.UInt16;
      MaxFrameAverageLightLevel : WinUI3.UInt16;
   ...
   package IVectorView_IHdmiDisplayMode is new WinUI3.Windows.Foundation.Collections.IVectorView (IHdmiDisplayMode);
   IID_IVectorView_IHdmiDisplayMode : aliased WinUI3.IID := (3094977450, 37932, 22507, (188, 62, 107, 26, 168, 47, 195, 177 ));
   ...
   -----------------------------------------------------------------------------
   -- type IHdmiDisplayInformation is interface and WinUI3.IInspectable;
      ...
      (
         this : access IHdmiDisplayInformation_Interface;
         RetVal : access WinUI3.Windows.Graphics.Display.Core.IHdmiDisplayMode
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         this : access IHdmiDisplayInformation_Interface;
         mode : WinUI3.Windows.Graphics.Display.Core.IHdmiDisplayMode;
         RetVal : access GenericObject
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_IHdmiDisplayInformation : aliased WinUI3.IID := (319503370, 62821, 18286, (171, 213, 234, 5, 174, 231, 76, 105 ));

   -----------------------------------------------------------------------------
   -- type IHdmiDisplayInformationStatics is interface and WinUI3.IInspectable;

      function GetForCurrentView
      (
         this : access IHdmiDisplayInformationStatics_Interface;
         RetVal : access WinUI3.Windows.Graphics.Display.Core.IHdmiDisplayInformation
      )
      return WinUI3.Hresult is abstract;

      IID_IHdmiDisplayInformationStatics : aliased WinUI3.IID := (1827058272, 62506, 18965, (145, 76, 123, 142, 42, 90, 101, 223 ));

   -----------------------------------------------------------------------------
   -- type IHdmiDisplayMode is interface and WinUI3.IInspectable;
      ...
      (
         this : access IHdmiDisplayMode_Interface;
         RetVal : access WinUI3.Windows.Graphics.Display.Core.HdmiDisplayColorSpace
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         this : access IHdmiDisplayMode_Interface;
         RetVal : access WinUI3.Windows.Graphics.Display.Core.HdmiDisplayPixelEncoding
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_IHdmiDisplayMode : aliased WinUI3.IID := (201774509, 7056, 20305, (153, 129, 239, 90, 28, 13, 223, 102 ));

   -----------------------------------------------------------------------------
   -- type IHdmiDisplayMode2 is interface and WinUI3.IInspectable;
      ...
      IID_IHdmiDisplayMode2 : aliased WinUI3.IID := (130895519, 19260, 17080, (132, 231, 137, 83, 104, 113, 138, 242 ));
   ...
   function GetForCurrentView
   return WinUI3.Windows.Graphics.Display.Core.HdmiDisplayInformation;
   ...
   return WinUI3.Windows.Graphics.Display.Core.HdmiDisplayMode'Class;
   ...
   return WinUI3.Windows.Graphics.Display.Core.HdmiDisplayColorSpace;

   function get_PixelEncoding
   (
      this : in out HdmiDisplayMode
   )
   return WinUI3.Windows.Graphics.Display.Core.HdmiDisplayPixelEncoding;
