...
--------------------------------------------------------------------------------
package body WinUI3.Windows.UI.Core.AnimationMetrics is
   ...
   return AnimationDescription is
      ...
      m_hString    : constant WinUI3.HString := To_HString ("Windows.UI.Core.AnimationMetrics.IAnimationDescription");
      m_Factory    : access IAnimationDescriptionFactory_Interface'Class := null;
      temp         : WinUI3.UInt32 := 0;
      m_ComRetVal  : aliased WinUI3.Windows.UI.Core.AnimationMetrics.IAnimationDescription;
   begin
      return RetVal : AnimationDescription do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IAnimationDescription := new WinUI3.Windows.UI.Core.AnimationMetrics.IAnimationDescription;
   ...
   return WinUI3.Windows.UI.Core.AnimationMetrics.PropertyAnimationType is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.UI.Core.AnimationMetrics.IPropertyAnimation := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.UI.Core.AnimationMetrics.PropertyAnimationType;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.UI.Core.AnimationMetrics.IOpacityAnimation_Interface, WinUI3.Windows.UI.Core.AnimationMetrics.IPropertyAnimation, WinUI3.Windows.UI.Core.AnimationMetrics.IID_IPropertyAnimation'Unchecked_Access);
   begin
   ...
   return WinUI3.Windows.UI.Core.AnimationMetrics.PropertyAnimationType is
      ...
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.UI.Core.AnimationMetrics.PropertyAnimationType;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.UI.Core.AnimationMetrics.IScaleAnimation_Interface, WinUI3.Windows.UI.Core.AnimationMetrics.IPropertyAnimation, WinUI3.Windows.UI.Core.AnimationMetrics.IID_IPropertyAnimation'Unchecked_Access);
   begin
