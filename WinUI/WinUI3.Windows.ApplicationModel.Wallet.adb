...
--------------------------------------------------------------------------------
package body WinUI3.Windows.ApplicationModel.Wallet is
   ...
   package IAsyncOperation_WalletItemStore is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.ApplicationModel.Wallet.IWalletItemStore);
   package AsyncOperationCompletedHandler_WalletItemStore is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.ApplicationModel.Wallet.IWalletItemStore);
   ...
   begin
      return RetVal : WalletBarcode do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IWalletBarcode := new WinUI3.Windows.ApplicationModel.Wallet.IWalletBarcode;
   ...
   return WinUI3.Windows.ApplicationModel.Wallet.WalletBarcodeSymbology is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Wallet.WalletBarcodeSymbology;
   begin
   ...
   return WinUI3.Windows.ApplicationModel.Wallet.WalletItemKind is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Wallet.WalletItemKind;
   begin
   ...
   return WinUI3.Windows.ApplicationModel.Wallet.WalletBarcode'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Wallet.IWalletBarcode;
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.Wallet.WalletBarcode do
   ...
   begin
      return RetVal : WalletItemCustomProperty do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IWalletItemCustomProperty := new WinUI3.Windows.ApplicationModel.Wallet.IWalletItemCustomProperty;
   ...
   return WinUI3.Windows.ApplicationModel.Wallet.WalletDetailViewPosition is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Wallet.WalletDetailViewPosition;
   begin
   ...
   return WinUI3.Windows.ApplicationModel.Wallet.WalletSummaryViewPosition is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Wallet.WalletSummaryViewPosition;
   begin
   ...
   package body WalletManager is
      ...
      return WinUI3.Windows.ApplicationModel.Wallet.WalletItemStore is
         Hr               : WinUI3.HResult := S_OK;
         tmp              : WinUI3.HResult := S_OK;
         m_hString        : constant WinUI3.HString := To_HString ("Windows.ApplicationModel.Wallet.WalletManager");
         m_Factory        : access WinUI3.Windows.ApplicationModel.Wallet.IWalletManagerStatics_Interface'Class := null;
         temp             : WinUI3.UInt32 := 0;
         m_Temp           : WinUI3.Int32 := 0;
         m_Completed      : WinUI3.UInt32 := 0;
         m_Captured       : WinUI3.UInt32 := 0;
         ...
         m_AsyncStatus    : aliased WinUI3.Windows.Foundation.AsyncStatus;
         m_ComRetVal      : aliased WinUI3.GenericObject := null;
         m_RetVal         : aliased WinUI3.Windows.ApplicationModel.Wallet.IWalletItemStore;
         m_IID            : aliased WinUI3.IID := (2523198394, 73, 23743, (132, 95, 143, 11, 202, 210, 177, 76 )); -- Windows.ApplicationModel.Wallet.WalletItemStore;
         m_HandlerIID     : aliased WinUI3.IID := (1395955550, 8282, 23404, (150, 253, 137, 111, 185, 57, 73, 189 ));
      ...
      begin
         return RetVal : WinUI3.Windows.ApplicationModel.Wallet.WalletItemStore do
            ...
            if Hr = S_OK then
               ...
               if Hr = S_OK then
                  ...
                  if m_AsyncOperation /= null then
                     ...
                     if m_AsyncStatus = Completed_e then
                        Hr := m_AsyncOperation.GetResults (m_RetVal'Access);
                        Retval.m_IWalletItemStore := new WinUI3.Windows.ApplicationModel.Wallet.IWalletItemStore;
   ...
   begin
      return RetVal : WalletRelevantLocation do
         ...
         if Hr = S_OK then
            Retval.m_IWalletRelevantLocation := new WinUI3.Windows.ApplicationModel.Wallet.IWalletRelevantLocation;
   ...
   begin
      return RetVal : WalletTransaction do
         Hr := RoActivateInstance (m_hString, m_ComRetVal'Address);
         if Hr = S_OK then
            Retval.m_IWalletTransaction := new WinUI3.Windows.ApplicationModel.Wallet.IWalletTransaction;
   ...
   begin
      return RetVal : WalletVerb do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IWalletVerb := new WinUI3.Windows.ApplicationModel.Wallet.IWalletVerb;
