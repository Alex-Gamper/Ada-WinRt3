...
--------------------------------------------------------------------------------
package WinUI3.Windows.Devices.Bluetooth.Background is
   ...
   type IBluetoothLEAdvertisementPublisherTriggerDetails_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IBluetoothLEAdvertisementPublisherTriggerDetails2_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IBluetoothLEAdvertisementWatcherTriggerDetails_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGattCharacteristicNotificationTriggerDetails_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGattCharacteristicNotificationTriggerDetails2_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGattServiceProviderConnection_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGattServiceProviderConnection2_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGattServiceProviderConnectionStatics_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGattServiceProviderTriggerDetails_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IRfcommConnectionTriggerDetails_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IRfcommInboundConnectionInformation_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IRfcommOutboundConnectionInformation_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   IID_IReference_Int16 : aliased WinUI3.IID := (3164144035, 10233, 23172, (130, 83, 137, 92, 190, 87, 133, 38 ));
   ...
   -----------------------------------------------------------------------------
   -- type IBluetoothLEAdvertisementPublisherTriggerDetails is interface and WinUI3.IInspectable;
      ...
      IID_IBluetoothLEAdvertisementPublisherTriggerDetails : aliased WinUI3.IID := (1628359302, 13440, 16841, (169, 24, 125, 218, 223, 32, 126, 0 ));

   -----------------------------------------------------------------------------
   -- type IBluetoothLEAdvertisementPublisherTriggerDetails2 is interface and WinUI3.IInspectable;
      ...
      IID_IBluetoothLEAdvertisementPublisherTriggerDetails2 : aliased WinUI3.IID := (3567505445, 50689, 17110, (152, 41, 76, 203, 63, 92, 215, 127 ));

   -----------------------------------------------------------------------------
   -- type IBluetoothLEAdvertisementWatcherTriggerDetails is interface and WinUI3.IInspectable;
      ...
      IID_IBluetoothLEAdvertisementWatcherTriggerDetails : aliased WinUI3.IID := (2816170711, 8791, 20073, (151, 132, 254, 230, 69, 193, 220, 224 ));

   -----------------------------------------------------------------------------
   -- type IGattCharacteristicNotificationTriggerDetails is interface and WinUI3.IInspectable;
      ...
      IID_IGattCharacteristicNotificationTriggerDetails : aliased WinUI3.IID := (2610969368, 4076, 17258, (147, 177, 244, 108, 105, 117, 50, 162 ));

   -----------------------------------------------------------------------------
   -- type IGattCharacteristicNotificationTriggerDetails2 is interface and WinUI3.IInspectable;
      ...
      IID_IGattCharacteristicNotificationTriggerDetails2 : aliased WinUI3.IID := (1920618716, 38045, 17738, (177, 146, 152, 52, 103, 227, 213, 15 ));

   -----------------------------------------------------------------------------
   -- type IGattServiceProviderConnection is interface and WinUI3.IInspectable;
      ...
      IID_IGattServiceProviderConnection : aliased WinUI3.IID := (2141305273, 12051, 16565, (149, 130, 142, 183, 142, 152, 239, 19 ));

   -----------------------------------------------------------------------------
   -- type IGattServiceProviderConnection2 is interface and WinUI3.IInspectable;
      ...
      IID_IGattServiceProviderConnection2 : aliased WinUI3.IID := (2429627360, 60352, 18511, (174, 10, 126, 184, 182, 38, 107, 172 ));

   -----------------------------------------------------------------------------
   -- type IGattServiceProviderConnectionStatics is interface and WinUI3.IInspectable;
      ...
      IID_IGattServiceProviderConnectionStatics : aliased WinUI3.IID := (1028693835, 2830, 17510, (184, 205, 110, 189, 218, 31, 161, 125 ));

   -----------------------------------------------------------------------------
   -- type IGattServiceProviderTriggerDetails is interface and WinUI3.IInspectable;

      function get_Connection
      (
         this : access IGattServiceProviderTriggerDetails_Interface;
         RetVal : access WinUI3.Windows.Devices.Bluetooth.Background.IGattServiceProviderConnection
      )
      return WinUI3.Hresult is abstract;

      IID_IGattServiceProviderTriggerDetails : aliased WinUI3.IID := (2928412197, 1535, 19195, (177, 106, 222, 149, 243, 207, 1, 88 ));

   -----------------------------------------------------------------------------
   -- type IRfcommConnectionTriggerDetails is interface and WinUI3.IInspectable;
      ...
      IID_IRfcommConnectionTriggerDetails : aliased WinUI3.IID := (4179784525, 11836, 20220, (171, 89, 252, 92, 249, 111, 151, 227 ));

   -----------------------------------------------------------------------------
   -- type IRfcommInboundConnectionInformation is interface and WinUI3.IInspectable;
      ...
      (
         this : access IRfcommInboundConnectionInformation_Interface;
         value : WinUI3.Windows.Devices.Bluetooth.Rfcomm.IRfcommServiceId
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         this : access IRfcommInboundConnectionInformation_Interface;
         value : WinUI3.Windows.Devices.Bluetooth.BluetoothServiceCapabilities
      )
      return WinUI3.Hresult is abstract;

      IID_IRfcommInboundConnectionInformation : aliased WinUI3.IID := (1832809896, 21545, 16473, (146, 227, 30, 139, 101, 82, 135, 7 ));

   -----------------------------------------------------------------------------
   -- type IRfcommOutboundConnectionInformation is interface and WinUI3.IInspectable;
      ...
      IID_IRfcommOutboundConnectionInformation : aliased WinUI3.IID := (2962301563, 62516, 19632, (153, 177, 74, 184, 206, 218, 237, 215 ));
   ...
   return WinUI3.Windows.Devices.Bluetooth.Background.GattServiceProviderConnection'Class;
   ...
   (
      this : in out RfcommInboundConnectionInformation;
      value : WinUI3.Windows.Devices.Bluetooth.Rfcomm.RfcommServiceId'Class
   );
...
end WinUI3.Windows.Devices.Bluetooth.Background;
