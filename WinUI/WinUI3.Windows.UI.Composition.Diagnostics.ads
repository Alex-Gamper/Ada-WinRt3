...
--------------------------------------------------------------------------------
package WinUI3.Windows.UI.Composition.Diagnostics is
   ...
   -- type ICompositionDebugHeatMaps is interface and WinUI3.IInspectable;
      ...
      (
         ...
         subtree : WinUI3.Windows.UI.Composition.IVisual
      )
      ...
      (
         this : access ICompositionDebugHeatMaps_Interface;
         subtree : WinUI3.Windows.UI.Composition.IVisual;
         contentKinds : WinUI3.Windows.UI.Composition.Diagnostics.CompositionDebugOverdrawContentKinds
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_ICompositionDebugHeatMaps : aliased WinUI3.IID := (3835465900, 12275, 22533, (113, 140, 183, 37, 238, 7, 101, 15 ));
   ...
   -- type ICompositionDebugSettings is interface and WinUI3.IInspectable;
      ...
      (
         ...
         RetVal : access WinUI3.Windows.UI.Composition.Diagnostics.ICompositionDebugHeatMaps
      )
      return WinUI3.Hresult is abstract;

      IID_ICompositionDebugSettings : aliased WinUI3.IID := (674338942, 7554, 19768, (183, 183, 239, 209, 28, 123, 195, 209 ));
   ...
   -- type ICompositionDebugSettingsStatics is interface and WinUI3.IInspectable;
      ...
      (
         ...
         RetVal : access WinUI3.Windows.UI.Composition.Diagnostics.ICompositionDebugSettings
      )
      return WinUI3.Hresult is abstract;

      IID_ICompositionDebugSettingsStatics : aliased WinUI3.IID := (1693196062, 27384, 19192, (184, 20, 200, 112, 253, 90, 149, 5 ));
   ...
   (
      ...
      subtree : WinUI3.Windows.UI.Composition.Visual'Class
   );
   ...
   return WinUI3.Windows.UI.Composition.Diagnostics.CompositionDebugSettings;
   ...
   return WinUI3.Windows.UI.Composition.Diagnostics.CompositionDebugHeatMaps'Class;

end WinUI3.Windows.UI.Composition.Diagnostics;
