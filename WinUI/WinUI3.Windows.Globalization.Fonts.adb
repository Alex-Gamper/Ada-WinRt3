...
--------------------------------------------------------------------------------
package body WinUI3.Windows.Globalization.Fonts is
   ...
   begin
      return RetVal : LanguageFontGroup do
         ...
         if Hr = S_OK then
            ...
            Retval.m_ILanguageFontGroup := new WinUI3.Windows.Globalization.Fonts.ILanguageFontGroup;
   ...
   return WinUI3.Windows.Globalization.Fonts.LanguageFont'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Globalization.Fonts.ILanguageFont;
   begin
      return RetVal : WinUI3.Windows.Globalization.Fonts.LanguageFont do
         Hr := this.m_ILanguageFontGroup.all.get_UITextFont (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_ILanguageFont := new WinUI3.Windows.Globalization.Fonts.ILanguageFont;
