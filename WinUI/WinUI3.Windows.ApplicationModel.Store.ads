...
--------------------------------------------------------------------------------
package WinUI3.Windows.ApplicationModel.Store is
   ...
   type ICurrentApp_Interface is interface and WinUI3.IInspectable_Interface;
   type ICurrentApp is access all ICurrentApp_Interface'Class;
   type ICurrentApp_Ptr is access all ICurrentApp;

   type ICurrentApp2Statics_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type ICurrentAppSimulator_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type ICurrentAppSimulatorStaticsWithFiltering_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type ICurrentAppSimulatorWithCampaignId_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type ICurrentAppSimulatorWithConsumables_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type ICurrentAppStaticsWithFiltering_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type ICurrentAppWithCampaignId_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type ICurrentAppWithConsumables_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type ILicenseInformation_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IListingInformation_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IListingInformation2_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IProductLicense_Interface is interface and WinUI3.IInspectable_Interface;
   type IProductLicense is access all IProductLicense_Interface'Class;
   type IProductLicense_Ptr is access all IProductLicense;

   type IProductLicenseWithFulfillment_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IProductListing_Interface is interface and WinUI3.IInspectable_Interface;
   type IProductListing is access all IProductListing_Interface'Class;
   type IProductListing_Ptr is access all IProductListing;

   type IProductListing2_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IProductListingWithConsumables_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IProductListingWithMetadata_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IProductPurchaseDisplayProperties_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IProductPurchaseDisplayPropertiesFactory_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IPurchaseResults_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IUnfulfilledConsumable_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   IID_LicenseChangedEventHandler : aliased WinUI3.IID := (3567583829, 4969, 19510, (131, 47, 111, 45, 136, 227, 101, 155 ));
   type LicenseChangedEventHandler_Delegate (Callback : access procedure ) is new WinUI3.IMulticastDelegate_Interface (IID_LicenseChangedEventHandler'Access) with null record;
      function Invoke
      (
   ...
   package IMapView_HString_IProductLicense is new WinUI3.Windows.Foundation.Collections.IMapView (WinUI3.HString, IProductLicense);
   IID_IMapView_HString_IProductLicense : aliased WinUI3.IID := (348922225, 54599, 21311, (141, 115, 115, 6, 206, 197, 147, 235 ));
   ...
   package IMapView_HString_IProductListing is new WinUI3.Windows.Foundation.Collections.IMapView (WinUI3.HString, IProductListing);
   IID_IMapView_HString_IProductListing : aliased WinUI3.IID := (4125311269, 42831, 21305, (128, 17, 9, 219, 230, 11, 82, 130 ));
   ...
   IID_IIterable_HString : aliased WinUI3.IID := (1095481932, 52133, 24215, (142, 217, 160, 227, 205, 139, 60, 37 ));
   ...
   -----------------------------------------------------------------------------
   -- type ICurrentApp is interface and WinUI3.IInspectable;

      function get_LicenseInformation
      (
         this : access ICurrentApp_Interface;
         RetVal : access WinUI3.Windows.ApplicationModel.Store.ILicenseInformation
      )
      ...
      IID_ICurrentApp : aliased WinUI3.IID := (3576545381, 55871, 18053, (153, 94, 155, 72, 46, 181, 230, 3 ));

   -----------------------------------------------------------------------------
   -- type ICurrentApp2Statics is interface and WinUI3.IInspectable;
      ...
      IID_ICurrentApp2Statics : aliased WinUI3.IID := (3746459181, 12657, 19155, (134, 20, 44, 97, 36, 67, 115, 203 ));

   -----------------------------------------------------------------------------
   -- type ICurrentAppSimulator is interface and WinUI3.IInspectable;
      ...
      (
         this : access ICurrentAppSimulator_Interface;
         simulatorSettingsFile : WinUI3.Windows.Storage.IStorageFile;
         RetVal : access WinUI3.Windows.Foundation.IAsyncAction
      )
      return WinUI3.Hresult is abstract;

      IID_ICurrentAppSimulator : aliased WinUI3.IID := (4051672497, 29901, 18311, (151, 135, 25, 134, 110, 154, 85, 89 ));

   -----------------------------------------------------------------------------
   -- type ICurrentAppSimulatorStaticsWithFiltering is interface and WinUI3.IInspectable;
      ...
      IID_ICurrentAppSimulatorStaticsWithFiltering : aliased WinUI3.IID := (1635676386, 63599, 19284, (150, 102, 221, 226, 133, 9, 44, 104 ));

   -----------------------------------------------------------------------------
   -- type ICurrentAppSimulatorWithCampaignId is interface and WinUI3.IInspectable;
      ...
      IID_ICurrentAppSimulatorWithCampaignId : aliased WinUI3.IID := (2221378115, 57088, 18034, (164, 63, 178, 91, 20, 65, 207, 207 ));

   -----------------------------------------------------------------------------
   -- type ICurrentAppSimulatorWithConsumables is interface and WinUI3.IInspectable;
      ...
      (
         this : access ICurrentAppSimulatorWithConsumables_Interface;
         productId : WinUI3.HString;
         offerId : WinUI3.HString;
         displayProperties : WinUI3.Windows.ApplicationModel.Store.IProductPurchaseDisplayProperties;
         RetVal : access GenericObject
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_ICurrentAppSimulatorWithConsumables : aliased WinUI3.IID := (1313992875, 8423, 17426, (155, 133, 89, 187, 120, 56, 134, 103 ));

   -----------------------------------------------------------------------------
   -- type ICurrentAppStaticsWithFiltering is interface and WinUI3.IInspectable;
      ...
      IID_ICurrentAppStaticsWithFiltering : aliased WinUI3.IID := (3547161922, 36997, 17294, (151, 186, 162, 92, 151, 107, 226, 253 ));

   -----------------------------------------------------------------------------
   -- type ICurrentAppWithCampaignId is interface and WinUI3.IInspectable;
      ...
      IID_ICurrentAppWithCampaignId : aliased WinUI3.IID := (825183440, 14017, 17574, (179, 43, 67, 45, 96, 142, 77, 214 ));

   -----------------------------------------------------------------------------
   -- type ICurrentAppWithConsumables is interface and WinUI3.IInspectable;
      ...
      IID_ICurrentAppWithConsumables : aliased WinUI3.IID := (2219704433, 40527, 20345, (153, 90, 95, 145, 23, 46, 108, 239 ));

   -----------------------------------------------------------------------------
   -- type ILicenseInformation is interface and WinUI3.IInspectable;
      ...
      IID_ILicenseInformation : aliased WinUI3.IID := (2394414128, 61808, 20181, (142, 33, 21, 22, 218, 63, 211, 103 ));

   -----------------------------------------------------------------------------
   -- type IListingInformation is interface and WinUI3.IInspectable;
      ...
      IID_IListingInformation : aliased WinUI3.IID := (1485523647, 48244, 17283, (183, 140, 153, 96, 99, 35, 222, 206 ));

   -----------------------------------------------------------------------------
   -- type IListingInformation2 is interface and WinUI3.IInspectable;
      ...
      IID_IListingInformation2 : aliased WinUI3.IID := (3237817373, 45838, 17284, (132, 234, 114, 254, 250, 130, 34, 62 ));

   -----------------------------------------------------------------------------
   -- type IProductLicense is interface and WinUI3.IInspectable;
      ...
      IID_IProductLicense : aliased WinUI3.IID := (909314247, 11215, 19470, (143, 47, 232, 8, 170, 168, 249, 157 ));

   -----------------------------------------------------------------------------
   -- type IProductLicenseWithFulfillment is interface and WinUI3.IInspectable;
      ...
      IID_IProductLicenseWithFulfillment : aliased WinUI3.IID := (4233321610, 63079, 16627, (186, 60, 4, 90, 99, 171, 179, 172 ));

   -----------------------------------------------------------------------------
   -- type IProductListing is interface and WinUI3.IInspectable;
      ...
      IID_IProductListing : aliased WinUI3.IID := (1168627373, 51024, 19868, (148, 124, 176, 13, 203, 249, 233, 194 ));

   -----------------------------------------------------------------------------
   -- type IProductListing2 is interface and WinUI3.IInspectable;
      ...
      IID_IProductListing2 : aliased WinUI3.IID := (4171114767, 29694, 18765, (169, 57, 8, 169, 178, 73, 90, 190 ));

   -----------------------------------------------------------------------------
   -- type IProductListingWithConsumables is interface and WinUI3.IInspectable;

      function get_ProductType
      (
         this : access IProductListingWithConsumables_Interface;
         RetVal : access WinUI3.Windows.ApplicationModel.Store.ProductType
      )
      return WinUI3.Hresult is abstract;

      IID_IProductListingWithConsumables : aliased WinUI3.IID := (3953039248, 36715, 18463, (147, 167, 92, 58, 99, 6, 129, 73 ));

   -----------------------------------------------------------------------------
   -- type IProductListingWithMetadata is interface and WinUI3.IInspectable;
      ...
      IID_IProductListingWithMetadata : aliased WinUI3.IID := (307078503, 9208, 16958, (149, 50, 24, 153, 67, 196, 10, 206 ));

   -----------------------------------------------------------------------------
   -- type IProductPurchaseDisplayProperties is interface and WinUI3.IInspectable;
      ...
      IID_IProductPurchaseDisplayProperties : aliased WinUI3.IID := (3607852064, 48274, 16411, (168, 9, 201, 178, 229, 219, 189, 175 ));

   -----------------------------------------------------------------------------
   -- type IProductPurchaseDisplayPropertiesFactory is interface and WinUI3.IInspectable;

      function CreateProductPurchaseDisplayProperties
      (
         this : access IProductPurchaseDisplayPropertiesFactory_Interface;
         name : WinUI3.HString;
         RetVal : access WinUI3.Windows.ApplicationModel.Store.IProductPurchaseDisplayProperties
      )
      return WinUI3.Hresult is abstract;

      IID_IProductPurchaseDisplayPropertiesFactory : aliased WinUI3.IID := (1867062772, 13014, 19264, (180, 116, 184, 48, 56, 164, 217, 207 ));

   -----------------------------------------------------------------------------
   -- type IPurchaseResults is interface and WinUI3.IInspectable;

      function get_Status
      (
         this : access IPurchaseResults_Interface;
         RetVal : access WinUI3.Windows.ApplicationModel.Store.ProductPurchaseStatus
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_IPurchaseResults : aliased WinUI3.IID := (3981489022, 34390, 20325, (184, 200, 172, 126, 12, 177, 161, 194 ));

   -----------------------------------------------------------------------------
   -- type IUnfulfilledConsumable is interface and WinUI3.IInspectable;
      ...
      IID_IUnfulfilledConsumable : aliased WinUI3.IID := (771226555, 7389, 19640, (160, 20, 123, 156, 248, 152, 105, 39 ));
   ...
   package CurrentApp is
      ...
      function get_LicenseInformation
      return WinUI3.Windows.ApplicationModel.Store.LicenseInformation;
      ...
      function LoadListingInformationAsync
      return WinUI3.Windows.ApplicationModel.Store.ListingInformation;
      ...
      return WinUI3.Windows.ApplicationModel.Store.FulfillmentResult;

      function RequestProductPurchaseAsync
      (
         productId : WinUI3.WString
      )
      return WinUI3.Windows.ApplicationModel.Store.PurchaseResults;
   ...
   return WinUI3.Windows.ApplicationModel.Store.ProductType;
   ...
   return WinUI3.Windows.ApplicationModel.Store.ProductPurchaseStatus;
