...
--------------------------------------------------------------------------------
package WinUI3.Windows.Services.Maps.OfflineMaps is
   ...
   type IOfflineMapPackage_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IOfflineMapPackageQueryResult_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IOfflineMapPackageStartDownloadResult_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IOfflineMapPackageStatics_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   package IVectorView_IOfflineMapPackage is new WinUI3.Windows.Foundation.Collections.IVectorView (IOfflineMapPackage);
   IID_IVectorView_IOfflineMapPackage : aliased WinUI3.IID := (3761224259, 57019, 21389, (136, 136, 235, 97, 194, 91, 15, 182 ));
   ...
   -----------------------------------------------------------------------------
   -- type IOfflineMapPackage is interface and WinUI3.IInspectable;

      function get_Status
      (
         this : access IOfflineMapPackage_Interface;
         RetVal : access WinUI3.Windows.Services.Maps.OfflineMaps.OfflineMapPackageStatus
      )
      ...
      IID_IOfflineMapPackage : aliased WinUI3.IID := (2811717435, 42421, 16708, (181, 37, 230, 140, 136, 98, 102, 75 ));

   -----------------------------------------------------------------------------
   -- type IOfflineMapPackageQueryResult is interface and WinUI3.IInspectable;

      function get_Status
      (
         this : access IOfflineMapPackageQueryResult_Interface;
         RetVal : access WinUI3.Windows.Services.Maps.OfflineMaps.OfflineMapPackageQueryStatus
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_IOfflineMapPackageQueryResult : aliased WinUI3.IID := (1431852049, 14817, 20033, (164, 225, 95, 72, 114, 190, 225, 153 ));

   -----------------------------------------------------------------------------
   -- type IOfflineMapPackageStartDownloadResult is interface and WinUI3.IInspectable;

      function get_Status
      (
         this : access IOfflineMapPackageStartDownloadResult_Interface;
         RetVal : access WinUI3.Windows.Services.Maps.OfflineMaps.OfflineMapPackageStartDownloadStatus
      )
      return WinUI3.Hresult is abstract;

      IID_IOfflineMapPackageStartDownloadResult : aliased WinUI3.IID := (3647322392, 54486, 19198, (147, 120, 62, 199, 30, 241, 28, 61 ));

   -----------------------------------------------------------------------------
   -- type IOfflineMapPackageStatics is interface and WinUI3.IInspectable;
      ...
      (
         this : access IOfflineMapPackageStatics_Interface;
         queryBoundingBox : WinUI3.Windows.Devices.Geolocation.IGeoboundingBox;
         RetVal : access GenericObject
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         this : access IOfflineMapPackageStatics_Interface;
         queryCircle : WinUI3.Windows.Devices.Geolocation.IGeocircle;
         RetVal : access GenericObject
      )
      return WinUI3.Hresult is abstract;

      IID_IOfflineMapPackageStatics : aliased WinUI3.IID := (408844578, 43057, 19120, (148, 31, 105, 152, 250, 146, 146, 133 ));
   ...
   return WinUI3.Windows.Services.Maps.OfflineMaps.OfflineMapPackageQueryResult;
   ...
   return WinUI3.Windows.Services.Maps.OfflineMaps.OfflineMapPackageStatus;
   ...
   return WinUI3.Windows.Services.Maps.OfflineMaps.OfflineMapPackageStartDownloadResult'Class;
   ...
   return WinUI3.Windows.Services.Maps.OfflineMaps.OfflineMapPackageQueryStatus;
   ...
   return WinUI3.Windows.Services.Maps.OfflineMaps.OfflineMapPackageStartDownloadStatus;
