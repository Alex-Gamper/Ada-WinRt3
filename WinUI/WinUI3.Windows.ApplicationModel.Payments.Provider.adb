...
--------------------------------------------------------------------------------
package body WinUI3.Windows.ApplicationModel.Payments.Provider is

   package IAsyncOperation_PaymentRequestChangedResult is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.ApplicationModel.Payments.IPaymentRequestChangedResult);
   package AsyncOperationCompletedHandler_PaymentRequestChangedResult is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.ApplicationModel.Payments.IPaymentRequestChangedResult);

   package IAsyncOperation_PaymentTransactionAcceptResult is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.ApplicationModel.Payments.Provider.IPaymentTransactionAcceptResult);
   package AsyncOperationCompletedHandler_PaymentTransactionAcceptResult is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.ApplicationModel.Payments.Provider.IPaymentTransactionAcceptResult);

   package IAsyncOperation_PaymentTransaction is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.ApplicationModel.Payments.Provider.IPaymentTransaction);
   package AsyncOperationCompletedHandler_PaymentTransaction is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.ApplicationModel.Payments.Provider.IPaymentTransaction);
   ...
   return WinUI3.Windows.ApplicationModel.Payments.PaymentRequest'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentRequest;
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.Payments.PaymentRequest do
   ...
   return WinUI3.Windows.ApplicationModel.Payments.Provider.PaymentAppManager is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_hString        : constant WinUI3.HString := To_HString ("Windows.ApplicationModel.Payments.Provider.PaymentAppManager");
      m_Factory        : access WinUI3.Windows.ApplicationModel.Payments.Provider.IPaymentAppManagerStatics_Interface'Class := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Payments.Provider.IPaymentAppManager;
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.Payments.Provider.PaymentAppManager do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IPaymentAppManager := new WinUI3.Windows.ApplicationModel.Payments.Provider.IPaymentAppManager;
   ...
   return WinUI3.Windows.ApplicationModel.Payments.Provider.PaymentTransaction is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_hString        : constant WinUI3.HString := To_HString ("Windows.ApplicationModel.Payments.Provider.PaymentTransaction");
      m_Factory        : access WinUI3.Windows.ApplicationModel.Payments.Provider.IPaymentTransactionStatics_Interface'Class := null;
      temp             : WinUI3.UInt32 := 0;
      ...
      m_RetVal         : aliased WinUI3.Windows.ApplicationModel.Payments.Provider.IPaymentTransaction;
      m_IID            : aliased WinUI3.IID := (3768205181, 27344, 22735, (171, 76, 46, 76, 156, 121, 24, 115 )); -- Windows.ApplicationModel.Payments.Provider.PaymentTransaction;
      m_HandlerIID     : aliased WinUI3.IID := (3176895205, 4230, 23613, (157, 225, 153, 130, 231, 118, 209, 147 ));
   ...
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.Payments.Provider.PaymentTransaction do
            ...
            if Hr = S_OK then
               ...
               if m_AsyncOperation /= null then
                  ...
                  if m_AsyncStatus = Completed_e then
                     ...
                     Retval.m_IPaymentTransaction := new WinUI3.Windows.ApplicationModel.Payments.Provider.IPaymentTransaction;
   ...
   return WinUI3.Windows.ApplicationModel.Payments.PaymentRequestChangedResult'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_Temp           : WinUI3.Int32 := 0;
      ...
      m_AsyncStatus    : aliased WinUI3.Windows.Foundation.AsyncStatus;
      m_ComRetVal      : aliased WinUI3.GenericObject := null;
      m_RetVal         : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentRequestChangedResult;
      m_IID            : aliased WinUI3.IID := (214114341, 44135, 22498, (160, 246, 58, 142, 17, 108, 239, 76 )); -- Windows.ApplicationModel.Payments.PaymentRequestChangedResult;
      m_HandlerIID     : aliased WinUI3.IID := (3200825126, 36950, 24135, (178, 42, 13, 160, 154, 168, 74, 254 ));
   ...
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.Payments.PaymentRequestChangedResult do
   ...
   return WinUI3.Windows.ApplicationModel.Payments.Provider.PaymentTransactionAcceptResult'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_Temp           : WinUI3.Int32 := 0;
      ...
      m_AsyncStatus    : aliased WinUI3.Windows.Foundation.AsyncStatus;
      m_ComRetVal      : aliased WinUI3.GenericObject := null;
      m_RetVal         : aliased WinUI3.Windows.ApplicationModel.Payments.Provider.IPaymentTransactionAcceptResult;
      m_IID            : aliased WinUI3.IID := (3326470383, 2147, 21940, (138, 237, 66, 189, 21, 45, 128, 4 )); -- Windows.ApplicationModel.Payments.Provider.PaymentTransactionAcceptResult;
      m_HandlerIID     : aliased WinUI3.IID := (1161361546, 35247, 20665, (129, 101, 126, 98, 105, 99, 152, 132 ));
   ...
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.Payments.Provider.PaymentTransactionAcceptResult do
         ...
         if Hr = S_OK then
            ...
            if m_AsyncOperation /= null then
               ...
               if m_AsyncStatus = Completed_e then
                  Hr := m_AsyncOperation.GetResults (m_RetVal'Access);
                  Retval.m_IPaymentTransactionAcceptResult := new WinUI3.Windows.ApplicationModel.Payments.Provider.IPaymentTransactionAcceptResult;
   ...
   return WinUI3.Windows.ApplicationModel.Payments.PaymentRequestCompletionStatus is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Payments.PaymentRequestCompletionStatus;
   begin
