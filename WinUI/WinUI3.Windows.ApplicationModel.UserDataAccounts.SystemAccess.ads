...
--------------------------------------------------------------------------------
package WinUI3.Windows.ApplicationModel.UserDataAccounts.SystemAccess is
   ...
   type IDeviceAccountConfiguration_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IDeviceAccountConfiguration2_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IUserDataAccountSystemAccessManagerStatics_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IUserDataAccountSystemAccessManagerStatics2_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   -----------------------------------------------------------------------------
   -- type IDeviceAccountConfiguration is interface and WinUI3.IInspectable;
      ...
      (
         this : access IDeviceAccountConfiguration_Interface;
         RetVal : access WinUI3.Windows.ApplicationModel.UserDataAccounts.SystemAccess.DeviceAccountServerType
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_IDeviceAccountConfiguration : aliased WinUI3.IID := (2902533027, 64476, 19739, (190, 67, 90, 39, 234, 74, 27, 99 ));

   -----------------------------------------------------------------------------
   -- type IDeviceAccountConfiguration2 is interface and WinUI3.IInspectable;
      ...
      (
         this : access IDeviceAccountConfiguration2_Interface;
         RetVal : access WinUI3.Windows.ApplicationModel.UserDataAccounts.SystemAccess.DeviceAccountIconId
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         this : access IDeviceAccountConfiguration2_Interface;
         RetVal : access WinUI3.Windows.ApplicationModel.UserDataAccounts.SystemAccess.DeviceAccountAuthenticationType
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         this : access IDeviceAccountConfiguration2_Interface;
         RetVal : access WinUI3.Windows.ApplicationModel.UserDataAccounts.SystemAccess.DeviceAccountSyncScheduleKind
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         this : access IDeviceAccountConfiguration2_Interface;
         RetVal : access WinUI3.Windows.ApplicationModel.UserDataAccounts.SystemAccess.DeviceAccountMailAgeFilter
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_IDeviceAccountConfiguration2 : aliased WinUI3.IID := (4071810470, 29325, 19018, (137, 69, 43, 248, 88, 1, 54, 222 ));

   -----------------------------------------------------------------------------
   -- type IUserDataAccountSystemAccessManagerStatics is interface and WinUI3.IInspectable;
      ...
      IID_IUserDataAccountSystemAccessManagerStatics : aliased WinUI3.IID := (2641039801, 52197, 17909, (130, 43, 194, 103, 184, 29, 189, 182 ));

   -----------------------------------------------------------------------------
   -- type IUserDataAccountSystemAccessManagerStatics2 is interface and WinUI3.IInspectable;
      ...
      (
         this : access IUserDataAccountSystemAccessManagerStatics2_Interface;
         account : WinUI3.Windows.ApplicationModel.UserDataAccounts.SystemAccess.IDeviceAccountConfiguration;
         RetVal : access GenericObject
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_IUserDataAccountSystemAccessManagerStatics2 : aliased WinUI3.IID := (2487190861, 19278, 17311, (131, 211, 151, 155, 39, 192, 90, 199 ));
   ...
   return WinUI3.Windows.ApplicationModel.UserDataAccounts.SystemAccess.DeviceAccountServerType;
   ...
   return WinUI3.Windows.ApplicationModel.UserDataAccounts.SystemAccess.DeviceAccountIconId;
   ...
   return WinUI3.Windows.ApplicationModel.UserDataAccounts.SystemAccess.DeviceAccountAuthenticationType;
   ...
   return WinUI3.Windows.ApplicationModel.UserDataAccounts.SystemAccess.DeviceAccountSyncScheduleKind;
   ...
   return WinUI3.Windows.ApplicationModel.UserDataAccounts.SystemAccess.DeviceAccountMailAgeFilter;
   ...
   package UserDataAccountSystemAccessManager is
      ...
      return WinUI3.Windows.ApplicationModel.UserDataAccounts.SystemAccess.DeviceAccountConfiguration;
