...
--------------------------------------------------------------------------------
package body WinUI3.Windows.Services.Maps.LocalSearch is

   package IAsyncOperation_LocalLocationFinderResult is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.Services.Maps.LocalSearch.ILocalLocationFinderResult);
   package AsyncOperationCompletedHandler_LocalLocationFinderResult is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.Services.Maps.LocalSearch.ILocalLocationFinderResult);
   ...
   package body LocalCategories is
      ...
      return WinUI3.WString is
         ...
         m_hString        : constant WinUI3.HString := To_HString ("Windows.Services.Maps.LocalSearch.LocalCategories");
         m_Factory        : access WinUI3.Windows.Services.Maps.LocalSearch.ILocalCategoriesStatics_Interface'Class := null;
   ...
   return WinUI3.WString is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.Services.Maps.LocalSearch.ILocalLocation2 := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.HString;
      AdaRetval        : WString;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Services.Maps.LocalSearch.ILocalLocation_Interface, WinUI3.Windows.Services.Maps.LocalSearch.ILocalLocation2, WinUI3.Windows.Services.Maps.LocalSearch.IID_ILocalLocation2'Unchecked_Access);
   begin
   ...
   return WinUI3.Windows.Services.Maps.LocalSearch.LocalLocationRatingInfo'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.Services.Maps.LocalSearch.ILocalLocation2 := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Services.Maps.LocalSearch.ILocalLocationRatingInfo;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Services.Maps.LocalSearch.ILocalLocation_Interface, WinUI3.Windows.Services.Maps.LocalSearch.ILocalLocation2, WinUI3.Windows.Services.Maps.LocalSearch.IID_ILocalLocation2'Unchecked_Access);
   begin
      return RetVal : WinUI3.Windows.Services.Maps.LocalSearch.LocalLocationRatingInfo do
         m_Interface := QInterface (this.m_ILocalLocation.all);
         ...
         Retval.m_ILocalLocationRatingInfo := new WinUI3.Windows.Services.Maps.LocalSearch.ILocalLocationRatingInfo;
   ...
   package body LocalLocationFinder is
      ...
      return WinUI3.Windows.Services.Maps.LocalSearch.LocalLocationFinderResult is
         Hr               : WinUI3.HResult := S_OK;
         tmp              : WinUI3.HResult := S_OK;
         m_hString        : constant WinUI3.HString := To_HString ("Windows.Services.Maps.LocalSearch.LocalLocationFinder");
         m_Factory        : access WinUI3.Windows.Services.Maps.LocalSearch.ILocalLocationFinderStatics_Interface'Class := null;
         temp             : WinUI3.UInt32 := 0;
         HStr_searchTerm : constant WinUI3.HString := To_HString (searchTerm);
         HStr_localCategory : constant WinUI3.HString := To_HString (localCategory);
         ...
         m_RetVal         : aliased WinUI3.Windows.Services.Maps.LocalSearch.ILocalLocationFinderResult;
         m_IID            : aliased WinUI3.IID := (149330738, 62496, 21120, (167, 33, 7, 91, 79, 208, 61, 148 )); -- Windows.Services.Maps.LocalSearch.LocalLocationFinderResult;
         m_HandlerIID     : aliased WinUI3.IID := (2068454291, 10563, 24144, (160, 16, 238, 154, 236, 27, 191, 231 ));
      ...
      begin
         return RetVal : WinUI3.Windows.Services.Maps.LocalSearch.LocalLocationFinderResult do
               ...
               if Hr = S_OK then
                  ...
                  if m_AsyncOperation /= null then
                     ...
                     if m_AsyncStatus = Completed_e then
                        ...
                        Retval.m_ILocalLocationFinderResult := new WinUI3.Windows.Services.Maps.LocalSearch.ILocalLocationFinderResult;
   ...
   return WinUI3.Windows.Services.Maps.LocalSearch.LocalLocationFinderStatus is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Services.Maps.LocalSearch.LocalLocationFinderStatus;
   begin
   ...
   package body PlaceInfoHelper is
      ...
      return WinUI3.Windows.Services.Maps.PlaceInfo is
         Hr               : WinUI3.HResult := S_OK;
         tmp              : WinUI3.HResult := S_OK;
         m_hString        : constant WinUI3.HString := To_HString ("Windows.Services.Maps.LocalSearch.PlaceInfoHelper");
         m_Factory        : access WinUI3.Windows.Services.Maps.LocalSearch.IPlaceInfoHelperStatics_Interface'Class := null;
         temp             : WinUI3.UInt32 := 0;
