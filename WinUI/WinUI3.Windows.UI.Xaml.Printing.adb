...
--------------------------------------------------------------------------------
package body WinUI3.Windows.UI.Xaml.Printing is
   ...
   begin
      return RetVal : AddPagesEventArgs do
         ...
         if Hr = S_OK then
            Retval.m_IAddPagesEventArgs := new WinUI3.Windows.UI.Xaml.Printing.IAddPagesEventArgs;
   ...
   begin
      return RetVal : GetPreviewPageEventArgs do
         Hr := RoActivateInstance (m_hString, m_ComRetVal'Address);
         if Hr = S_OK then
            Retval.m_IGetPreviewPageEventArgs := new WinUI3.Windows.UI.Xaml.Printing.IGetPreviewPageEventArgs;
   ...
   begin
      return RetVal : PaginateEventArgs do
         Hr := RoActivateInstance (m_hString, m_ComRetVal'Address);
         if Hr = S_OK then
            Retval.m_IPaginateEventArgs := new WinUI3.Windows.UI.Xaml.Printing.IPaginateEventArgs;
   ...
   begin
      return RetVal : PrintDocument do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IPrintDocument := new WinUI3.Windows.UI.Xaml.Printing.IPrintDocument;
   ...
   return WinUI3.Windows.UI.Xaml.DependencyProperty is
      ...
      tmp              : WinUI3.HResult := S_OK;
      m_hString        : constant WinUI3.HString := To_HString ("Windows.UI.Xaml.Printing.PrintDocument");
      m_Factory        : access WinUI3.Windows.UI.Xaml.Printing.IPrintDocumentStatics_Interface'Class := null;
      temp             : WinUI3.UInt32 := 0;
