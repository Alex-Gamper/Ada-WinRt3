...
--------------------------------------------------------------------------------
package body WinUI3.Windows.UI.Accessibility is
   ...
   begin
      return RetVal : ScreenReaderService do
         ...
         if Hr = S_OK then
            Retval.m_IScreenReaderService := new WinUI3.Windows.UI.Accessibility.IScreenReaderService;
   ...
   return WinUI3.Windows.UI.Accessibility.ScreenReaderPositionChangedEventArgs'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.UI.Accessibility.IScreenReaderPositionChangedEventArgs;
   begin
      return RetVal : WinUI3.Windows.UI.Accessibility.ScreenReaderPositionChangedEventArgs do
         Hr := this.m_IScreenReaderService.all.get_CurrentScreenReaderPosition (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IScreenReaderPositionChangedEventArgs := new WinUI3.Windows.UI.Accessibility.IScreenReaderPositionChangedEventArgs;
