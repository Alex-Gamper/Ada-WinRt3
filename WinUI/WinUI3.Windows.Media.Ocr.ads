...
--------------------------------------------------------------------------------
package WinUI3.Windows.Media.Ocr is
   ...
   type IOcrEngine_Interface is interface and WinUI3.IInspectable_Interface;
   type IOcrEngine is access all IOcrEngine_Interface'Class;
   type IOcrEngine_Ptr is access all IOcrEngine;

   type IOcrEngineStatics_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IOcrLine_Interface is interface and WinUI3.IInspectable_Interface;
   type IOcrLine is access all IOcrLine_Interface'Class;
   type IOcrLine_Ptr is access all IOcrLine;

   type IOcrResult_Interface is interface and WinUI3.IInspectable_Interface;
   type IOcrResult is access all IOcrResult_Interface'Class;
   type IOcrResult_Ptr is access all IOcrResult;

   type IOcrWord_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   package IVectorView_IOcrWord is new WinUI3.Windows.Foundation.Collections.IVectorView (IOcrWord);
   IID_IVectorView_IOcrWord : aliased WinUI3.IID := (2553682480, 7745, 22888, (185, 212, 25, 37, 58, 252, 188, 131 ));
   ...
   package IVectorView_IOcrLine is new WinUI3.Windows.Foundation.Collections.IVectorView (IOcrLine);
   IID_IVectorView_IOcrLine : aliased WinUI3.IID := (1396734671, 64622, 24380, (153, 76, 197, 254, 143, 160, 29, 129 ));
   ...
   IID_IReference_Double : aliased WinUI3.IID := (1396734671, 64622, 24380, (153, 76, 197, 254, 143, 160, 29, 129 ));
   ...
   -----------------------------------------------------------------------------
   -- type IOcrEngine is interface and WinUI3.IInspectable;
      ...
      IID_IOcrEngine : aliased WinUI3.IID := (1511308353, 23414, 12608, (182, 128, 136, 37, 86, 38, 131, 172 ));

   -----------------------------------------------------------------------------
   -- type IOcrEngineStatics is interface and WinUI3.IInspectable;
      ...
      (
         this : access IOcrEngineStatics_Interface;
         language : WinUI3.Windows.Globalization.ILanguage;
         RetVal : access WinUI3.Windows.Media.Ocr.IOcrEngine
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_IOcrEngineStatics : aliased WinUI3.IID := (1543481434, 13188, 13632, (153, 64, 105, 145, 32, 212, 40, 168 ));

   -----------------------------------------------------------------------------
   -- type IOcrLine is interface and WinUI3.IInspectable;
      ...
      IID_IOcrLine : aliased WinUI3.IID := (4432239, 58143, 14884, (137, 156, 212, 68, 189, 8, 129, 36 ));

   -----------------------------------------------------------------------------
   -- type IOcrResult is interface and WinUI3.IInspectable;
      ...
      IID_IOcrResult : aliased WinUI3.IID := (2614244786, 5979, 15722, (146, 226, 56, 140, 32, 110, 47, 99 ));

   -----------------------------------------------------------------------------
   -- type IOcrWord is interface and WinUI3.IInspectable;
      ...
      IID_IOcrWord : aliased WinUI3.IID := (1009403770, 23769, 13605, (186, 42, 35, 209, 224, 166, 138, 29 ));
   ...
   return WinUI3.Windows.Media.Ocr.OcrEngine;
   ...
   return WinUI3.Windows.Media.Ocr.OcrResult'Class;
