...
--------------------------------------------------------------------------------
package body WinUI3.Windows.Security.DataProtection is

   package IAsyncOperation_UserDataStorageItemProtectionStatus is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.Security.DataProtection.UserDataStorageItemProtectionStatus);
   package AsyncOperationCompletedHandler_UserDataStorageItemProtectionStatus is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.Security.DataProtection.UserDataStorageItemProtectionStatus);

   package IAsyncOperation_UserDataStorageItemProtectionInfo is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.Security.DataProtection.IUserDataStorageItemProtectionInfo);
   package AsyncOperationCompletedHandler_UserDataStorageItemProtectionInfo is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.Security.DataProtection.IUserDataStorageItemProtectionInfo);
   ...
   package IAsyncOperation_UserDataBufferUnprotectResult is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.Security.DataProtection.IUserDataBufferUnprotectResult);
   package AsyncOperationCompletedHandler_UserDataBufferUnprotectResult is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.Security.DataProtection.IUserDataBufferUnprotectResult);
   ...
   return WinUI3.Windows.Security.DataProtection.UserDataBufferUnprotectStatus is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Security.DataProtection.UserDataBufferUnprotectStatus;
   begin
   ...
   return WinUI3.Windows.Security.DataProtection.UserDataProtectionManager is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_hString        : constant WinUI3.HString := To_HString ("Windows.Security.DataProtection.UserDataProtectionManager");
      m_Factory        : access WinUI3.Windows.Security.DataProtection.IUserDataProtectionManagerStatics_Interface'Class := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Security.DataProtection.IUserDataProtectionManager;
   begin
      return RetVal : WinUI3.Windows.Security.DataProtection.UserDataProtectionManager do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IUserDataProtectionManager := new WinUI3.Windows.Security.DataProtection.IUserDataProtectionManager;
   ...
   return WinUI3.Windows.Security.DataProtection.UserDataStorageItemProtectionStatus is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      ...
      m_RetVal         : aliased WinUI3.Windows.Security.DataProtection.UserDataStorageItemProtectionStatus;
      m_IID            : aliased WinUI3.IID := (3854970301, 57385, 21217, (175, 213, 115, 247, 164, 34, 61, 230 )); -- Windows.Security.DataProtection.UserDataStorageItemProtectionStatus;
      m_HandlerIID     : aliased WinUI3.IID := (943730012, 50564, 21215, (154, 234, 121, 104, 103, 166, 104, 53 ));
   ...
   return WinUI3.Windows.Security.DataProtection.UserDataStorageItemProtectionInfo'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_Temp           : WinUI3.Int32 := 0;
      ...
      m_AsyncStatus    : aliased WinUI3.Windows.Foundation.AsyncStatus;
      m_ComRetVal      : aliased WinUI3.GenericObject := null;
      m_RetVal         : aliased WinUI3.Windows.Security.DataProtection.IUserDataStorageItemProtectionInfo;
      m_IID            : aliased WinUI3.IID := (687838034, 23730, 24455, (159, 8, 222, 202, 207, 79, 89, 179 )); -- Windows.Security.DataProtection.UserDataStorageItemProtectionInfo;
      m_HandlerIID     : aliased WinUI3.IID := (2860606682, 55424, 23029, (128, 147, 102, 77, 5, 45, 116, 181 ));
   ...
   begin
      return RetVal : WinUI3.Windows.Security.DataProtection.UserDataStorageItemProtectionInfo do
         ...
         if Hr = S_OK then
            ...
            if m_AsyncOperation /= null then
               ...
               if m_AsyncStatus = Completed_e then
                  Hr := m_AsyncOperation.GetResults (m_RetVal'Access);
                  Retval.m_IUserDataStorageItemProtectionInfo := new WinUI3.Windows.Security.DataProtection.IUserDataStorageItemProtectionInfo;
   ...
   return WinUI3.Windows.Security.DataProtection.UserDataBufferUnprotectResult'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_Temp           : WinUI3.Int32 := 0;
      ...
      m_AsyncStatus    : aliased WinUI3.Windows.Foundation.AsyncStatus;
      m_ComRetVal      : aliased WinUI3.GenericObject := null;
      m_RetVal         : aliased WinUI3.Windows.Security.DataProtection.IUserDataBufferUnprotectResult;
      m_IID            : aliased WinUI3.IID := (4168508717, 65505, 23671, (166, 145, 43, 219, 64, 76, 250, 111 )); -- Windows.Security.DataProtection.UserDataBufferUnprotectResult;
      m_HandlerIID     : aliased WinUI3.IID := (3081625265, 13942, 20889, (161, 254, 189, 79, 96, 35, 17, 159 ));
   ...
   begin
      return RetVal : WinUI3.Windows.Security.DataProtection.UserDataBufferUnprotectResult do
         ...
         if Hr = S_OK then
            ...
            if m_AsyncOperation /= null then
               ...
               if m_AsyncStatus = Completed_e then
                  Hr := m_AsyncOperation.GetResults (m_RetVal'Access);
                  Retval.m_IUserDataBufferUnprotectResult := new WinUI3.Windows.Security.DataProtection.IUserDataBufferUnprotectResult;
   ...
   return WinUI3.Windows.Security.DataProtection.UserDataAvailability is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Security.DataProtection.UserDataAvailability;
   begin
