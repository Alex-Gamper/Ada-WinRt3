...
--------------------------------------------------------------------------------
package body WinUI3.Windows.UI.Xaml.Markup is
   ...
   return MarkupExtension is
      ...
      m_hString    : constant WinUI3.HString := To_HString ("Windows.UI.Xaml.Markup.IMarkupExtension");
      m_Factory    : access IMarkupExtensionFactory_Interface'Class := null;
      temp         : WinUI3.UInt32 := 0;
      m_ComRetVal  : aliased WinUI3.Windows.UI.Xaml.Markup.IMarkupExtension;
   begin
      return RetVal : MarkupExtension do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IMarkupExtension := new WinUI3.Windows.UI.Xaml.Markup.IMarkupExtension;
   ...
   return WinUI3.IInspectable is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.UI.Xaml.Markup.IMarkupExtensionOverrides := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.IInspectable;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.UI.Xaml.Markup.IMarkupExtension_Interface, WinUI3.Windows.UI.Xaml.Markup.IMarkupExtensionOverrides, WinUI3.Windows.UI.Xaml.Markup.IID_IMarkupExtensionOverrides'Unchecked_Access);
   begin
   ...
   return WinUI3.Windows.UI.Xaml.Markup.XamlBinaryWriterErrorInformation is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_hString        : constant WinUI3.HString := To_HString ("Windows.UI.Xaml.Markup.XamlBinaryWriter");
      m_Factory        : access WinUI3.Windows.UI.Xaml.Markup.IXamlBinaryWriterStatics_Interface'Class := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.UI.Xaml.Markup.XamlBinaryWriterErrorInformation;
   begin
   ...
   return WinUI3.Windows.UI.Xaml.DependencyProperty is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_hString        : constant WinUI3.HString := To_HString ("Windows.UI.Xaml.Markup.XamlBindingHelper");
      m_Factory        : access WinUI3.Windows.UI.Xaml.Markup.IXamlBindingHelperStatics_Interface'Class := null;
      temp             : WinUI3.UInt32 := 0;
   ...
   return WinUI3.Windows.UI.Xaml.Markup.IDataTemplateComponent is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_hString        : constant WinUI3.HString := To_HString ("Windows.UI.Xaml.Markup.XamlBindingHelper");
      m_Factory        : access WinUI3.Windows.UI.Xaml.Markup.IXamlBindingHelperStatics_Interface'Class := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.UI.Xaml.Markup.IDataTemplateComponent;
   begin
      Hr := RoGetActivationFactory (m_hString, IID_IXamlBindingHelperStatics'Access , m_Factory'Address);
      if Hr = S_OK then
   ...
   (
      ...
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_hString        : constant WinUI3.HString := To_HString ("Windows.UI.Xaml.Markup.XamlMarkupHelper");
      m_Factory        : access WinUI3.Windows.UI.Xaml.Markup.IXamlMarkupHelperStatics_Interface'Class := null;
      temp             : WinUI3.UInt32 := 0;
   begin
   ...
   return WinUI3.IInspectable is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_hString        : constant WinUI3.HString := To_HString ("Windows.UI.Xaml.Markup.XamlReader");
      m_Factory        : access WinUI3.Windows.UI.Xaml.Markup.IXamlReaderStatics_Interface'Class := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.IInspectable;
