...
--------------------------------------------------------------------------------
package body WinUI3.Windows.ApplicationModel.Payments is
   ...
   package IAsyncOperation_PaymentRequestSubmitResult is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.ApplicationModel.Payments.IPaymentRequestSubmitResult);
   package AsyncOperationCompletedHandler_PaymentRequestSubmitResult is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.ApplicationModel.Payments.IPaymentRequestSubmitResult);

   package IAsyncOperation_PaymentCanMakePaymentResult is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.ApplicationModel.Payments.IPaymentCanMakePaymentResult);
   package AsyncOperationCompletedHandler_PaymentCanMakePaymentResult is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.ApplicationModel.Payments.IPaymentCanMakePaymentResult);
   ...
   function Constructor return PaymentAddress is
      ...
      m_hString    : constant WinUI3.HString := To_HString ("Windows.ApplicationModel.Payments.IPaymentAddress");
      m_ComRetVal  : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentAddress;
   begin
      return RetVal : PaymentAddress do
         Hr := RoActivateInstance (m_hString, m_ComRetVal'Address);
         if Hr = S_OK then
            Retval.m_IPaymentAddress := new WinUI3.Windows.ApplicationModel.Payments.IPaymentAddress;
   ...
   return PaymentCanMakePaymentResult is
      Hr           : WinUI3.HResult := S_OK;
      tmp          : WinUI3.HResult := S_OK;
      m_hString    : constant WinUI3.HString := To_HString ("Windows.ApplicationModel.Payments.IPaymentCanMakePaymentResult");
      m_Factory    : access IPaymentCanMakePaymentResultFactory_Interface'Class := null;
      temp         : WinUI3.UInt32 := 0;
      m_ComRetVal  : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentCanMakePaymentResult;
   begin
      return RetVal : PaymentCanMakePaymentResult do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IPaymentCanMakePaymentResult := new WinUI3.Windows.ApplicationModel.Payments.IPaymentCanMakePaymentResult;
   ...
   return WinUI3.Windows.ApplicationModel.Payments.PaymentCanMakePaymentResultStatus is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Payments.PaymentCanMakePaymentResultStatus;
   begin
   ...
   return PaymentCurrencyAmount is
      Hr           : WinUI3.HResult := S_OK;
      tmp          : WinUI3.HResult := S_OK;
      m_hString    : constant WinUI3.HString := To_HString ("Windows.ApplicationModel.Payments.IPaymentCurrencyAmount");
      m_Factory    : access IPaymentCurrencyAmountFactory_Interface'Class := null;
      temp         : WinUI3.UInt32 := 0;
      m_ComRetVal  : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentCurrencyAmount;
      HStr_value : constant WinUI3.HString := To_HString (value);
      HStr_currency : constant WinUI3.HString := To_HString (currency);
   begin
      return RetVal : PaymentCurrencyAmount do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IPaymentCurrencyAmount := new WinUI3.Windows.ApplicationModel.Payments.IPaymentCurrencyAmount;
   ...
   return PaymentCurrencyAmount is
      ...
      HStr_value : constant WinUI3.HString := To_HString (value);
      HStr_currency : constant WinUI3.HString := To_HString (currency);
      HStr_currencySystem : constant WinUI3.HString := To_HString (currencySystem);
   begin
      return RetVal : PaymentCurrencyAmount do
         Hr := RoGetActivationFactory (m_hString, IID_IPaymentCurrencyAmountFactory'Access , m_Factory'Address);
         if Hr = S_OK then
   ...
   return PaymentDetails is
      Hr           : WinUI3.HResult := S_OK;
      tmp          : WinUI3.HResult := S_OK;
      m_hString    : constant WinUI3.HString := To_HString ("Windows.ApplicationModel.Payments.IPaymentDetails");
      m_Factory    : access IPaymentDetailsFactory_Interface'Class := null;
      temp         : WinUI3.UInt32 := 0;
      m_ComRetVal  : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentDetails;
   begin
      return RetVal : PaymentDetails do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IPaymentDetails := new WinUI3.Windows.ApplicationModel.Payments.IPaymentDetails;
   ...
   return WinUI3.Windows.ApplicationModel.Payments.PaymentItem'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentItem;
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.Payments.PaymentItem do
         Hr := this.m_IPaymentDetails.all.get_Total (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IPaymentItem := new WinUI3.Windows.ApplicationModel.Payments.IPaymentItem;
   ...
   return PaymentDetailsModifier is
      Hr           : WinUI3.HResult := S_OK;
      tmp          : WinUI3.HResult := S_OK;
      m_hString    : constant WinUI3.HString := To_HString ("Windows.ApplicationModel.Payments.IPaymentDetailsModifier");
      m_Factory    : access IPaymentDetailsModifierFactory_Interface'Class := null;
      temp         : WinUI3.UInt32 := 0;
      m_ComRetVal  : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentDetailsModifier;
   begin
      return RetVal : PaymentDetailsModifier do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IPaymentDetailsModifier := new WinUI3.Windows.ApplicationModel.Payments.IPaymentDetailsModifier;
   ...
   return PaymentDetailsModifier is
      ...
      temp         : WinUI3.UInt32 := 0;
      m_ComRetVal  : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentDetailsModifier;
      HStr_jsonData : constant WinUI3.HString := To_HString (jsonData);
   begin
      return RetVal : PaymentDetailsModifier do
         Hr := RoGetActivationFactory (m_hString, IID_IPaymentDetailsModifierFactory'Access , m_Factory'Address);
         if Hr = S_OK then
   ...
   return PaymentItem is
      Hr           : WinUI3.HResult := S_OK;
      tmp          : WinUI3.HResult := S_OK;
      m_hString    : constant WinUI3.HString := To_HString ("Windows.ApplicationModel.Payments.IPaymentItem");
   ...
   return WinUI3.Windows.ApplicationModel.Payments.PaymentCurrencyAmount'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentCurrencyAmount;
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.Payments.PaymentCurrencyAmount do
   ...
   function Constructor return PaymentMediator is
      Hr           : WinUI3.HResult := S_OK;
      tmp          : WinUI3.HResult := S_OK;
      m_hString    : constant WinUI3.HString := To_HString ("Windows.ApplicationModel.Payments.IPaymentMediator");
      m_ComRetVal  : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentMediator;
   begin
      return RetVal : PaymentMediator do
         Hr := RoActivateInstance (m_hString, m_ComRetVal'Address);
         if Hr = S_OK then
            Retval.m_IPaymentMediator := new WinUI3.Windows.ApplicationModel.Payments.IPaymentMediator;
   ...
   return WinUI3.Windows.ApplicationModel.Payments.PaymentRequestSubmitResult'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_Temp           : WinUI3.Int32 := 0;
      ...
      m_AsyncStatus    : aliased WinUI3.Windows.Foundation.AsyncStatus;
      m_ComRetVal      : aliased WinUI3.GenericObject := null;
      m_RetVal         : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentRequestSubmitResult;
      m_IID            : aliased WinUI3.IID := (3475574251, 21833, 22467, (138, 189, 83, 183, 108, 100, 60, 202 )); -- Windows.ApplicationModel.Payments.PaymentRequestSubmitResult;
      m_HandlerIID     : aliased WinUI3.IID := (3419211686, 44586, 23152, (188, 11, 145, 32, 86, 8, 37, 209 ));
   ...
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.Payments.PaymentRequestSubmitResult do
         ...
         if Hr = S_OK then
            ...
            if m_AsyncOperation /= null then
               ...
               if m_AsyncStatus = Completed_e then
                  Hr := m_AsyncOperation.GetResults (m_RetVal'Access);
                  Retval.m_IPaymentRequestSubmitResult := new WinUI3.Windows.ApplicationModel.Payments.IPaymentRequestSubmitResult;
   ...
   return WinUI3.Windows.ApplicationModel.Payments.PaymentCanMakePaymentResult'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.ApplicationModel.Payments.IPaymentMediator2 := null;
      temp             : WinUI3.UInt32 := 0;
      m_Temp           : WinUI3.Int32 := 0;
      m_Completed      : WinUI3.UInt32 := 0;
      m_Captured       : WinUI3.UInt32 := 0;
      ...
      m_AsyncStatus    : aliased WinUI3.Windows.Foundation.AsyncStatus;
      m_ComRetVal      : aliased WinUI3.GenericObject := null;
      m_RetVal         : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentCanMakePaymentResult;
      m_IID            : aliased WinUI3.IID := (2758230282, 4574, 20624, (185, 5, 150, 165, 98, 216, 93, 229 )); -- Windows.ApplicationModel.Payments.PaymentCanMakePaymentResult;
      m_HandlerIID     : aliased WinUI3.IID := (2309905289, 27909, 22594, (156, 223, 244, 203, 247, 6, 220, 94 ));
      ...
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.ApplicationModel.Payments.IPaymentMediator_Interface, WinUI3.Windows.ApplicationModel.Payments.IPaymentMediator2, WinUI3.Windows.ApplicationModel.Payments.IID_IPaymentMediator2'Unchecked_Access);
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.Payments.PaymentCanMakePaymentResult do
   ...
   function Constructor return PaymentMerchantInfo is
      Hr           : WinUI3.HResult := S_OK;
      tmp          : WinUI3.HResult := S_OK;
      m_hString    : constant WinUI3.HString := To_HString ("Windows.ApplicationModel.Payments.IPaymentMerchantInfo");
      m_ComRetVal  : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentMerchantInfo;
   begin
      return RetVal : PaymentMerchantInfo do
         Hr := RoActivateInstance (m_hString, m_ComRetVal'Address);
         if Hr = S_OK then
            Retval.m_IPaymentMerchantInfo := new WinUI3.Windows.ApplicationModel.Payments.IPaymentMerchantInfo;
   ...
   return PaymentMethodData is
      Hr           : WinUI3.HResult := S_OK;
      tmp          : WinUI3.HResult := S_OK;
      m_hString    : constant WinUI3.HString := To_HString ("Windows.ApplicationModel.Payments.IPaymentMethodData");
      m_Factory    : access IPaymentMethodDataFactory_Interface'Class := null;
      temp         : WinUI3.UInt32 := 0;
      m_ComRetVal  : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentMethodData;
   begin
      return RetVal : PaymentMethodData do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IPaymentMethodData := new WinUI3.Windows.ApplicationModel.Payments.IPaymentMethodData;
   ...
   function Constructor return PaymentOptions is
      Hr           : WinUI3.HResult := S_OK;
      tmp          : WinUI3.HResult := S_OK;
      m_hString    : constant WinUI3.HString := To_HString ("Windows.ApplicationModel.Payments.IPaymentOptions");
      m_ComRetVal  : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentOptions;
   begin
      return RetVal : PaymentOptions do
         Hr := RoActivateInstance (m_hString, m_ComRetVal'Address);
         if Hr = S_OK then
            Retval.m_IPaymentOptions := new WinUI3.Windows.ApplicationModel.Payments.IPaymentOptions;
   ...
   return WinUI3.Windows.ApplicationModel.Payments.PaymentOptionPresence is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Payments.PaymentOptionPresence;
   begin
   ...
   return WinUI3.Windows.ApplicationModel.Payments.PaymentShippingType is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Payments.PaymentShippingType;
   begin
   ...
   return PaymentRequest is
      Hr           : WinUI3.HResult := S_OK;
      tmp          : WinUI3.HResult := S_OK;
      m_hString    : constant WinUI3.HString := To_HString ("Windows.ApplicationModel.Payments.IPaymentRequest");
      m_Factory    : access IPaymentRequestFactory_Interface'Class := null;
      temp         : WinUI3.UInt32 := 0;
      m_ComRetVal  : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentRequest;
   begin
      return RetVal : PaymentRequest do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IPaymentRequest := new WinUI3.Windows.ApplicationModel.Payments.IPaymentRequest;
   ...
   return WinUI3.Windows.ApplicationModel.Payments.PaymentMerchantInfo'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentMerchantInfo;
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.Payments.PaymentMerchantInfo do
   ...
   return WinUI3.Windows.ApplicationModel.Payments.PaymentDetails'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentDetails;
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.Payments.PaymentDetails do
   ...
   return WinUI3.Windows.ApplicationModel.Payments.PaymentOptions'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentOptions;
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.Payments.PaymentOptions do
   ...
   return WinUI3.WString is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.ApplicationModel.Payments.IPaymentRequest2 := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.HString;
      AdaRetval        : WString;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.ApplicationModel.Payments.IPaymentRequest_Interface, WinUI3.Windows.ApplicationModel.Payments.IPaymentRequest2, WinUI3.Windows.ApplicationModel.Payments.IID_IPaymentRequest2'Unchecked_Access);
   begin
   ...
   return WinUI3.Windows.ApplicationModel.Payments.PaymentRequestChangeKind is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Payments.PaymentRequestChangeKind;
   begin
   ...
   return WinUI3.Windows.ApplicationModel.Payments.PaymentAddress'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentAddress;
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.Payments.PaymentAddress do
   ...
   return WinUI3.Windows.ApplicationModel.Payments.PaymentShippingOption'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentShippingOption;
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.Payments.PaymentShippingOption do
         Hr := this.m_IPaymentRequestChangedArgs.all.get_SelectedShippingOption (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IPaymentShippingOption := new WinUI3.Windows.ApplicationModel.Payments.IPaymentShippingOption;
   ...
   return PaymentRequestChangedResult is
      Hr           : WinUI3.HResult := S_OK;
      tmp          : WinUI3.HResult := S_OK;
      m_hString    : constant WinUI3.HString := To_HString ("Windows.ApplicationModel.Payments.IPaymentRequestChangedResult");
      m_Factory    : access IPaymentRequestChangedResultFactory_Interface'Class := null;
      temp         : WinUI3.UInt32 := 0;
      m_ComRetVal  : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentRequestChangedResult;
   begin
      return RetVal : PaymentRequestChangedResult do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IPaymentRequestChangedResult := new WinUI3.Windows.ApplicationModel.Payments.IPaymentRequestChangedResult;
   ...
   return WinUI3.Windows.ApplicationModel.Payments.PaymentRequestStatus is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Payments.PaymentRequestStatus;
   begin
   ...
   return WinUI3.Windows.ApplicationModel.Payments.PaymentResponse'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentResponse;
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.Payments.PaymentResponse do
         Hr := this.m_IPaymentRequestSubmitResult.all.get_Response (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IPaymentResponse := new WinUI3.Windows.ApplicationModel.Payments.IPaymentResponse;
   ...
   return WinUI3.Windows.ApplicationModel.Payments.PaymentToken'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentToken;
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.Payments.PaymentToken do
         Hr := this.m_IPaymentResponse.all.get_PaymentToken (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IPaymentToken := new WinUI3.Windows.ApplicationModel.Payments.IPaymentToken;
   ...
   return PaymentShippingOption is
      Hr           : WinUI3.HResult := S_OK;
      tmp          : WinUI3.HResult := S_OK;
      m_hString    : constant WinUI3.HString := To_HString ("Windows.ApplicationModel.Payments.IPaymentShippingOption");
   ...
   return PaymentToken is
      Hr           : WinUI3.HResult := S_OK;
      tmp          : WinUI3.HResult := S_OK;
      m_hString    : constant WinUI3.HString := To_HString ("Windows.ApplicationModel.Payments.IPaymentToken");
      m_Factory    : access IPaymentTokenFactory_Interface'Class := null;
      temp         : WinUI3.UInt32 := 0;
      m_ComRetVal  : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentToken;
      HStr_paymentMethodId : constant WinUI3.HString := To_HString (paymentMethodId);
   begin
   ...
   return PaymentToken is
      ...
      m_ComRetVal  : aliased WinUI3.Windows.ApplicationModel.Payments.IPaymentToken;
      HStr_paymentMethodId : constant WinUI3.HString := To_HString (paymentMethodId);
      HStr_jsonDetails : constant WinUI3.HString := To_HString (jsonDetails);
   begin
      return RetVal : PaymentToken do
         Hr := RoGetActivationFactory (m_hString, IID_IPaymentTokenFactory'Access , m_Factory'Address);
         if Hr = S_OK then
