...
--------------------------------------------------------------------------------
package body WinUI3.Windows.ApplicationModel.Contacts.DataProvider is
   ...
   return WinUI3.Windows.Foundation.EventRegistrationToken is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.ApplicationModel.Contacts.DataProvider.IContactDataProviderConnection2 := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Foundation.EventRegistrationToken;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.ApplicationModel.Contacts.DataProvider.IContactDataProviderConnection_Interface, WinUI3.Windows.ApplicationModel.Contacts.DataProvider.IContactDataProviderConnection2, WinUI3.Windows.ApplicationModel.Contacts.DataProvider.IID_IContactDataProviderConnection2'Unchecked_Access);
   begin
   ...
   return WinUI3.Windows.ApplicationModel.Contacts.DataProvider.ContactDataProviderConnection'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Contacts.DataProvider.IContactDataProviderConnection;
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.Contacts.DataProvider.ContactDataProviderConnection do
         Hr := this.m_IContactDataProviderTriggerDetails.all.get_Connection (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IContactDataProviderConnection := new WinUI3.Windows.ApplicationModel.Contacts.DataProvider.IContactDataProviderConnection;
   ...
   return WinUI3.Windows.ApplicationModel.Contacts.DataProvider.ContactListCreateOrUpdateContactRequest'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Contacts.DataProvider.IContactListCreateOrUpdateContactRequest;
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.Contacts.DataProvider.ContactListCreateOrUpdateContactRequest do
         Hr := this.m_IContactListCreateOrUpdateContactRequestEventArgs.all.get_Request (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IContactListCreateOrUpdateContactRequest := new WinUI3.Windows.ApplicationModel.Contacts.DataProvider.IContactListCreateOrUpdateContactRequest;
   ...
   return WinUI3.Windows.ApplicationModel.Contacts.DataProvider.ContactListDeleteContactRequest'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Contacts.DataProvider.IContactListDeleteContactRequest;
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.Contacts.DataProvider.ContactListDeleteContactRequest do
         Hr := this.m_IContactListDeleteContactRequestEventArgs.all.get_Request (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IContactListDeleteContactRequest := new WinUI3.Windows.ApplicationModel.Contacts.DataProvider.IContactListDeleteContactRequest;
   ...
   return WinUI3.Windows.ApplicationModel.Contacts.ContactQueryOptions'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Contacts.IContactQueryOptions;
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.Contacts.ContactQueryOptions do
   ...
   return WinUI3.Windows.ApplicationModel.Contacts.DataProvider.ContactListServerSearchReadBatchRequest'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Contacts.DataProvider.IContactListServerSearchReadBatchRequest;
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.Contacts.DataProvider.ContactListServerSearchReadBatchRequest do
         Hr := this.m_IContactListServerSearchReadBatchRequestEventArgs.all.get_Request (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IContactListServerSearchReadBatchRequest := new WinUI3.Windows.ApplicationModel.Contacts.DataProvider.IContactListServerSearchReadBatchRequest;
   ...
   return WinUI3.Windows.ApplicationModel.Contacts.DataProvider.ContactListSyncManagerSyncRequest'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.Contacts.DataProvider.IContactListSyncManagerSyncRequest;
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.Contacts.DataProvider.ContactListSyncManagerSyncRequest do
         Hr := this.m_IContactListSyncManagerSyncRequestEventArgs.all.get_Request (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IContactListSyncManagerSyncRequest := new WinUI3.Windows.ApplicationModel.Contacts.DataProvider.IContactListSyncManagerSyncRequest;
