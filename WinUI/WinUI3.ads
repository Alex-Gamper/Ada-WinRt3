...
package WinUI3 is
   ...
   type IUnknown_Array is array (Natural range <>) of IUnknown;
      ...
      return WinUI3.UInt32 is abstract;
   ...
   type IInspectable_Ptr is access all IInspectable;
      ...
      (
         ...
         iidCount   : access WinUI3.UInt32;
         iids       : in WinUI3.IID_Ptr
      )
      return WinUI3.HResult is abstract;
      ...
      (
         This       : access IInspectable_Interface;
         className  : access WinUI3.HString
      )
      return WinUI3.HResult is abstract;
      ...
      (
         This       : access IInspectable_Interface;
         trustLevel : access WinUI3.TrustLevel
      )
      return WinUI3.HResult is abstract;
   ...
   IID_IUnknown     : aliased constant  WinUI3.GUID := (0, 0, 0, (192, 0, 0, 0, 0, 0, 0, 70));
   IID_IInspectable : aliased constant  WinUI3.GUID := (2944852704, 45357, 19562, (156, 90, 215, 170, 101, 16, 30, 144));
   IID_IMarshal     : aliased constant  WinUI3.GUID := (3, 0, 0, (192, 0, 0, 0, 0, 0, 0, 70));
   IID_IAgileObject : aliased constant  WinUI3.GUID := (2498374548, 59852, 18912, (192, 255, 238, 100, 202, 143, 91, 144));
   ...
   function RoInitialize (InitType : WinUI3.UInt32 := 1) return WinUI3.HResult;
   ...
   function RoActivateInstance(activatableClassId : WinUI3.HString ; instance : System.Address) return WinUI3.HResult;
   pragma Import (StdCall, RoActivateInstance, "RoActivateInstance");

   function WindowsCreateString(sourceString : System.Address ; length : WinUI3.UInt32 ; string : access WinUI3.HString) return WinUI3.HResult;
   pragma Import (StdCall, WindowsCreateString, "WindowsCreateString");

   function WindowsDeleteString(string : WinUI3.HString) return WinUI3.HRESULT;
   pragma Import (StdCall, WindowsDeleteString, "WindowsDeleteString");

   function WindowsGetStringLen(string : WinUI3.HString) return UInt32;
   pragma import(stdcall, WindowsGetStringLen,"WindowsGetStringLen");

   function WindowsGetStringRawBuffer(string : WinUI3.HString ; length : access UInt32) return Wide_Char_Ptr;
   pragma import(stdcall, WindowsGetStringRawBuffer,"WindowsGetStringRawBuffer");

   function RoGetActivationFactory(activatableClassId : WinUI3.HString ; iid : in WinUI3.IID_Ptr ; instance : System.Address) return WinUI3.HResult;
   pragma Import (StdCall, RoGetActivationFactory, "RoGetActivationFactory");

   function CoCreateFreeThreadedMarshaler(punkOuter : WinUI3.IUnknown; ppunkMarshel : access IUnknown) return WinUI3.HRESULT;
   ...
   (
      ...
      AddressSize : WinUI3.UInt32;
      dwMilliseconds : WinUI3.UInt32
   )
   return WinUI3.Int32;
   ...
   function To_HString (Value : Wide_String) return WinUI3.HString;
   function To_HString (Value : WString) return WinUI3.HString;
   function To_HString_Array (Value : WString_Array) return WinUI3.HString_Array;
   function To_Ada (Value : WinUI3.HString) return WString;
