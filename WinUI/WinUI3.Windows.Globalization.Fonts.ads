...
--------------------------------------------------------------------------------
package WinUI3.Windows.Globalization.Fonts is
   ...
   type ILanguageFont_Interface is interface and WinUI3.IInspectable_Interface;
   type ILanguageFont is access all ILanguageFont_Interface'Class;
   type ILanguageFont_Ptr is access all ILanguageFont;

   type ILanguageFontGroup_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type ILanguageFontGroupFactory_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   -----------------------------------------------------------------------------
   -- type ILanguageFont is interface and WinUI3.IInspectable;
      ...
      IID_ILanguageFont : aliased WinUI3.IID := (2972605498, 46957, 17819, (190, 235, 144, 17, 81, 205, 119, 209 ));

   -----------------------------------------------------------------------------
   -- type ILanguageFontGroup is interface and WinUI3.IInspectable;

      function get_UITextFont
      (
         this : access ILanguageFontGroup_Interface;
         RetVal : access WinUI3.Windows.Globalization.Fonts.ILanguageFont
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_ILanguageFontGroup : aliased WinUI3.IID := (4080697283, 14940, 19178, (185, 255, 179, 159, 178, 66, 247, 246 ));

   -----------------------------------------------------------------------------
   -- type ILanguageFontGroupFactory is interface and WinUI3.IInspectable;

      function CreateLanguageFontGroup
      (
         this : access ILanguageFontGroupFactory_Interface;
         languageTag : WinUI3.HString;
         RetVal : access WinUI3.Windows.Globalization.Fonts.ILanguageFontGroup
      )
      return WinUI3.Hresult is abstract;

      IID_ILanguageFontGroupFactory : aliased WinUI3.IID := (4239305831, 20087, 18887, (184, 86, 221, 233, 52, 252, 115, 91 ));
   ...
   return WinUI3.Windows.Globalization.Fonts.LanguageFont'Class;
...
end WinUI3.Windows.Globalization.Fonts;
