...
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
package WinUI3.Windows.ApplicationModel.CommunicationBlocking is
   ...
   type ICommunicationBlockingAccessManagerStatics_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type ICommunicationBlockingAppManagerStatics_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type ICommunicationBlockingAppManagerStatics2_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   -----------------------------------------------------------------------------
   -- type ICommunicationBlockingAccessManagerStatics is interface and WinUI3.IInspectable;
      ...
      IID_ICommunicationBlockingAccessManagerStatics : aliased WinUI3.IID := (479631768, 40234, 23991, (237, 213, 12, 228, 7, 252, 37, 149 ));

   -----------------------------------------------------------------------------
   -- type ICommunicationBlockingAppManagerStatics is interface and WinUI3.IInspectable;
      ...
      IID_ICommunicationBlockingAppManagerStatics : aliased WinUI3.IID := (2010863852, 5286, 19370, (148, 42, 106, 103, 61, 153, 155, 242 ));

   -----------------------------------------------------------------------------
   -- type ICommunicationBlockingAppManagerStatics2 is interface and WinUI3.IInspectable;
      ...
      IID_ICommunicationBlockingAppManagerStatics2 : aliased WinUI3.IID := (346459869, 60808, 17786, (163, 100, 163, 99, 77, 111, 22, 109 ));

end WinUI3.Windows.ApplicationModel.CommunicationBlocking;
