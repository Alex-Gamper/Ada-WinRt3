...
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
package WinUI3.Windows.Foundation.Metadata is
   ...
   type IApiInformationStatics_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   -----------------------------------------------------------------------------
   -- type IApiInformationStatics is interface and WinUI3.IInspectable;

      function IsTypePresent
      (
         this : access IApiInformationStatics_Interface;
         typeName : WinUI3.HString;
      ...
      (
         ...
         typeName : WinUI3.HString;
         methodName : WinUI3.HString;
         inputParameterCount : WinUI3.UInt32;
         RetVal : access WinUI3.Boolean
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         this : access IApiInformationStatics_Interface;
         enumTypeName : WinUI3.HString;
         valueName : WinUI3.HString;
         RetVal : access WinUI3.Boolean
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         this : access IApiInformationStatics_Interface;
         contractName : WinUI3.HString;
         majorVersion : WinUI3.UInt16;
         RetVal : access WinUI3.Boolean
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         ...
         contractName : WinUI3.HString;
         majorVersion : WinUI3.UInt16;
         minorVersion : WinUI3.UInt16;
         RetVal : access WinUI3.Boolean
      )
      return WinUI3.Hresult is abstract;

      IID_IApiInformationStatics : aliased WinUI3.IID := (2574531070, 63105, 18961, (180, 22, 193, 58, 71, 232, 186, 54 ));

end WinUI3.Windows.Foundation.Metadata;
