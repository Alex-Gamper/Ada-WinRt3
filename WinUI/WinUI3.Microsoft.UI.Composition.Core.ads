...
--------------------------------------------------------------------------------
package WinUI3.Microsoft.UI.Composition.Core is
   ...
   type CompositorController is new Ada.Finalization.Limited_Controlled with
      record
         m_ICompositorController : access Microsoft.UI.Composition.Core.ICompositorController;
      end record;
   ...
   -- type ICompositorController is interface and WinUI3.IInspectable;
      ...
      IID_ICompositorController : aliased WinUI3.IID := (3423632604, 21903, 23834, (150, 165, 167, 53, 172, 4, 56, 107 ));
