...
--------------------------------------------------------------------------------
package body WinUI3.Windows.ApplicationModel.AppService is
   ...
   package IAsyncOperation_AppServiceConnectionStatus is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.ApplicationModel.AppService.AppServiceConnectionStatus);
   package AsyncOperationCompletedHandler_AppServiceConnectionStatus is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.ApplicationModel.AppService.AppServiceConnectionStatus);

   package IAsyncOperation_AppServiceResponse is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.ApplicationModel.AppService.IAppServiceResponse);
   package AsyncOperationCompletedHandler_AppServiceResponse is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.ApplicationModel.AppService.IAppServiceResponse);

   package IAsyncOperation_StatelessAppServiceResponse is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.ApplicationModel.AppService.IStatelessAppServiceResponse);
   package AsyncOperationCompletedHandler_StatelessAppServiceResponse is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.ApplicationModel.AppService.IStatelessAppServiceResponse);

   package IAsyncOperation_AppServiceResponseStatus is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.ApplicationModel.AppService.AppServiceResponseStatus);
   package AsyncOperationCompletedHandler_AppServiceResponseStatus is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.ApplicationModel.AppService.AppServiceResponseStatus);
   ...
   package body AppServiceCatalog is
      ...
      (
         appServiceName : WinUI3.WString
      )
      return WinUI3.GenericObject is
         Hr               : WinUI3.HResult := S_OK;
         tmp              : WinUI3.HResult := S_OK;
         m_hString        : constant WinUI3.HString := To_HString ("Windows.ApplicationModel.AppService.AppServiceCatalog");
         m_Factory        : access WinUI3.Windows.ApplicationModel.AppService.IAppServiceCatalogStatics_Interface'Class := null;
         temp             : WinUI3.UInt32 := 0;
         HStr_appServiceName : constant WinUI3.HString := To_HString (appServiceName);
   ...
   return WinUI3.Windows.ApplicationModel.AppService.AppServiceClosedStatus is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.AppService.AppServiceClosedStatus;
   begin
   ...
   begin
      return RetVal : AppServiceConnection do
         ...
         if Hr = S_OK then
            Retval.m_IAppServiceConnection := new WinUI3.Windows.ApplicationModel.AppService.IAppServiceConnection;
   ...
   (
      ...
      connectionRequest : WinUI3.Windows.System.RemoteSystems.RemoteSystemConnectionRequest'Class;
      message : WinUI3.Windows.Foundation.Collections.ValueSet'Class
   )
   return WinUI3.Windows.ApplicationModel.AppService.StatelessAppServiceResponse is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_hString        : constant WinUI3.HString := To_HString ("Windows.ApplicationModel.AppService.AppServiceConnection");
      m_Factory        : access WinUI3.Windows.ApplicationModel.AppService.IAppServiceConnectionStatics_Interface'Class := null;
      temp             : WinUI3.UInt32 := 0;
      m_Temp           : WinUI3.Int32 := 0;
      m_Completed      : WinUI3.UInt32 := 0;
      m_Captured       : WinUI3.UInt32 := 0;
      ...
      m_AsyncStatus    : aliased WinUI3.Windows.Foundation.AsyncStatus;
      m_ComRetVal      : aliased WinUI3.GenericObject := null;
      m_RetVal         : aliased WinUI3.Windows.ApplicationModel.AppService.IStatelessAppServiceResponse;
      m_IID            : aliased WinUI3.IID := (2996916814, 48811, 23531, (170, 233, 180, 53, 1, 195, 164, 136 )); -- Windows.ApplicationModel.AppService.StatelessAppServiceResponse;
      m_HandlerIID     : aliased WinUI3.IID := (1293870317, 19833, 21498, (169, 215, 201, 201, 53, 78, 79, 85 ));
   ...
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.AppService.StatelessAppServiceResponse do
         ...
         if Hr = S_OK then
            ...
            if Hr = S_OK then
               ...
               if m_AsyncOperation /= null then
                  ...
                  if m_AsyncStatus = Completed_e then
                     Hr := m_AsyncOperation.GetResults (m_RetVal'Access);
                     Retval.m_IStatelessAppServiceResponse := new WinUI3.Windows.ApplicationModel.AppService.IStatelessAppServiceResponse;
   ...
   return WinUI3.Windows.ApplicationModel.AppService.AppServiceConnectionStatus is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_Temp           : WinUI3.Int32 := 0;
      ...
      m_AsyncStatus    : aliased WinUI3.Windows.Foundation.AsyncStatus;
      m_ComRetVal      : aliased WinUI3.GenericObject := null;
      m_RetVal         : aliased WinUI3.Windows.ApplicationModel.AppService.AppServiceConnectionStatus;
      m_IID            : aliased WinUI3.IID := (219047523, 9785, 23194, (156, 188, 48, 215, 212, 206, 83, 59 )); -- Windows.ApplicationModel.AppService.AppServiceConnectionStatus;
      m_HandlerIID     : aliased WinUI3.IID := (3066477554, 29386, 22425, (166, 81, 209, 153, 6, 112, 9, 123 ));
   ...
   return WinUI3.Windows.ApplicationModel.AppService.AppServiceResponse'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_Temp           : WinUI3.Int32 := 0;
      ...
      m_AsyncStatus    : aliased WinUI3.Windows.Foundation.AsyncStatus;
      m_ComRetVal      : aliased WinUI3.GenericObject := null;
      m_RetVal         : aliased WinUI3.Windows.ApplicationModel.AppService.IAppServiceResponse;
      m_IID            : aliased WinUI3.IID := (1215650428, 51343, 24304, (155, 76, 135, 111, 204, 38, 16, 180 )); -- Windows.ApplicationModel.AppService.AppServiceResponse;
      m_HandlerIID     : aliased WinUI3.IID := (2124929004, 57700, 21187, (142, 50, 187, 167, 18, 109, 144, 40 ));
   ...
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.AppService.AppServiceResponse do
         ...
         if Hr = S_OK then
            ...
            if m_AsyncOperation /= null then
               ...
               if m_AsyncStatus = Completed_e then
                  Hr := m_AsyncOperation.GetResults (m_RetVal'Access);
                  Retval.m_IAppServiceResponse := new WinUI3.Windows.ApplicationModel.AppService.IAppServiceResponse;
   ...
   return WinUI3.Windows.ApplicationModel.AppService.AppServiceConnectionStatus is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.ApplicationModel.AppService.IAppServiceConnection2 := null;
      temp             : WinUI3.UInt32 := 0;
      m_Temp           : WinUI3.Int32 := 0;
      m_Completed      : WinUI3.UInt32 := 0;
      m_Captured       : WinUI3.UInt32 := 0;
      ...
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.ApplicationModel.AppService.IAppServiceConnection_Interface, WinUI3.Windows.ApplicationModel.AppService.IAppServiceConnection2, WinUI3.Windows.ApplicationModel.AppService.IID_IAppServiceConnection2'Unchecked_Access);
   begin
   ...
   (
      ...
      temp             : WinUI3.UInt32 := 0;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.ApplicationModel.AppService.IAppServiceConnection_Interface, WinUI3.Windows.Foundation.IClosable, WinUI3.Windows.Foundation.IID_IClosable'Unchecked_Access);
   begin
      m_Interface := QInterface (this.m_IAppServiceConnection.all);
   ...
   return WinUI3.Windows.ApplicationModel.AppService.AppServiceResponseStatus is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_Temp           : WinUI3.Int32 := 0;
      ...
      m_AsyncStatus    : aliased WinUI3.Windows.Foundation.AsyncStatus;
      m_ComRetVal      : aliased WinUI3.GenericObject := null;
      m_RetVal         : aliased WinUI3.Windows.ApplicationModel.AppService.AppServiceResponseStatus;
      m_IID            : aliased WinUI3.IID := (2566764610, 23051, 21402, (163, 92, 85, 172, 95, 34, 134, 18 )); -- Windows.ApplicationModel.AppService.AppServiceResponseStatus;
      m_HandlerIID     : aliased WinUI3.IID := (3089381437, 13024, 21881, (134, 112, 160, 106, 97, 69, 127, 32 ));
   ...
   return WinUI3.Windows.ApplicationModel.AppService.AppServiceRequest'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.AppService.IAppServiceRequest;
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.AppService.AppServiceRequest do
         Hr := this.m_IAppServiceRequestReceivedEventArgs.all.get_Request (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IAppServiceRequest := new WinUI3.Windows.ApplicationModel.AppService.IAppServiceRequest;
   ...
   return WinUI3.Windows.ApplicationModel.AppService.AppServiceDeferral'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.AppService.IAppServiceDeferral;
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.AppService.AppServiceDeferral do
         Hr := this.m_IAppServiceRequestReceivedEventArgs.all.GetDeferral (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IAppServiceDeferral := new WinUI3.Windows.ApplicationModel.AppService.IAppServiceDeferral;
   ...
   return WinUI3.Windows.ApplicationModel.AppService.AppServiceResponseStatus is
      ...
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.AppService.AppServiceResponseStatus;
   begin
   ...
   return WinUI3.Windows.ApplicationModel.AppService.AppServiceConnection'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.AppService.IAppServiceConnection;
   begin
      return RetVal : WinUI3.Windows.ApplicationModel.AppService.AppServiceConnection do
   ...
   return WinUI3.Boolean is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.ApplicationModel.AppService.IAppServiceTriggerDetails2 := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Boolean;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.ApplicationModel.AppService.IAppServiceTriggerDetails_Interface, WinUI3.Windows.ApplicationModel.AppService.IAppServiceTriggerDetails2, WinUI3.Windows.ApplicationModel.AppService.IID_IAppServiceTriggerDetails2'Unchecked_Access);
   begin
   ...
   return WinUI3.Boolean is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.ApplicationModel.AppService.IAppServiceTriggerDetails3 := null;
      temp             : WinUI3.UInt32 := 0;
      ...
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.ApplicationModel.AppService.IAppServiceTriggerDetails_Interface, WinUI3.Windows.ApplicationModel.AppService.IAppServiceTriggerDetails3, WinUI3.Windows.ApplicationModel.AppService.IID_IAppServiceTriggerDetails3'Unchecked_Access);
   begin
      m_Interface := QInterface (this.m_IAppServiceTriggerDetails.all);
   ...
   return WinUI3.WString is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.ApplicationModel.AppService.IAppServiceTriggerDetails4 := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.HString;
      AdaRetval        : WString;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.ApplicationModel.AppService.IAppServiceTriggerDetails_Interface, WinUI3.Windows.ApplicationModel.AppService.IAppServiceTriggerDetails4, WinUI3.Windows.ApplicationModel.AppService.IID_IAppServiceTriggerDetails4'Unchecked_Access);
   begin
      m_Interface := QInterface (this.m_IAppServiceTriggerDetails.all);
   ...
   return WinUI3.Windows.ApplicationModel.AppService.StatelessAppServiceResponseStatus is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.AppService.StatelessAppServiceResponseStatus;
   begin
...
end WinUI3.Windows.ApplicationModel.AppService;
