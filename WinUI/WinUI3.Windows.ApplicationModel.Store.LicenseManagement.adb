...
--------------------------------------------------------------------------------
package body WinUI3.Windows.ApplicationModel.Store.LicenseManagement is

   package IAsyncOperation_LicenseSatisfactionResult is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.ApplicationModel.Store.LicenseManagement.ILicenseSatisfactionResult);
   package AsyncOperationCompletedHandler_LicenseSatisfactionResult is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.ApplicationModel.Store.LicenseManagement.ILicenseSatisfactionResult);
   ...
   package body LicenseManager is
      ...
      (
         ...
         m_hString        : constant WinUI3.HString := To_HString ("Windows.ApplicationModel.Store.LicenseManagement.LicenseManager");
         m_Factory        : access WinUI3.Windows.ApplicationModel.Store.LicenseManagement.ILicenseManagerStatics2_Interface'Class := null;
      ...
      (
         ...
         tmp              : WinUI3.HResult := S_OK;
         m_hString        : constant WinUI3.HString := To_HString ("Windows.ApplicationModel.Store.LicenseManagement.LicenseManager");
         m_Factory        : access WinUI3.Windows.ApplicationModel.Store.LicenseManagement.ILicenseManagerStatics_Interface'Class := null;
         temp             : WinUI3.UInt32 := 0;
         m_Temp           : WinUI3.Int32 := 0;
         m_Completed      : WinUI3.UInt32 := 0;
         m_Captured       : WinUI3.UInt32 := 0;
      ...
      return WinUI3.Windows.ApplicationModel.Store.LicenseManagement.LicenseSatisfactionResult is
         Hr               : WinUI3.HResult := S_OK;
         tmp              : WinUI3.HResult := S_OK;
         m_hString        : constant WinUI3.HString := To_HString ("Windows.ApplicationModel.Store.LicenseManagement.LicenseManager");
         m_Factory        : access WinUI3.Windows.ApplicationModel.Store.LicenseManagement.ILicenseManagerStatics_Interface'Class := null;
         ...
         m_RetVal         : aliased WinUI3.Windows.ApplicationModel.Store.LicenseManagement.ILicenseSatisfactionResult;
         m_IID            : aliased WinUI3.IID := (3091495881, 43512, 22631, (139, 48, 205, 52, 114, 14, 220, 49 )); -- Windows.ApplicationModel.Store.LicenseManagement.LicenseSatisfactionResult;
         m_HandlerIID     : aliased WinUI3.IID := (2473493617, 9519, 21305, (137, 195, 148, 40, 65, 32, 134, 202 ));
      ...
      begin
         return RetVal : WinUI3.Windows.ApplicationModel.Store.LicenseManagement.LicenseSatisfactionResult do
            Hr := RoGetActivationFactory (m_hString, IID_ILicenseManagerStatics'Access , m_Factory'Address);
            if Hr = S_OK then
               ...
               if Hr = S_OK then
                  ...
                  if m_AsyncOperation /= null then
                     ...
                     if m_AsyncStatus = Completed_e then
                        ...
                        Retval.m_ILicenseSatisfactionResult := new WinUI3.Windows.ApplicationModel.Store.LicenseManagement.ILicenseSatisfactionResult;
