...
--------------------------------------------------------------------------------
package WinUI3.Windows.Media.SpeechSynthesis is
   ...
   type IInstalledVoicesStatic_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IInstalledVoicesStatic2_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type ISpeechSynthesisStream_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type ISpeechSynthesizer_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type ISpeechSynthesizer2_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type ISpeechSynthesizerOptions_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type ISpeechSynthesizerOptions2_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type ISpeechSynthesizerOptions3_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IVoiceInformation_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   package IVectorView_IMediaMarker is new WinUI3.Windows.Foundation.Collections.IVectorView (WinUI3.Windows.Media.IMediaMarker);
   IID_IVectorView_IMediaMarker : aliased WinUI3.IID := (1064925668, 57160, 22288, (184, 71, 50, 38, 225, 150, 128, 45 ));
   ...
   -----------------------------------------------------------------------------
   -- type IInstalledVoicesStatic is interface and WinUI3.IInspectable;
      ...
      (
         this : access IInstalledVoicesStatic_Interface;
         RetVal : access WinUI3.Windows.Media.SpeechSynthesis.IVoiceInformation
      )
      return WinUI3.Hresult is abstract;

      IID_IInstalledVoicesStatic : aliased WinUI3.IID := (2102554316, 30003, 19519, (133, 190, 136, 140, 43, 174, 235, 220 ));

   -----------------------------------------------------------------------------
   -- type IInstalledVoicesStatic2 is interface and WinUI3.IInspectable;

      function TrySetDefaultVoiceAsync
      (
         this : access IInstalledVoicesStatic2_Interface;
         voice : WinUI3.Windows.Media.SpeechSynthesis.IVoiceInformation;
         RetVal : access GenericObject
      )
      return WinUI3.Hresult is abstract;

      IID_IInstalledVoicesStatic2 : aliased WinUI3.IID := (1680170798, 13709, 16472, (190, 154, 253, 63, 203, 66, 53, 48 ));

   -----------------------------------------------------------------------------
   -- type ISpeechSynthesisStream is interface and WinUI3.IInspectable;
      ...
      IID_ISpeechSynthesisStream : aliased WinUI3.IID := (2212785811, 9292, 17954, (186, 11, 98, 41, 196, 208, 214, 93 ));

   -----------------------------------------------------------------------------
   -- type ISpeechSynthesizer is interface and WinUI3.IInspectable;
      ...
      (
         this : access ISpeechSynthesizer_Interface;
         value : WinUI3.Windows.Media.SpeechSynthesis.IVoiceInformation
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_ISpeechSynthesizer : aliased WinUI3.IID := (3466558582, 38900, 19693, (173, 104, 213, 28, 69, 142, 69, 198 ));

   -----------------------------------------------------------------------------
   -- type ISpeechSynthesizer2 is interface and WinUI3.IInspectable;

      function get_Options
      (
         this : access ISpeechSynthesizer2_Interface;
         RetVal : access WinUI3.Windows.Media.SpeechSynthesis.ISpeechSynthesizerOptions
      )
      return WinUI3.Hresult is abstract;

      IID_ISpeechSynthesizer2 : aliased WinUI3.IID := (2814766258, 17209, 19818, (187, 248, 199, 164, 241, 84, 76, 46 ));

   -----------------------------------------------------------------------------
   -- type ISpeechSynthesizerOptions is interface and WinUI3.IInspectable;
      ...
      IID_ISpeechSynthesizerOptions : aliased WinUI3.IID := (2699180145, 52285, 17353, (145, 177, 238, 24, 83, 36, 216, 61 ));

   -----------------------------------------------------------------------------
   -- type ISpeechSynthesizerOptions2 is interface and WinUI3.IInspectable;
      ...
      IID_ISpeechSynthesizerOptions2 : aliased WinUI3.IID := (482276878, 4508, 19437, (177, 24, 210, 80, 195, 162, 87, 147 ));

   -----------------------------------------------------------------------------
   -- type ISpeechSynthesizerOptions3 is interface and WinUI3.IInspectable;

      function get_AppendedSilence
      (
         this : access ISpeechSynthesizerOptions3_Interface;
         RetVal : access WinUI3.Windows.Media.SpeechSynthesis.SpeechAppendedSilence
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         this : access ISpeechSynthesizerOptions3_Interface;
         RetVal : access WinUI3.Windows.Media.SpeechSynthesis.SpeechPunctuationSilence
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_ISpeechSynthesizerOptions3 : aliased WinUI3.IID := (1075763319, 36908, 18452, (165, 130, 165, 208, 192, 118, 159, 168 ));

   -----------------------------------------------------------------------------
   -- type IVoiceInformation is interface and WinUI3.IInspectable;
      ...
      (
         this : access IVoiceInformation_Interface;
         RetVal : access WinUI3.Windows.Media.SpeechSynthesis.VoiceGender
      )
      return WinUI3.Hresult is abstract;

      IID_IVoiceInformation : aliased WinUI3.IID := (2972178084, 4753, 17924, (170, 156, 131, 19, 64, 131, 53, 44 ));
   ...
   function get_DefaultVoice
   return WinUI3.Windows.Media.SpeechSynthesis.VoiceInformation;
   ...
   return WinUI3.Windows.Media.SpeechSynthesis.SpeechSynthesisStream'Class;
   ...
   return WinUI3.Windows.Media.SpeechSynthesis.VoiceInformation'Class;
   ...
   return WinUI3.Windows.Media.SpeechSynthesis.SpeechSynthesizerOptions'Class;
   ...
   return WinUI3.Windows.Media.SpeechSynthesis.SpeechAppendedSilence;
   ...
   return WinUI3.Windows.Media.SpeechSynthesis.SpeechPunctuationSilence;
   ...
   return WinUI3.Windows.Media.SpeechSynthesis.VoiceGender;
