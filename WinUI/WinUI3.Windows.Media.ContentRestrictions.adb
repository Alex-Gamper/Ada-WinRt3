...
package body WinUI3.Windows.Media.ContentRestrictions is
   ...
   return RatedContentDescription is
      Hr           : WinUI3.HResult := S_OK;
      tmp          : WinUI3.HResult := S_OK;
      m_hString    : constant WinUI3.HString := To_HString ("Windows.Media.ContentRestrictions.RatedContentDescription");
   ...
   return RatedContentRestrictions is
      Hr           : WinUI3.HResult := S_OK;
      tmp          : WinUI3.HResult := S_OK;
      m_hString    : constant WinUI3.HString := To_HString ("Windows.Media.ContentRestrictions.RatedContentRestrictions");
