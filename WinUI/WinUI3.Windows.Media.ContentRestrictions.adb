...
--------------------------------------------------------------------------------
package body WinUI3.Windows.Media.ContentRestrictions is

   package IAsyncOperation_ContentRestrictionsBrowsePolicy is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.Media.ContentRestrictions.IContentRestrictionsBrowsePolicy);
   package AsyncOperationCompletedHandler_ContentRestrictionsBrowsePolicy is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.Media.ContentRestrictions.IContentRestrictionsBrowsePolicy);

   package IAsyncOperation_ContentAccessRestrictionLevel is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.Media.ContentRestrictions.ContentAccessRestrictionLevel);
   package AsyncOperationCompletedHandler_ContentAccessRestrictionLevel is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.Media.ContentRestrictions.ContentAccessRestrictionLevel);
   ...
   return RatedContentDescription is
      Hr           : WinUI3.HResult := S_OK;
      tmp          : WinUI3.HResult := S_OK;
      m_hString    : constant WinUI3.HString := To_HString ("Windows.Media.ContentRestrictions.IRatedContentDescription");
      m_Factory    : access IRatedContentDescriptionFactory_Interface'Class := null;
      temp         : WinUI3.UInt32 := 0;
      m_ComRetVal  : aliased WinUI3.Windows.Media.ContentRestrictions.IRatedContentDescription;
   ...
   begin
      return RetVal : RatedContentDescription do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IRatedContentDescription := new WinUI3.Windows.Media.ContentRestrictions.IRatedContentDescription;
   ...
   return WinUI3.Windows.Media.ContentRestrictions.RatedContentCategory is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Media.ContentRestrictions.RatedContentCategory;
   begin
   ...
   return RatedContentRestrictions is
      Hr           : WinUI3.HResult := S_OK;
      tmp          : WinUI3.HResult := S_OK;
      m_hString    : constant WinUI3.HString := To_HString ("Windows.Media.ContentRestrictions.IRatedContentRestrictions");
      m_Factory    : access IRatedContentRestrictionsFactory_Interface'Class := null;
      temp         : WinUI3.UInt32 := 0;
      m_ComRetVal  : aliased WinUI3.Windows.Media.ContentRestrictions.IRatedContentRestrictions;
   begin
      return RetVal : RatedContentRestrictions do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IRatedContentRestrictions := new WinUI3.Windows.Media.ContentRestrictions.IRatedContentRestrictions;
   ...
   return WinUI3.Windows.Media.ContentRestrictions.ContentRestrictionsBrowsePolicy'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      ...
      m_RetVal         : aliased WinUI3.Windows.Media.ContentRestrictions.IContentRestrictionsBrowsePolicy;
      m_IID            : aliased WinUI3.IID := (2922617266, 51157, 24347, (159, 185, 248, 189, 129, 233, 249, 190 )); -- Windows.Media.ContentRestrictions.ContentRestrictionsBrowsePolicy;
      m_HandlerIID     : aliased WinUI3.IID := (1924012566, 50949, 21735, (177, 196, 252, 5, 160, 224, 122, 119 ));
   ...
   begin
      return RetVal : WinUI3.Windows.Media.ContentRestrictions.ContentRestrictionsBrowsePolicy do
         ...
         if Hr = S_OK then
            ...
            if m_AsyncOperation /= null then
               ...
               if m_AsyncStatus = Completed_e then
                  ...
                  Retval.m_IContentRestrictionsBrowsePolicy := new WinUI3.Windows.Media.ContentRestrictions.IContentRestrictionsBrowsePolicy;
   ...
   return WinUI3.Windows.Media.ContentRestrictions.ContentAccessRestrictionLevel is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_Temp           : WinUI3.Int32 := 0;
      ...
      m_AsyncStatus    : aliased WinUI3.Windows.Foundation.AsyncStatus;
      m_ComRetVal      : aliased WinUI3.GenericObject := null;
      m_RetVal         : aliased WinUI3.Windows.Media.ContentRestrictions.ContentAccessRestrictionLevel;
      m_IID            : aliased WinUI3.IID := (2248933753, 48641, 21613, (169, 206, 89, 86, 70, 76, 152, 171 )); -- Windows.Media.ContentRestrictions.ContentAccessRestrictionLevel;
      m_HandlerIID     : aliased WinUI3.IID := (3479289437, 16579, 21636, (132, 106, 63, 130, 184, 186, 87, 56 ));
