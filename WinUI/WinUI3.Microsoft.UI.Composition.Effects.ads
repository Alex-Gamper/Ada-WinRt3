...
--------------------------------------------------------------------------------
package WinUI3.Microsoft.UI.Composition.Effects is
   ...
   type SceneLightingEffect is new Ada.Finalization.Limited_Controlled with
      record
         m_ISceneLightingEffect : access Microsoft.UI.Composition.Effects.ISceneLightingEffect;
      end record;
   ...
   -- type ISceneLightingEffect is interface and WinUI3.IInspectable;
      ...
      IID_ISceneLightingEffect : aliased WinUI3.IID := (3944641302, 4428, 22864, (132, 128, 32, 162, 154, 59, 177, 238 ));
   ...
   -- type ISceneLightingEffect2 is interface and WinUI3.IInspectable;
      ...
      (
         ...
         RetVal : access WinUI3.Microsoft.UI.Composition.Effects.SceneLightingEffectReflectanceModel
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_ISceneLightingEffect2 : aliased WinUI3.IID := (1801754290, 18061, 20689, (187, 233, 89, 59, 130, 99, 173, 128 ));
   ...
   return WinUI3.Microsoft.UI.Composition.Effects.SceneLightingEffectReflectanceModel;
