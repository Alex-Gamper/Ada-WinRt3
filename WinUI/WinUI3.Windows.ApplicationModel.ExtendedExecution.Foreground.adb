...
--------------------------------------------------------------------------------
package body WinUI3.Windows.ApplicationModel.ExtendedExecution.Foreground is

   package IAsyncOperation_ExtendedExecutionForegroundResult is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.ApplicationModel.ExtendedExecution.Foreground.ExtendedExecutionForegroundResult);
   package AsyncOperationCompletedHandler_ExtendedExecutionForegroundResult is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.ApplicationModel.ExtendedExecution.Foreground.ExtendedExecutionForegroundResult);
   ...
   return WinUI3.Windows.ApplicationModel.ExtendedExecution.Foreground.ExtendedExecutionForegroundRevokedReason is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.ExtendedExecution.Foreground.ExtendedExecutionForegroundRevokedReason;
   begin
   ...
   begin
      return RetVal : ExtendedExecutionForegroundSession do
         ...
         if Hr = S_OK then
            Retval.m_IExtendedExecutionForegroundSession := new WinUI3.Windows.ApplicationModel.ExtendedExecution.Foreground.IExtendedExecutionForegroundSession;
   ...
   return WinUI3.Windows.ApplicationModel.ExtendedExecution.Foreground.ExtendedExecutionForegroundResult is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      ...
      m_RetVal         : aliased WinUI3.Windows.ApplicationModel.ExtendedExecution.Foreground.ExtendedExecutionForegroundResult;
      m_IID            : aliased WinUI3.IID := (2978914319, 35872, 23234, (146, 70, 62, 244, 5, 39, 31, 26 )); -- Windows.ApplicationModel.ExtendedExecution.Foreground.ExtendedExecutionForegroundResult;
      m_HandlerIID     : aliased WinUI3.IID := (132242433, 6330, 22890, (183, 69, 121, 249, 205, 228, 76, 204 ));
   ...
   return WinUI3.Windows.ApplicationModel.ExtendedExecution.Foreground.ExtendedExecutionForegroundReason is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.ApplicationModel.ExtendedExecution.Foreground.ExtendedExecutionForegroundReason;
   begin
   ...
   (
      this : in out ExtendedExecutionForegroundSession;
      value : WinUI3.Windows.ApplicationModel.ExtendedExecution.Foreground.ExtendedExecutionForegroundReason
   ) is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
   ...
   (
      ...
      temp             : WinUI3.UInt32 := 0;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.ApplicationModel.ExtendedExecution.Foreground.IExtendedExecutionForegroundSession_Interface, WinUI3.Windows.Foundation.IClosable, WinUI3.Windows.Foundation.IID_IClosable'Unchecked_Access);
   begin
...
end WinUI3.Windows.ApplicationModel.ExtendedExecution.Foreground;
