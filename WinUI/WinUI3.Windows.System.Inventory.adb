...
--------------------------------------------------------------------------------
package body WinUI3.Windows.System.Inventory is
   ...
   return WinUI3.GenericObject is
      ...
      m_hString        : constant WinUI3.HString := To_HString ("Windows.System.Inventory.InstalledDesktopApp");
      m_Factory        : access WinUI3.Windows.System.Inventory.IInstalledDesktopAppStatics_Interface'Class := null;
      temp             : WinUI3.UInt32 := 0;
      ...
      m_IID            : aliased WinUI3.IID := (2684202880, 27941, 24116, (152, 134, 43, 93, 84, 29, 131, 36 )); -- GenericObject;
      m_HandlerIID     : aliased WinUI3.IID := (3952368764, 32477, 22106, (139, 204, 130, 186, 244, 234, 23, 182 ));
   ...
   return WinUI3.WString is
      ...
      m_ComRetVal      : aliased WinUI3.HString;
      AdaRetval        : WString;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.System.Inventory.IInstalledDesktopApp_Interface, WinUI3.Windows.Foundation.IStringable, WinUI3.Windows.Foundation.IID_IStringable'Unchecked_Access);
   begin
...
end WinUI3.Windows.System.Inventory;
