...
--------------------------------------------------------------------------------
package body WinUI3.Windows.Devices.Printers.Extensions is
   ...
   return WinUI3.Windows.Foundation.EventRegistrationToken is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.Devices.Printers.Extensions.IPrint3DWorkflow2 := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Foundation.EventRegistrationToken;
      function QInterface is new Generic_QueryInterface (WinUI3.Windows.Devices.Printers.Extensions.IPrint3DWorkflow_Interface, WinUI3.Windows.Devices.Printers.Extensions.IPrint3DWorkflow2, WinUI3.Windows.Devices.Printers.Extensions.IID_IPrint3DWorkflow2'Unchecked_Access);
   begin
   ...
   return WinUI3.Windows.Devices.Printers.Extensions.Print3DWorkflowStatus is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Devices.Printers.Extensions.Print3DWorkflowStatus;
   begin
   ...
   package body PrintExtensionContext is
      ...
      return WinUI3.IInspectable is
         Hr               : WinUI3.HResult := S_OK;
         tmp              : WinUI3.HResult := S_OK;
         m_hString        : constant WinUI3.HString := To_HString ("Windows.Devices.Printers.Extensions.PrintExtensionContext");
         m_Factory        : access WinUI3.Windows.Devices.Printers.Extensions.IPrintExtensionContextStatic_Interface'Class := null;
         temp             : WinUI3.UInt32 := 0;
         m_ComRetVal      : aliased WinUI3.IInspectable;
   ...
   return WinUI3.Windows.Devices.Printers.Extensions.PrintTaskConfigurationSaveRequestedDeferral'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Devices.Printers.Extensions.IPrintTaskConfigurationSaveRequestedDeferral;
   begin
      return RetVal : WinUI3.Windows.Devices.Printers.Extensions.PrintTaskConfigurationSaveRequestedDeferral do
         Hr := this.m_IPrintTaskConfigurationSaveRequest.all.GetDeferral (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IPrintTaskConfigurationSaveRequestedDeferral := new WinUI3.Windows.Devices.Printers.Extensions.IPrintTaskConfigurationSaveRequestedDeferral;
   ...
   return WinUI3.Windows.Devices.Printers.Extensions.PrintTaskConfigurationSaveRequest'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Devices.Printers.Extensions.IPrintTaskConfigurationSaveRequest;
   begin
      return RetVal : WinUI3.Windows.Devices.Printers.Extensions.PrintTaskConfigurationSaveRequest do
         Hr := this.m_IPrintTaskConfigurationSaveRequestedEventArgs.all.get_Request (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IPrintTaskConfigurationSaveRequest := new WinUI3.Windows.Devices.Printers.Extensions.IPrintTaskConfigurationSaveRequest;
