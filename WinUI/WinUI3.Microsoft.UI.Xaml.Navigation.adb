...
--------------------------------------------------------------------------------
package body WinUI3.Microsoft.UI.Xaml.Navigation is
   ...
   return FrameNavigationOptions is
      ...
      m_hString    : constant WinUI3.HString := To_HString ("Microsoft.UI.Xaml.Navigation.IFrameNavigationOptions");
      m_Factory    : access IFrameNavigationOptionsFactory_Interface'Class := null;
      temp         : WinUI3.UInt32 := 0;
      m_ComRetVal  : aliased WinUI3.Microsoft.UI.Xaml.Navigation.IFrameNavigationOptions;
   begin
      return RetVal : FrameNavigationOptions do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IFrameNavigationOptions := new WinUI3.Microsoft.UI.Xaml.Navigation.IFrameNavigationOptions;
   ...
   return WinUI3.Microsoft.UI.Xaml.Navigation.NavigationMode is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Microsoft.UI.Xaml.Navigation.NavigationMode;
   begin
   ...
   begin
      Hr := this.m_INavigatingCancelEventArgs.all.get_Parameter (m_ComRetVal'Access);
      if Hr /= S_OK then
         raise Program_Error;
      end if;
      return m_ComRetVal;
   ...
   begin
      return RetVal : WinUI3.Microsoft.UI.Xaml.Media.Animation.NavigationTransitionInfo do
         Hr := this.m_INavigatingCancelEventArgs.all.get_NavigationTransitionInfo (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_INavigationTransitionInfo := new WinUI3.Microsoft.UI.Xaml.Media.Animation.INavigationTransitionInfo;
   ...
   begin
      return RetVal : WinUI3.Microsoft.UI.Xaml.Media.Animation.NavigationTransitionInfo do
         Hr := this.m_INavigationEventArgs.all.get_NavigationTransitionInfo (m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_INavigationTransitionInfo := new WinUI3.Microsoft.UI.Xaml.Media.Animation.INavigationTransitionInfo;
   ...
   return PageStackEntry is
      Hr           : WinUI3.HResult := S_OK;
      tmp          : WinUI3.HResult := S_OK;
      m_hString    : constant WinUI3.HString := To_HString ("Microsoft.UI.Xaml.Navigation.IPageStackEntry");
      m_Factory    : access IPageStackEntryFactory_Interface'Class := null;
      temp         : WinUI3.UInt32 := 0;
      m_ComRetVal  : aliased WinUI3.Microsoft.UI.Xaml.Navigation.IPageStackEntry;
   begin
      return RetVal : PageStackEntry do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IPageStackEntry := new WinUI3.Microsoft.UI.Xaml.Navigation.IPageStackEntry;
   ...
   return WinUI3.Microsoft.UI.Xaml.DependencyProperty is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_hString        : constant WinUI3.HString := To_HString ("Microsoft.UI.Xaml.Navigation.PageStackEntry");
      m_Factory        : access WinUI3.Microsoft.UI.Xaml.Navigation.IPageStackEntryStatics_Interface'Class := null;
      temp             : WinUI3.UInt32 := 0;
