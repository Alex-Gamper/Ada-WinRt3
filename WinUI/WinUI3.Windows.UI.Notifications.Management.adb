...
--------------------------------------------------------------------------------
package body WinUI3.Windows.UI.Notifications.Management is

   package IAsyncOperation_UserNotificationListenerAccessStatus is new WinUI3.Windows.Foundation.IAsyncOperation (WinUI3.Windows.UI.Notifications.Management.UserNotificationListenerAccessStatus);
   package AsyncOperationCompletedHandler_UserNotificationListenerAccessStatus is new WinUI3.Windows.Foundation.AsyncOperationCompletedHandler (WinUI3.Windows.UI.Notifications.Management.UserNotificationListenerAccessStatus);
   ...
   return WinUI3.Windows.UI.Notifications.Management.UserNotificationListener is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_hString        : constant WinUI3.HString := To_HString ("Windows.UI.Notifications.Management.UserNotificationListener");
      m_Factory        : access WinUI3.Windows.UI.Notifications.Management.IUserNotificationListenerStatics_Interface'Class := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.UI.Notifications.Management.IUserNotificationListener;
   begin
      return RetVal : WinUI3.Windows.UI.Notifications.Management.UserNotificationListener do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IUserNotificationListener := new WinUI3.Windows.UI.Notifications.Management.IUserNotificationListener;
   ...
   return WinUI3.Windows.UI.Notifications.Management.UserNotificationListenerAccessStatus is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      ...
      m_RetVal         : aliased WinUI3.Windows.UI.Notifications.Management.UserNotificationListenerAccessStatus;
      m_IID            : aliased WinUI3.IID := (263903431, 2159, 23545, (129, 226, 141, 121, 231, 24, 72, 3 )); -- Windows.UI.Notifications.Management.UserNotificationListenerAccessStatus;
      m_HandlerIID     : aliased WinUI3.IID := (4036920378, 5067, 21915, (169, 252, 1, 87, 34, 194, 205, 87 ));
   ...
   return WinUI3.Windows.UI.Notifications.Management.UserNotificationListenerAccessStatus is
      ...
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.UI.Notifications.Management.UserNotificationListenerAccessStatus;
   begin
   ...
   (
      this : in out UserNotificationListener;
      kinds : WinUI3.Windows.UI.Notifications.NotificationKinds
   )
   return WinUI3.GenericObject is
      ...
      m_IID            : aliased WinUI3.IID := (3212787004, 8975, 21738, (173, 116, 12, 246, 197, 92, 216, 209 )); -- GenericObject;
      m_HandlerIID     : aliased WinUI3.IID := (2655186184, 17843, 22083, (181, 199, 178, 22, 245, 120, 21, 148 ));
   ...
   return WinUI3.Windows.UI.Notifications.UserNotification'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.UI.Notifications.IUserNotification;
   begin
      return RetVal : WinUI3.Windows.UI.Notifications.UserNotification do
         Hr := this.m_IUserNotificationListener.all.GetNotification (notificationId, m_ComRetVal'Access);
         if Hr /= S_OK then
            raise Program_Error;
         end if;
         Retval.m_IUserNotification := new WinUI3.Windows.UI.Notifications.IUserNotification;
...
end WinUI3.Windows.UI.Notifications.Management;
