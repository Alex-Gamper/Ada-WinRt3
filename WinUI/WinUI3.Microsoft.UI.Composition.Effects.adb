...
--------------------------------------------------------------------------------
package body WinUI3.Microsoft.UI.Composition.Effects is
   ...
   function Constructor return SceneLightingEffect is
      ...
      m_hString    : constant WinUI3.HString := To_HString ("Microsoft.UI.Composition.Effects.ISceneLightingEffect");
      m_ComRetVal  : aliased WinUI3.Microsoft.UI.Composition.Effects.ISceneLightingEffect;
   begin
      return RetVal : SceneLightingEffect do
         Hr := RoActivateInstance (m_hString, m_ComRetVal'Address);
         if Hr = S_OK then
            Retval.m_ISceneLightingEffect := new WinUI3.Microsoft.UI.Composition.Effects.ISceneLightingEffect;
   ...
   return WinUI3.Windows.Graphics.Effects.IGraphicsEffectSource is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Graphics.Effects.IGraphicsEffectSource;
   begin
   ...
   return WinUI3.Microsoft.UI.Composition.Effects.SceneLightingEffectReflectanceModel is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Microsoft.UI.Composition.Effects.ISceneLightingEffect2 := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Microsoft.UI.Composition.Effects.SceneLightingEffectReflectanceModel;
      function QInterface is new Generic_QueryInterface (WinUI3.Microsoft.UI.Composition.Effects.ISceneLightingEffect_Interface, WinUI3.Microsoft.UI.Composition.Effects.ISceneLightingEffect2, WinUI3.Microsoft.UI.Composition.Effects.IID_ISceneLightingEffect2'Unchecked_Access);
   begin
   ...
   (
      this : in out SceneLightingEffect;
      value : WinUI3.Microsoft.UI.Composition.Effects.SceneLightingEffectReflectanceModel
   ) is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Microsoft.UI.Composition.Effects.ISceneLightingEffect2 := null;
   ...
   return WinUI3.WString is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_Interface      : WinUI3.Windows.Graphics.Effects.IGraphicsEffect := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.HString;
      AdaRetval        : WString;
      function QInterface is new Generic_QueryInterface (WinUI3.Microsoft.UI.Composition.Effects.ISceneLightingEffect_Interface, WinUI3.Windows.Graphics.Effects.IGraphicsEffect, WinUI3.Windows.Graphics.Effects.IID_IGraphicsEffect'Unchecked_Access);
   begin
      m_Interface := QInterface (this.m_ISceneLightingEffect.all);
...
end WinUI3.Microsoft.UI.Composition.Effects;
