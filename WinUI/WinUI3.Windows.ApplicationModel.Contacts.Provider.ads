...
--------------------------------------------------------------------------------
package WinUI3.Windows.ApplicationModel.Contacts.Provider is
   ...
   type IContactPickerUI_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IContactPickerUI2_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IContactRemovedEventArgs_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   IID_IVectorView_HString : aliased WinUI3.IID := (1876249280, 53067, 22264, (158, 149, 37, 211, 47, 96, 202, 222 ));
   ...
   package IVector_ContactFieldType is new WinUI3.Windows.Foundation.Collections.IVector (WinUI3.Windows.ApplicationModel.Contacts.ContactFieldType);
   IID_IVector_ContactFieldType : aliased WinUI3.IID := (1407643354, 30083, 24355, (170, 171, 200, 157, 83, 3, 186, 241 ));
   ...
   -----------------------------------------------------------------------------
   -- type IContactPickerUI is interface and WinUI3.IInspectable;
      ...
      (
         ...
         RetVal : access WinUI3.Windows.ApplicationModel.Contacts.Provider.AddContactResult
      )
      ...
      IID_IContactPickerUI : aliased WinUI3.IID := (3805025126, 53094, 17348, (169, 106, 165, 161, 18, 219, 71, 70 ));

   -----------------------------------------------------------------------------
   -- type IContactPickerUI2 is interface and WinUI3.IInspectable;
      ...
      IID_IContactPickerUI2 : aliased WinUI3.IID := (1849990696, 31525, 18841, (155, 11, 135, 84, 0, 161, 232, 200 ));

   -----------------------------------------------------------------------------
   -- type IContactRemovedEventArgs is interface and WinUI3.IInspectable;
      ...
      IID_IContactRemovedEventArgs : aliased WinUI3.IID := (1865761592, 13058, 19731, (173, 141, 173, 204, 15, 249, 228, 124 ));
   ...
   return WinUI3.Windows.ApplicationModel.Contacts.Provider.AddContactResult;
...
end WinUI3.Windows.ApplicationModel.Contacts.Provider;
