...
--------------------------------------------------------------------------------
package body WinUI3.Windows.Devices.Geolocation.Geofencing is
   ...
   return Geofence is
      ...
      m_hString    : constant WinUI3.HString := To_HString ("Windows.Devices.Geolocation.Geofencing.IGeofence");
      m_Factory    : access IGeofenceFactory_Interface'Class := null;
      temp         : WinUI3.UInt32 := 0;
      m_ComRetVal  : aliased WinUI3.Windows.Devices.Geolocation.Geofencing.IGeofence;
   ...
   begin
      return RetVal : Geofence do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IGeofence := new WinUI3.Windows.Devices.Geolocation.Geofencing.IGeofence;
   ...
   return WinUI3.Windows.Devices.Geolocation.Geofencing.MonitoredGeofenceStates is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Devices.Geolocation.Geofencing.MonitoredGeofenceStates;
   begin
   ...
   return WinUI3.Windows.Devices.Geolocation.Geofencing.GeofenceMonitor is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      m_hString        : constant WinUI3.HString := To_HString ("Windows.Devices.Geolocation.Geofencing.GeofenceMonitor");
      m_Factory        : access WinUI3.Windows.Devices.Geolocation.Geofencing.IGeofenceMonitorStatics_Interface'Class := null;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Devices.Geolocation.Geofencing.IGeofenceMonitor;
   begin
      return RetVal : WinUI3.Windows.Devices.Geolocation.Geofencing.GeofenceMonitor do
         ...
         if Hr = S_OK then
            ...
            Retval.m_IGeofenceMonitor := new WinUI3.Windows.Devices.Geolocation.Geofencing.IGeofenceMonitor;
   ...
   return WinUI3.Windows.Devices.Geolocation.Geofencing.GeofenceMonitorStatus is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Devices.Geolocation.Geofencing.GeofenceMonitorStatus;
   begin
   ...
   return WinUI3.Windows.Devices.Geolocation.Geofencing.GeofenceState is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Devices.Geolocation.Geofencing.GeofenceState;
   begin
   ...
   return WinUI3.Windows.Devices.Geolocation.Geofencing.Geofence'Class is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Devices.Geolocation.Geofencing.IGeofence;
   begin
      return RetVal : WinUI3.Windows.Devices.Geolocation.Geofencing.Geofence do
   ...
   return WinUI3.Windows.Devices.Geolocation.Geofencing.GeofenceRemovalReason is
      Hr               : WinUI3.HResult := S_OK;
      tmp              : WinUI3.HResult := S_OK;
      temp             : WinUI3.UInt32 := 0;
      m_ComRetVal      : aliased WinUI3.Windows.Devices.Geolocation.Geofencing.GeofenceRemovalReason;
   begin
