...
--------------------------------------------------------------------------------
package WinUI3.Windows.ApplicationModel.DataTransfer.ShareTarget is
   ...
   type IQuickLink_Interface is interface and WinUI3.IInspectable_Interface;
   type IQuickLink is access all IQuickLink_Interface'Class;
   type IQuickLink_Ptr is access all IQuickLink;

   type IShareOperation_Interface is interface and WinUI3.IInspectable_Interface;
   type IShareOperation is access all IShareOperation_Interface'Class;
   type IShareOperation_Ptr is access all IShareOperation;

   type IShareOperation2_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IShareOperation3_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   IID_IVector_HString : aliased WinUI3.IID := (3418906382, 49975, 21831, (140, 134, 135, 251, 191, 137, 166, 104 ));
   ...
   -----------------------------------------------------------------------------
   -- type IQuickLink is interface and WinUI3.IInspectable;
      ...
      IID_IQuickLink : aliased WinUI3.IID := (1614693128, 61630, 19164, (172, 201, 139, 39, 171, 156, 245, 86 ));

   -----------------------------------------------------------------------------
   -- type IShareOperation is interface and WinUI3.IInspectable;
      ...
      (
         this : access IShareOperation_Interface;
         quicklink_p : WinUI3.Windows.ApplicationModel.DataTransfer.ShareTarget.IQuickLink
      )
      return WinUI3.Hresult is abstract;
      ...
      IID_IShareOperation : aliased WinUI3.IID := (575060664, 53496, 16833, (168, 42, 65, 55, 219, 101, 4, 251 ));

   -----------------------------------------------------------------------------
   -- type IShareOperation2 is interface and WinUI3.IInspectable;
      ...
      IID_IShareOperation2 : aliased WinUI3.IID := (268146625, 38776, 18953, (142, 91, 203, 94, 72, 45, 5, 85 ));

   -----------------------------------------------------------------------------
   -- type IShareOperation3 is interface and WinUI3.IInspectable;
      ...
      IID_IShareOperation3 : aliased WinUI3.IID := (1593226114, 47015, 17777, (162, 166, 153, 74, 3, 73, 136, 178 ));
