...
--------------------------------------------------------------------------------
package WinUI3.Windows.Gaming.UI is
   ...
   type IGameBarStatics_Interface is interface and WinUI3.IInspectable_Interface;
   type IGameBarStatics is access all IGameBarStatics_Interface'Class;
   type IGameBarStatics_Ptr is access all IGameBarStatics;

   type IGameChatMessageReceivedEventArgs_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGameChatOverlay_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGameChatOverlayMessageSource_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGameChatOverlayStatics_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   type IGameUIProviderActivatedEventArgs_Interface is interface and WinUI3.IInspectable_Interface;
   ...
   -----------------------------------------------------------------------------
   -- type IGameBarStatics is interface and WinUI3.IInspectable;
      ...
      IID_IGameBarStatics : aliased WinUI3.IID := (498705042, 52344, 16755, (190, 69, 182, 30, 103, 40, 62, 167 ));

   -----------------------------------------------------------------------------
   -- type IGameChatMessageReceivedEventArgs is interface and WinUI3.IInspectable;
      ...
      (
         this : access IGameChatMessageReceivedEventArgs_Interface;
         RetVal : access WinUI3.Windows.Gaming.UI.GameChatMessageOrigin
      )
      return WinUI3.Hresult is abstract;

      IID_IGameChatMessageReceivedEventArgs : aliased WinUI3.IID := (2726429169, 16313, 20034, (164, 3, 122, 252, 226, 2, 59, 30 ));

   -----------------------------------------------------------------------------
   -- type IGameChatOverlay is interface and WinUI3.IInspectable;

      function get_DesiredPosition
      (
         this : access IGameChatOverlay_Interface;
         RetVal : access WinUI3.Windows.Gaming.UI.GameChatOverlayPosition
      )
      return WinUI3.Hresult is abstract;
      ...
      (
         this : access IGameChatOverlay_Interface;
         sender : WinUI3.HString;
         message : WinUI3.HString;
         origin : WinUI3.Windows.Gaming.UI.GameChatMessageOrigin
      )
      return WinUI3.Hresult is abstract;

      IID_IGameChatOverlay : aliased WinUI3.IID := (4224075877, 63228, 19016, (174, 7, 3, 172, 110, 212, 55, 4 ));

   -----------------------------------------------------------------------------
   -- type IGameChatOverlayMessageSource is interface and WinUI3.IInspectable;
      ...
      IID_IGameChatOverlayMessageSource : aliased WinUI3.IID := (504853399, 23035, 20303, (142, 154, 128, 172, 248, 23, 116, 60 ));

   -----------------------------------------------------------------------------
   -- type IGameChatOverlayStatics is interface and WinUI3.IInspectable;

      function GetDefault
      (
         this : access IGameChatOverlayStatics_Interface;
         RetVal : access WinUI3.Windows.Gaming.UI.IGameChatOverlay
      )
      return WinUI3.Hresult is abstract;

      IID_IGameChatOverlayStatics : aliased WinUI3.IID := (2309813780, 30823, 18935, (150, 135, 37, 217, 219, 244, 68, 209 ));

   -----------------------------------------------------------------------------
   -- type IGameUIProviderActivatedEventArgs is interface and WinUI3.IInspectable;
      ...
      (
         this : access IGameUIProviderActivatedEventArgs_Interface;
         results : WinUI3.Windows.Foundation.Collections.IPropertySet
      )
      return WinUI3.Hresult is abstract;

      IID_IGameUIProviderActivatedEventArgs : aliased WinUI3.IID := (2813534270, 51959, 19949, (187, 210, 71, 222, 67, 187, 109, 213 ));
   ...
   return WinUI3.Windows.Gaming.UI.GameChatMessageOrigin;
   ...
   function GetDefault
   return WinUI3.Windows.Gaming.UI.GameChatOverlay;
   ...
   return WinUI3.Windows.Gaming.UI.GameChatOverlayPosition;
