...
--------------------------------------------------------------------------------
package WinRt.Windows.System.Profile.SystemManufacturers is
   ...
   -----------------------------------------------------------------------------
   -- type IOemSupportInfo is interface and WinRt.IInspectable;
      ...
      IID_IOemSupportInfo : aliased WinRt.IID := (2368646741, 34799, 16998, (134, 208, 196, 175, 190, 178, 155, 185 ));

   -----------------------------------------------------------------------------
   -- type ISmbiosInformationStatics is interface and WinRt.IInspectable;
      ...
      IID_ISmbiosInformationStatics : aliased WinRt.IID := (135055996, 25468, 18628, (183, 40, 249, 39, 56, 18, 219, 142 ));

   -----------------------------------------------------------------------------
   -- type ISystemSupportDeviceInfo is interface and WinRt.IInspectable;
      ...
      IID_ISystemSupportDeviceInfo : aliased WinRt.IID := (92801945, 33351, 17435, (169, 150, 161, 120, 75, 171, 121, 168 ));

   -----------------------------------------------------------------------------
   -- type ISystemSupportInfoStatics is interface and WinRt.IInspectable;
      ...
      IID_ISystemSupportInfoStatics : aliased WinRt.IID := (4017424756, 50210, 17879, (164, 77, 92, 28, 0, 67, 162, 179 ));

   -----------------------------------------------------------------------------
   -- type ISystemSupportInfoStatics2 is interface and WinRt.IInspectable;
      ...
      IID_ISystemSupportInfoStatics2 : aliased WinRt.IID := (871582116, 16289, 18822, (170, 75, 5, 116, 32, 69, 94, 109 ));
