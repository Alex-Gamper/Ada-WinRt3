...
package body WinRt.Windows.Services.TargetedContent is
   ...
   (
      ...
      tmp              : WinRt.HResult := S_OK;
      temp             : WinRt.UInt32 := 0;
      HStr_customInteractionName : constant WinRt.HString := To_HString (customInteractionName);
   begin
   ...
   return WinRt.Windows.Services.TargetedContent.TargetedContentContainer is
      Hr               : WinRt.HResult := S_OK;
      tmp              : WinRt.HResult := S_OK;
      m_hString        : constant WinRt.HString := To_HString ("Windows.Services.TargetedContent.TargetedContentContainer");
