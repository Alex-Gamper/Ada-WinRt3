...
--------------------------------------------------------------------------------
package WinRt.Windows.UI.ApplicationSettings is
   ...
   -----------------------------------------------------------------------------
   -- type IAccountsSettingsPane is interface and WinRt.IInspectable;
      ...
      IID_IAccountsSettingsPane : aliased WinRt.IID := (2179634220, 20233, 17414, (165, 56, 131, 141, 155, 20, 183, 230 ));

   -----------------------------------------------------------------------------
   -- type IAccountsSettingsPaneCommandsRequestedEventArgs is interface and WinRt.IInspectable;
      ...
      IID_IAccountsSettingsPaneCommandsRequestedEventArgs : aliased WinRt.IID := (996720793, 56089, 17872, (154, 191, 149, 211, 119, 60, 147, 48 ));

   -----------------------------------------------------------------------------
   -- type IAccountsSettingsPaneCommandsRequestedEventArgs2 is interface and WinRt.IInspectable;
      ...
      IID_IAccountsSettingsPaneCommandsRequestedEventArgs2 : aliased WinRt.IID := (909081517, 20023, 18791, (140, 64, 231, 142, 231, 161, 229, 187 ));

   -----------------------------------------------------------------------------
   -- type IAccountsSettingsPaneEventDeferral is interface and WinRt.IInspectable;
      ...
      IID_IAccountsSettingsPaneEventDeferral : aliased WinRt.IID := (3421658431, 58810, 16623, (147, 218, 101, 224, 150, 229, 251, 4 ));

   -----------------------------------------------------------------------------
   -- type IAccountsSettingsPaneStatics is interface and WinRt.IInspectable;
      ...
      IID_IAccountsSettingsPaneStatics : aliased WinRt.IID := (1444907872, 45292, 16720, (168, 220, 32, 142, 228, 75, 6, 138 ));

   -----------------------------------------------------------------------------
   -- type IAccountsSettingsPaneStatics2 is interface and WinRt.IInspectable;
      ...
      IID_IAccountsSettingsPaneStatics2 : aliased WinRt.IID := (3525179330, 52749, 18511, (184, 232, 232, 35, 194, 21, 118, 94 ));

   -----------------------------------------------------------------------------
   -- type IAccountsSettingsPaneStatics3 is interface and WinRt.IInspectable;
      ...
      IID_IAccountsSettingsPaneStatics3 : aliased WinRt.IID := (138478680, 41658, 19567, (180, 172, 72, 245, 20, 51, 18, 22 ));

   -----------------------------------------------------------------------------
   -- type ICredentialCommand is interface and WinRt.IInspectable;
      ...
      IID_ICredentialCommand : aliased WinRt.IID := (2784388582, 24899, 19066, (169, 113, 176, 23, 186, 151, 140, 226 ));

   -----------------------------------------------------------------------------
   -- type ICredentialCommandFactory is interface and WinRt.IInspectable;
      ...
      IID_ICredentialCommandFactory : aliased WinRt.IID := (669551639, 48190, 19328, (148, 149, 78, 215, 32, 228, 138, 145 ));

   -----------------------------------------------------------------------------
   -- type ISettingsCommandFactory is interface and WinRt.IInspectable;
      ...
      IID_ISettingsCommandFactory : aliased WinRt.IID := (1759599411, 7299, 17210, (170, 90, 206, 238, 165, 189, 71, 100 ));

   -----------------------------------------------------------------------------
   -- type ISettingsCommandStatics is interface and WinRt.IInspectable;
      ...
      IID_ISettingsCommandStatics : aliased WinRt.IID := (1956309332, 12137, 19223, (138, 186, 208, 92, 229, 119, 142, 70 ));

   -----------------------------------------------------------------------------
   -- type ISettingsPane is interface and WinRt.IInspectable;
      ...
      IID_ISettingsPane : aliased WinRt.IID := (2983004466, 17776, 19561, (141, 56, 137, 68, 101, 97, 172, 224 ));

   -----------------------------------------------------------------------------
   -- type ISettingsPaneCommandsRequest is interface and WinRt.IInspectable;
      ...
      IID_ISettingsPaneCommandsRequest : aliased WinRt.IID := (1155474350, 23918, 16488, (161, 104, 244, 118, 67, 24, 33, 20 ));

   -----------------------------------------------------------------------------
   -- type ISettingsPaneCommandsRequestedEventArgs is interface and WinRt.IInspectable;
      ...
      IID_ISettingsPaneCommandsRequestedEventArgs : aliased WinRt.IID := (543120676, 6984, 17961, (166, 202, 47, 223, 237, 175, 183, 93 ));

   -----------------------------------------------------------------------------
   -- type ISettingsPaneStatics is interface and WinRt.IInspectable;
      ...
      IID_ISettingsPaneStatics : aliased WinRt.IID := (476730053, 65305, 18203, (186, 107, 248, 243, 86, 148, 173, 154 ));

   -----------------------------------------------------------------------------
   -- type IWebAccountCommand is interface and WinRt.IInspectable;
      ...
      IID_IWebAccountCommand : aliased WinRt.IID := (3399717784, 40186, 16966, (176, 196, 169, 19, 163, 137, 101, 65 ));

   -----------------------------------------------------------------------------
   -- type IWebAccountCommandFactory is interface and WinRt.IInspectable;
      ...
      IID_IWebAccountCommandFactory : aliased WinRt.IID := (3215379967, 12077, 17141, (129, 222, 29, 86, 186, 252, 73, 109 ));

   -----------------------------------------------------------------------------
   -- type IWebAccountInvokedArgs is interface and WinRt.IInspectable;
      ...
      IID_IWebAccountInvokedArgs : aliased WinRt.IID := (3886795840, 41432, 19549, (154, 127, 29, 52, 178, 249, 10, 210 ));

   -----------------------------------------------------------------------------
   -- type IWebAccountProviderCommand is interface and WinRt.IInspectable;
      ...
      IID_IWebAccountProviderCommand : aliased WinRt.IID := (3600539034, 41126, 20123, (136, 220, 199, 30, 117, 122, 53, 1 ));

   -----------------------------------------------------------------------------
   -- type IWebAccountProviderCommandFactory is interface and WinRt.IInspectable;
      ...
      IID_IWebAccountProviderCommandFactory : aliased WinRt.IID := (3580201499, 45430, 18294, (132, 105, 169, 211, 255, 11, 63, 89 ));
   ...
   return WinRt.Windows.UI.ApplicationSettings.AccountsSettingsPaneEventDeferral'Class;
   ...
   return WinRt.Windows.UI.ApplicationSettings.CredentialCommandCredentialDeletedHandler;
   ...
   function get_Edge
   return WinRt.Windows.UI.ApplicationSettings.SettingsEdgeLocation;
   ...
   return WinRt.Windows.UI.ApplicationSettings.SettingsPaneCommandsRequest'Class;
   ...
   return WinRt.Windows.UI.ApplicationSettings.WebAccountCommandInvokedHandler;

   function get_Actions
   (
      this : in out WebAccountCommand
   )
   return WinRt.Windows.UI.ApplicationSettings.SupportedWebAccountActions;
   ...
   return WinRt.Windows.UI.ApplicationSettings.WebAccountAction;
