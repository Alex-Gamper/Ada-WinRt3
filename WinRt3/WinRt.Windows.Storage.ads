...
package WinRt.Windows.Storage is
   ...
   type ApplicationDataSetVersionHandler_Delegate (Callback : access procedure  (setVersionRequest : WinRt.Windows.Storage.ISetVersionRequest)) is new WinRt.IMulticastDelegate_Interface (IID_ApplicationDataSetVersionHandler'Access) with null record;
      function Invoke
      (
         this : access ApplicationDataSetVersionHandler_Delegate;
         setVersionRequest : WinRt.Windows.Storage.ISetVersionRequest
      )
