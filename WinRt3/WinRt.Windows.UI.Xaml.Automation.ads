...
--------------------------------------------------------------------------------
package WinRt.Windows.UI.Xaml.Automation is
   ...
   -----------------------------------------------------------------------------
   -- type IAnnotationPatternIdentifiers is interface and WinRt.IInspectable;

      IID_IAnnotationPatternIdentifiers : aliased WinRt.IID := (3564478657, 18610, 20032, (166, 207, 61, 196, 182, 56, 192, 222 ));

   -----------------------------------------------------------------------------
   -- type IAnnotationPatternIdentifiersStatics is interface and WinRt.IInspectable;
      ...
      IID_IAnnotationPatternIdentifiersStatics : aliased WinRt.IID := (3773014877, 53607, 18140, (149, 171, 51, 10, 246, 26, 235, 181 ));

   -----------------------------------------------------------------------------
   -- type IAutomationAnnotation is interface and WinRt.IInspectable;
      ...
      IID_IAutomationAnnotation : aliased WinRt.IID := (4215025866, 984, 17944, (145, 191, 228, 216, 79, 74, 243, 24 ));

   -----------------------------------------------------------------------------
   -- type IAutomationAnnotationFactory is interface and WinRt.IInspectable;
      ...
      IID_IAutomationAnnotationFactory : aliased WinRt.IID := (1225194066, 56768, 20073, (183, 107, 1, 157, 146, 141, 130, 47 ));

   -----------------------------------------------------------------------------
   -- type IAutomationAnnotationStatics is interface and WinRt.IInspectable;
      ...
      IID_IAutomationAnnotationStatics : aliased WinRt.IID := (3842239159, 20197, 18635, (181, 184, 187, 205, 70, 201, 209, 218 ));

   -----------------------------------------------------------------------------
   -- type IAutomationElementIdentifiers is interface and WinRt.IInspectable;

      IID_IAutomationElementIdentifiers : aliased WinRt.IID := (3867829199, 17221, 20013, (138, 106, 73, 204, 225, 250, 45, 204 ));

   -----------------------------------------------------------------------------
   -- type IAutomationElementIdentifiersStatics is interface and WinRt.IInspectable;
      ...
      IID_IAutomationElementIdentifiersStatics : aliased WinRt.IID := (1162426783, 33600, 19815, (185, 191, 140, 42, 198, 160, 119, 58 ));

   -----------------------------------------------------------------------------
   -- type IAutomationElementIdentifiersStatics2 is interface and WinRt.IInspectable;
      ...
      IID_IAutomationElementIdentifiersStatics2 : aliased WinRt.IID := (3050025442, 54623, 18089, (158, 218, 26, 71, 66, 81, 93, 195 ));

   -----------------------------------------------------------------------------
   -- type IAutomationElementIdentifiersStatics3 is interface and WinRt.IInspectable;
      ...
      IID_IAutomationElementIdentifiersStatics3 : aliased WinRt.IID := (257736381, 46059, 16515, (173, 199, 12, 47, 57, 187, 53, 67 ));

   -----------------------------------------------------------------------------
   -- type IAutomationElementIdentifiersStatics4 is interface and WinRt.IInspectable;
      ...
      IID_IAutomationElementIdentifiersStatics4 : aliased WinRt.IID := (1526013813, 22803, 19832, (179, 48, 166, 245, 11, 115, 237, 155 ));

   -----------------------------------------------------------------------------
   -- type IAutomationElementIdentifiersStatics5 is interface and WinRt.IInspectable;
      ...
      IID_IAutomationElementIdentifiersStatics5 : aliased WinRt.IID := (2557116934, 56921, 17145, (161, 231, 98, 184, 175, 158, 117, 109 ));

   -----------------------------------------------------------------------------
   -- type IAutomationElementIdentifiersStatics6 is interface and WinRt.IInspectable;
      ...
      IID_IAutomationElementIdentifiersStatics6 : aliased WinRt.IID := (3729960973, 33576, 20142, (128, 53, 248, 219, 153, 200, 186, 196 ));

   -----------------------------------------------------------------------------
   -- type IAutomationElementIdentifiersStatics7 is interface and WinRt.IInspectable;
      ...
      IID_IAutomationElementIdentifiersStatics7 : aliased WinRt.IID := (15838130, 29740, 17514, (168, 246, 22, 114, 177, 13, 40, 116 ));

   -----------------------------------------------------------------------------
   -- type IAutomationElementIdentifiersStatics8 is interface and WinRt.IInspectable;
      ...
      IID_IAutomationElementIdentifiersStatics8 : aliased WinRt.IID := (2232922208, 32876, 24005, (188, 65, 137, 27, 181, 164, 122, 223 ));

   -----------------------------------------------------------------------------
   -- type IAutomationProperties is interface and WinRt.IInspectable;

      IID_IAutomationProperties : aliased WinRt.IID := (1758929708, 58914, 18665, (175, 11, 31, 250, 51, 204, 92, 186 ));

   -----------------------------------------------------------------------------
   -- type IAutomationPropertiesStatics is interface and WinRt.IInspectable;
      ...
      IID_IAutomationPropertiesStatics : aliased WinRt.IID := (3055091067, 13008, 18800, (156, 66, 124, 3, 154, 199, 190, 120 ));

   -----------------------------------------------------------------------------
   -- type IAutomationPropertiesStatics2 is interface and WinRt.IInspectable;
      ...
      IID_IAutomationPropertiesStatics2 : aliased WinRt.IID := (964056191, 28809, 18433, (143, 29, 170, 183, 128, 144, 209, 160 ));

   -----------------------------------------------------------------------------
   -- type IAutomationPropertiesStatics3 is interface and WinRt.IInspectable;
      ...
      IID_IAutomationPropertiesStatics3 : aliased WinRt.IID := (2071320373, 23729, 17069, (155, 87, 95, 171, 168, 193, 134, 127 ));

   -----------------------------------------------------------------------------
   -- type IAutomationPropertiesStatics4 is interface and WinRt.IInspectable;
      ...
      IID_IAutomationPropertiesStatics4 : aliased WinRt.IID := (4158006869, 12570, 19324, (161, 49, 82, 78, 137, 205, 60, 249 ));

   -----------------------------------------------------------------------------
   -- type IAutomationPropertiesStatics5 is interface and WinRt.IInspectable;
      ...
      IID_IAutomationPropertiesStatics5 : aliased WinRt.IID := (199449382, 51449, 16802, (180, 219, 230, 167, 163, 43, 12, 52 ));

   -----------------------------------------------------------------------------
   -- type IAutomationPropertiesStatics6 is interface and WinRt.IInspectable;
      ...
      IID_IAutomationPropertiesStatics6 : aliased WinRt.IID := (3323855631, 60233, 20061, (176, 18, 76, 28, 150, 195, 144, 27 ));

   -----------------------------------------------------------------------------
   -- type IAutomationPropertiesStatics7 is interface and WinRt.IInspectable;
      ...
      IID_IAutomationPropertiesStatics7 : aliased WinRt.IID := (4159278067, 36753, 16488, (164, 173, 183, 180, 2, 209, 10, 44 ));

   -----------------------------------------------------------------------------
   -- type IAutomationPropertiesStatics8 is interface and WinRt.IInspectable;
   ...
   -----------------------------------------------------------------------------
   -- type IDockPatternIdentifiers is interface and WinRt.IInspectable;

      IID_IDockPatternIdentifiers : aliased WinRt.IID := (3436704998, 58617, 18431, (189, 231, 55, 139, 17, 247, 142, 9 ));

   -----------------------------------------------------------------------------
   -- type IDockPatternIdentifiersStatics is interface and WinRt.IInspectable;
      ...
      IID_IDockPatternIdentifiersStatics : aliased WinRt.IID := (730276956, 60800, 20453, (142, 180, 112, 138, 57, 200, 65, 229 ));

   -----------------------------------------------------------------------------
   -- type IDragPatternIdentifiers is interface and WinRt.IInspectable;

      IID_IDragPatternIdentifiers : aliased WinRt.IID := (1650911621, 19719, 20096, (130, 235, 143, 150, 105, 10, 26, 12 ));

   -----------------------------------------------------------------------------
   -- type IDragPatternIdentifiersStatics is interface and WinRt.IInspectable;
      ...
      IID_IDragPatternIdentifiersStatics : aliased WinRt.IID := (704984989, 5973, 16514, (157, 144, 70, 241, 65, 29, 121, 134 ));

   -----------------------------------------------------------------------------
   -- type IDropTargetPatternIdentifiers is interface and WinRt.IInspectable;

      IID_IDropTargetPatternIdentifiers : aliased WinRt.IID := (294015283, 42750, 17972, (189, 24, 14, 246, 18, 183, 178, 8 ));

   -----------------------------------------------------------------------------
   -- type IDropTargetPatternIdentifiersStatics is interface and WinRt.IInspectable;
      ...
      IID_IDropTargetPatternIdentifiersStatics : aliased WinRt.IID := (459879172, 35323, 19210, (148, 82, 202, 44, 102, 170, 249, 243 ));

   -----------------------------------------------------------------------------
   -- type IExpandCollapsePatternIdentifiers is interface and WinRt.IInspectable;

      IID_IExpandCollapsePatternIdentifiers : aliased WinRt.IID := (2953231040, 29979, 19797, (146, 203, 97, 62, 193, 189, 245, 208 ));

   -----------------------------------------------------------------------------
   -- type IExpandCollapsePatternIdentifiersStatics is interface and WinRt.IInspectable;
      ...
      IID_IExpandCollapsePatternIdentifiersStatics : aliased WinRt.IID := (3615584212, 28384, 20280, (142, 20, 86, 239, 33, 173, 172, 253 ));

   -----------------------------------------------------------------------------
   -- type IGridItemPatternIdentifiers is interface and WinRt.IInspectable;

      IID_IGridItemPatternIdentifiers : aliased WinRt.IID := (1970750705, 12933, 20401, (128, 59, 37, 69, 189, 67, 21, 153 ));

   -----------------------------------------------------------------------------
   -- type IGridItemPatternIdentifiersStatics is interface and WinRt.IInspectable;
      ...
      IID_IGridItemPatternIdentifiersStatics : aliased WinRt.IID := (561849346, 24134, 19809, (135, 148, 184, 238, 142, 119, 71, 20 ));

   -----------------------------------------------------------------------------
   -- type IGridPatternIdentifiers is interface and WinRt.IInspectable;

      IID_IGridPatternIdentifiers : aliased WinRt.IID := (3372390415, 38597, 17676, (144, 68, 126, 82, 194, 79, 158, 148 ));

   -----------------------------------------------------------------------------
   -- type IGridPatternIdentifiersStatics is interface and WinRt.IInspectable;
      ...
      IID_IGridPatternIdentifiersStatics : aliased WinRt.IID := (2076463859, 41345, 16695, (141, 233, 31, 155, 26, 131, 32, 237 ));

   -----------------------------------------------------------------------------
   -- type IMultipleViewPatternIdentifiers is interface and WinRt.IInspectable;

      IID_IMultipleViewPatternIdentifiers : aliased WinRt.IID := (1566364600, 7698, 18571, (176, 234, 94, 108, 184, 152, 22, 225 ));

   -----------------------------------------------------------------------------
   -- type IMultipleViewPatternIdentifiersStatics is interface and WinRt.IInspectable;
      ...
      IID_IMultipleViewPatternIdentifiersStatics : aliased WinRt.IID := (2848958063, 27524, 19825, (158, 72, 215, 100, 211, 188, 218, 142 ));

   -----------------------------------------------------------------------------
   -- type IRangeValuePatternIdentifiers is interface and WinRt.IInspectable;

      IID_IRangeValuePatternIdentifiers : aliased WinRt.IID := (4168486725, 13257, 18045, (188, 158, 209, 81, 82, 99, 172, 225 ));

   -----------------------------------------------------------------------------
   -- type IRangeValuePatternIdentifiersStatics is interface and WinRt.IInspectable;
      ...
      IID_IRangeValuePatternIdentifiersStatics : aliased WinRt.IID := (3458417935, 7207, 17791, (184, 21, 122, 94, 70, 134, 61, 187 ));

   -----------------------------------------------------------------------------
   -- type IScrollPatternIdentifiers is interface and WinRt.IInspectable;

      IID_IScrollPatternIdentifiers : aliased WinRt.IID := (912986115, 16988, 18769, (174, 131, 213, 33, 231, 59, 198, 150 ));

   -----------------------------------------------------------------------------
   -- type IScrollPatternIdentifiersStatics is interface and WinRt.IInspectable;
      ...
      IID_IScrollPatternIdentifiersStatics : aliased WinRt.IID := (1274601633, 64383, 20388, (131, 179, 207, 174, 177, 3, 166, 133 ));

   -----------------------------------------------------------------------------
   -- type ISelectionItemPatternIdentifiers is interface and WinRt.IInspectable;

      IID_ISelectionItemPatternIdentifiers : aliased WinRt.IID := (766485530, 16120, 19381, (160, 43, 62, 225, 178, 39, 71, 64 ));

   -----------------------------------------------------------------------------
   -- type ISelectionItemPatternIdentifiersStatics is interface and WinRt.IInspectable;
      ...
      IID_ISelectionItemPatternIdentifiersStatics : aliased WinRt.IID := (2836975971, 18558, 20030, (159, 134, 123, 68, 172, 190, 39, 206 ));

   -----------------------------------------------------------------------------
   -- type ISelectionPatternIdentifiers is interface and WinRt.IInspectable;

      IID_ISelectionPatternIdentifiers : aliased WinRt.IID := (1252421552, 58359, 18271, (183, 141, 248, 168, 59, 183, 48, 196 ));

   -----------------------------------------------------------------------------
   -- type ISelectionPatternIdentifiersStatics is interface and WinRt.IInspectable;
      ...
      IID_ISelectionPatternIdentifiersStatics : aliased WinRt.IID := (2466470732, 27472, 16545, (178, 63, 92, 120, 221, 189, 71, 154 ));

   -----------------------------------------------------------------------------
   -- type ISpreadsheetItemPatternIdentifiers is interface and WinRt.IInspectable;

      IID_ISpreadsheetItemPatternIdentifiers : aliased WinRt.IID := (2218032665, 51787, 18082, (167, 148, 200, 121, 40, 163, 177, 171 ));

   -----------------------------------------------------------------------------
   -- type ISpreadsheetItemPatternIdentifiersStatics is interface and WinRt.IInspectable;
      ...
      IID_ISpreadsheetItemPatternIdentifiersStatics : aliased WinRt.IID := (1130727289, 21376, 20242, (180, 104, 180, 243, 104, 173, 68, 153 ));

   -----------------------------------------------------------------------------
   -- type IStylesPatternIdentifiers is interface and WinRt.IInspectable;

      IID_IStylesPatternIdentifiers : aliased WinRt.IID := (2967790081, 59549, 17259, (130, 135, 79, 121, 3, 70, 104, 121 ));

   -----------------------------------------------------------------------------
   -- type IStylesPatternIdentifiersStatics is interface and WinRt.IInspectable;
      ...
      IID_IStylesPatternIdentifiersStatics : aliased WinRt.IID := (1384793466, 48188, 19784, (148, 175, 31, 104, 112, 60, 162, 150 ));

   -----------------------------------------------------------------------------
   -- type ITableItemPatternIdentifiers is interface and WinRt.IInspectable;

      IID_ITableItemPatternIdentifiers : aliased WinRt.IID := (3274106285, 32887, 19556, (152, 228, 232, 59, 207, 27, 67, 137 ));

   -----------------------------------------------------------------------------
   -- type ITableItemPatternIdentifiersStatics is interface and WinRt.IInspectable;
      ...
      IID_ITableItemPatternIdentifiersStatics : aliased WinRt.IID := (616872227, 59810, 19945, (178, 164, 168, 178, 45, 11, 227, 98 ));

   -----------------------------------------------------------------------------
   -- type ITablePatternIdentifiers is interface and WinRt.IInspectable;

      IID_ITablePatternIdentifiers : aliased WinRt.IID := (953222398, 3340, 16682, (191, 141, 81, 237, 230, 131, 186, 245 ));

   -----------------------------------------------------------------------------
   -- type ITablePatternIdentifiersStatics is interface and WinRt.IInspectable;
      ...
      IID_ITablePatternIdentifiersStatics : aliased WinRt.IID := (1963408677, 13001, 18691, (174, 207, 220, 53, 4, 203, 210, 68 ));

   -----------------------------------------------------------------------------
   -- type ITogglePatternIdentifiers is interface and WinRt.IInspectable;

      IID_ITogglePatternIdentifiers : aliased WinRt.IID := (2115575659, 13524, 19175, (131, 172, 41, 248, 136, 130, 217, 133 ));

   -----------------------------------------------------------------------------
   -- type ITogglePatternIdentifiersStatics is interface and WinRt.IInspectable;
      ...
      IID_ITogglePatternIdentifiersStatics : aliased WinRt.IID := (3354875204, 5285, 20271, (146, 252, 118, 5, 36, 222, 6, 234 ));

   -----------------------------------------------------------------------------
   -- type ITransformPattern2Identifiers is interface and WinRt.IInspectable;

      IID_ITransformPattern2Identifiers : aliased WinRt.IID := (145399869, 56999, 16431, (128, 151, 154, 39, 131, 214, 14, 93 ));

   -----------------------------------------------------------------------------
   -- type ITransformPattern2IdentifiersStatics is interface and WinRt.IInspectable;
      ...
      IID_ITransformPattern2IdentifiersStatics : aliased WinRt.IID := (2023110212, 4592, 18044, (167, 43, 93, 172, 65, 193, 246, 254 ));

   -----------------------------------------------------------------------------
   -- type ITransformPatternIdentifiers is interface and WinRt.IInspectable;

      IID_ITransformPatternIdentifiers : aliased WinRt.IID := (3826342796, 50120, 18999, (185, 148, 39, 9, 167, 129, 22, 101 ));

   -----------------------------------------------------------------------------
   -- type ITransformPatternIdentifiersStatics is interface and WinRt.IInspectable;
      ...
      IID_ITransformPatternIdentifiersStatics : aliased WinRt.IID := (1165028779, 55045, 16580, (161, 220, 233, 172, 252, 239, 133, 246 ));

   -----------------------------------------------------------------------------
   -- type IValuePatternIdentifiers is interface and WinRt.IInspectable;

      IID_IValuePatternIdentifiers : aliased WinRt.IID := (1113323084, 21299, 20033, (180, 112, 43, 173, 20, 236, 208, 133 ));

   -----------------------------------------------------------------------------
   -- type IValuePatternIdentifiersStatics is interface and WinRt.IInspectable;
      ...
      IID_IValuePatternIdentifiersStatics : aliased WinRt.IID := (3259492599, 44492, 17423, (177, 35, 51, 120, 138, 64, 82, 90 ));

   -----------------------------------------------------------------------------
   -- type IWindowPatternIdentifiers is interface and WinRt.IInspectable;

      IID_IWindowPatternIdentifiers : aliased WinRt.IID := (972524468, 28722, 16866, (183, 158, 39, 183, 74, 134, 40, 222 ));

   -----------------------------------------------------------------------------
   -- type IWindowPatternIdentifiersStatics is interface and WinRt.IInspectable;
      ...
      IID_IWindowPatternIdentifiersStatics : aliased WinRt.IID := (131116294, 25346, 19753, (135, 139, 25, 218, 3, 252, 34, 141 ));
