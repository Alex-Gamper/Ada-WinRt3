...
package WinRt.Windows.Media.Audio is
   ...
   IID_IReference_TimeSpan : aliased WinRt.IID := (3883431139, 30630, 24477, (174, 0, 229, 220, 147, 246, 242, 214 ));
   ...
   return WinRt.Windows.Media.Audio.AudioNodeEmitter'Class;
   ...
   return WinRt.Windows.Media.Audio.CreateAudioDeviceOutputNodeResult'Class;
   ...
   return WinRt.Windows.Media.Audio.AudioGraphBatchUpdater'Class;
   ...
   return WinRt.Windows.Media.Audio.IAudioNode;
   ...
   return WinRt.Windows.Media.Audio.QuantumSizeSelectionMode;
   ...
   return WinRt.Windows.Media.Render.AudioRenderCategory;
   ...
   return WinRt.Windows.Media.Audio.AudioGraphUnrecoverableError;
   ...
   return WinRt.Windows.Media.Audio.AudioNodeEmitterShape'Class;

   function get_DecayModel
   (
      this : in out AudioNodeEmitter
   )
   return WinRt.Windows.Media.Audio.AudioNodeEmitterDecayModel'Class;
   ...
   return WinRt.Windows.Media.Audio.SpatialAudioModel;
   ...
   return WinRt.Windows.Media.Audio.AudioNodeEmitterDecayKind;
   ...
   return WinRt.Windows.Media.Audio.AudioNodeEmitterNaturalDecayModelProperties'Class;
   ...
   return WinRt.Windows.Media.Audio.AudioNodeEmitterShapeKind;

   function get_ConeProperties
   (
      this : in out AudioNodeEmitterShape
   )
   return WinRt.Windows.Media.Audio.AudioNodeEmitterConeProperties'Class;
   ...
   return WinRt.Windows.Media.Audio.AudioPlaybackConnectionState;

   function Open
   (
      this : in out AudioPlaybackConnection
   )
   return WinRt.Windows.Media.Audio.AudioPlaybackConnectionOpenResult'Class;
   ...
   return WinRt.Windows.Media.Audio.AudioPlaybackConnectionOpenResultStatus;
   ...
   return WinRt.Windows.Media.Audio.AudioDeviceNodeCreationStatus;
   ...
   return WinRt.Windows.Media.Audio.AudioDeviceOutputNode'Class;
   ...
   return WinRt.Windows.Media.Audio.AudioFileNodeCreationStatus;

   function get_FileInputNode
   (
      this : in out CreateAudioFileInputNodeResult
   )
   return WinRt.Windows.Media.Audio.AudioFileInputNode'Class;
   ...
   return WinRt.Windows.Media.Audio.AudioFileOutputNode'Class;
   ...
   return WinRt.Windows.Media.Audio.AudioGraphCreationStatus;

   function get_Graph
   (
      this : in out CreateAudioGraphResult
   )
   return WinRt.Windows.Media.Audio.AudioGraph'Class;
   ...
   return WinRt.Windows.Media.Audio.MediaSourceAudioInputNodeCreationStatus;

   function get_Node
   (
      this : in out CreateMediaSourceAudioInputNodeResult
   )
   return WinRt.Windows.Media.Audio.MediaSourceAudioInputNode'Class;
   ...
   return WinRt.Windows.Media.Audio.SetDefaultSpatialAudioFormatStatus;
   ...
   return WinRt.Windows.Media.Audio.SetDefaultSpatialAudioFormatResult'Class;
   ...
   return WinRt.Windows.Media.Audio.MixedRealitySpatialAudioFormatPolicy;
